...
namespace SAD_DAL.TFSDAL.TestTableAdapters {
    ...
    public partial class tblItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [tblItem] WHERE (([strProductName] = @Original_strProductName) AND ([" +
                "intID] = @Original_intID))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [tblItem] SET [strProductName] = @strProductName WHERE (([strProductName] " +
                "= @Original_strProductName) AND ([intID] = @Original_intID));\r\nSELECT strProduct" +
                "Name, intID FROM tblItem WHERE (intID = @intID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT strProductName, intID FROM tblItem WHERE (intUnitID = 2) AND (intTypeID = " +
                "6)";
        ...
        public virtual Test.tblItemDataTable GetItemName() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Test.tblItemDataTable dataTable = new Test.tblItemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Test.tblItemDataTable dataTable) {
