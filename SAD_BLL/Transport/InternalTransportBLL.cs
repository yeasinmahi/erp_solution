...
namespace SAD_BLL.Transport
{
    public class InternalTransportBLL
    {
        ...
        public DataTable GetVechicleInfoupdate(int unitID)
        {
        ...
        public string UpdateVehicleInfoData(int intUnitid, int intInsertBy, string xml)
        {
            string msg = "";

            tblVehicleTableAdapter adp = new tblVehicleTableAdapter();
             adp.UpdateVehicleInfoData(intUnitid, intInsertBy,  xml,ref msg);
            return msg;
