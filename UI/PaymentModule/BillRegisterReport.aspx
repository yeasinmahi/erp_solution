    ...
    <div class="divbody" style="padding-right:10px;">
        ...
        <table class="tbldecoration" style="width:auto; float:left;">
            <tr>
                ...
                <td><asp:TextBox ID="txtFrom" runat="server" AutoPostBack="false" autocomplete="off" CssClass="txtBox1" Enabled="true" Width="110"></asp:TextBox>
                ...
                <td><asp:TextBox ID="txtTo" runat="server" AutoPostBack="false" CssClass="txtBox1" autocomplete="off" Enabled="true" Width="110px"></asp:TextBox>
