<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndentViewDetails.aspx.cs" Inherits="UI.PaymentModule.IndentViewDetails" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %> 
<!DOCTYPE html> 
<html> 
<head runat="server"> 
    <title>::. Indent Details View</title> 
 ...
 <script>
     function Print() {
         ...
         document.getElementById("btnBillDetails").style.display = "none";
...
<body>
     ...
     <form id="frmIndentDetailsView" runat="server">        
...
<%--=========================================Start My Code From Here===============================================--%> 
    <div id="dvTable"   style="width:auto;background-color:white;padding-left:50px;padding-right:50px; padding-top:10px;padding-bottom:20px;"> 
         <asp:HiddenField ID="hfImageData" runat="server" /><asp:HiddenField ID="hdnBillID" runat="server" />
             <table style="width:700px">
                    <tr><td colspan="3" style="color:blue; font-weight:900;"><a id="btnBillDetails" href="BillDetails.aspx" class="nextclick" style="cursor:pointer; text-align:right;">Back</a></td></tr> 
