        ...
        <asp:UpdatePanel ID="UpdatePanel0" runat="server">
            <ContentTemplate>
                ...
                <div class="divbody" style="padding-right: 10px;">
                    <div class="tabs_container" style="background-color: #dcdbdb; padding-top: 10px; padding-left: 5px; padding-right: -50px; border-radius: 5px;">VOUCHER FOR ADVICE<hr />
                    </div>
                    <table class="tbldecoration" style="width: auto; float: left;">
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Bank"></asp:Label><span style="color: red; font-size: 14px;">*</span><span> :</span></td>
                            <td style="text-align: left;">
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label3" runat="server" CssClass="lbl" Text="A/C"></asp:Label><span style="color: red; font-size: 14px;">*</span><span> :</span></td>
                            <td style="text-align: left;">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                ...
                                <span style="padding-left: 15px">
                                    <asp:Button ID="btnPrepareAllVoucher" runat="server" class="myButton" Height="30px" Width="190px" Text="Prepare All Voucher" OnClientClick="ConfirmAll()" OnClick="btnPrepareAllVoucher_Click" /></span>
                            </td>
                            ...
                            <asp:GridView ID="dgvReportForPaymentV" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="8"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ID" SortExpression="intBill">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" runat="server" Text='<%# Bind("intBill") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="PO ID" SortExpression="strReff">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPOID" runat="server" Text='<%# Bind("strReff") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="50px" />
                                    </asp:TemplateField>
            ...
            <ItemTemplate><asp:Label ID="lblPayDate" runat="server" Text='<%#Eval("dtePayDate", "{0:yyyy-MM-dd}") %>' Width="80px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Pay Date" ItemStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPayDate" runat="server" CssClass="txtBoxCenter" Width="80px" Text='<%#Eval("dtePayDate", "{0:yyyy-MM-dd}") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Audit Date" SortExpression="AuditApproveDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAuditDate" runat="server" Text='<%# Bind("AuditApproveDate", "{0:yyyy-MM-dd}") %>' Width="80px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Party ID" SortExpression="intParty">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPartyID" runat="server" Text='<%# Bind("intParty") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="50px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Party Name" SortExpression="strParty">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPartyName" runat="server" Text='<%# Bind("strParty") %>' Width="150px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bank Account" SortExpression="strAccount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBankAccount" runat="server" Text='<%# Bind("strAccount") %>' Width="150px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" Width="150px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="COA" SortExpression="intCOA">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCOA" runat="server" Text='<%# Bind("intCOA") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="50px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Book Value" SortExpression="Bookval">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBookValue" runat="server" Text='<%# Bind("Bookval", "{0:n2}") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Ledger Balance" SortExpression="Leadgerbal">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLBalance" runat="server" Text='<%# Bind("Leadgerbal", "{0:n2}") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Registration Code" SortExpression="strBill">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRegNo" runat="server" Text='<%# Bind("strBill") %>' Width="150px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bill Amount" SortExpression="BillAmount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBillAmount" runat="server" Text='<%# Bind("BillAmount", "{0:n2}") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Previous Advance" SortExpression="Preadv">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPreAdv" runat="server" Text='<%# Bind("Preadv", "{0:n2}") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="TDS" SortExpression="TDSval">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTDS" runat="server" Text='<%# Bind("TDSval", "{0:n2}") %>' Width="60px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="60px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Approve Amount" SortExpression="monAppAmount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApproveAmount" runat="server" Text='<%# Bind("monAppAmount", "{0:n2}") %>' ForeColor="blue" Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                    </asp:TemplateField>
