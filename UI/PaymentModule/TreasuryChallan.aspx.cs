    ...
    public partial class TreasuryChallan : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                lblChallanDate.Text= dtCha.Text;
                lblDate.Text = dtVdate.Text;
            }            
        }
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            lblvat.Text = dt.Rows[0]["strTreasuryDepositDescription"].ToString() + " VAT Reg.NO:"
                          + dtt.Rows[0]["strVATRegNo"].ToString();
            ...
            //string tamountinwords = ConvertToWords(number);
            //lblMoney.Text = tamountinwords;

        }

        #region---------========Converting Taka to Word========----------
