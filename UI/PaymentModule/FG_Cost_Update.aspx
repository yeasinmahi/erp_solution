                ...
                <div class="divbody" style="padding-right: 10px;">
                    ...
                    <table class="tbldecoration" style="width: auto; float: left;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:TextBox ID="txtValue" runat="server" AutoPostBack="false" CssClass="txtBox1" Enabled="true" Width="110px" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox></td>
                            <td style="text-align: right; padding: 10px 0px 5px 0px">
                                <asp:Button ID="btnAdd" runat="server" class="btn btn-primary" Text="Add"  OnClick="btnAdd_Click" OnClientClick="return Validation();"/></td>
                            <td style="width:10px;"></td>
                            <td style="text-align: right; padding: 10px 0px 5px 0px">
                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-success" Text="Submit" OnClick="btnSubmit_Click"/></td>
                            <td style="width:10px;"></td>
                            <td style="text-align: right; padding: 10px 0px 5px 0px">
                                <asp:Button ID="btnShow" runat="server" class="btn btn-primary" Text="Show"  OnClick="btnShow_Click"/></td>
                        </tr>
                        <table>
                            <tr>
                            ...
                            <tr id="report" runat="server" visible="false">
                                <td>
                                    <asp:GridView ID="dgvShowReport" runat="server" AllowPaging="false" AutoGenerateColumns="False"  FooterStyle-Font-Size="11px" ForeColor="Black" GridLines="Vertical" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="10px" OnRowDeleting="dgvReport_RowDeleting">
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="SL No.">
                                                <ItemStyle HorizontalAlign="center" Width="50px" />
                                            ...
                                            <asp:TemplateField HeaderText="Value" SortExpression="monCost">
                                                <ItemTemplate>
