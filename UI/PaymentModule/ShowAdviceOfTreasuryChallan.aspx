...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <div class="tabs_container" id="head"> Treasury challan Information :<hr /></div>
            <table id="btnprint"><tr><td style="text-align:right;"><asp:Button ID="btnPrintAdvice" runat="server" class="nextclick" style="font-size:12px; cursor: pointer;" 
        ...
        <table id="tblform" style="background-color: white;" >
            ...
            <tr>
             ...
             <tr>
                <td colspan="2">
                    <asp:Label ID="lblsalam"  runat="server"></asp:Label>
                </td>
            </tr><tr><td colspan="2" style="height:15px;"></td></tr>
             <tr>
                <td colspan="2">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Amount" SortExpression="monAmount">
                                <ItemTemplate><asp:Label ID="lblamount" runat="server" Text='<%# Bind("monAmount", "{0:N1}") %>'></asp:Label></ItemTemplate>                          
                                <FooterTemplate>
