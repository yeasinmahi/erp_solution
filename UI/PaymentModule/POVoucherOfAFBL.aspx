<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POVoucherOfAFBL.aspx.cs" Inherits="UI.PaymentModule.POVoucherOfAFBL" %>
            ...
            <ContentTemplate>
                ...
                <div class="divbody" style="padding-right: 10px;">
                    <div id="divLevel1" class="tabs_container" style="background-color: #dcdbdb; padding-top: 10px; padding-left: 5px; padding-right: -50px; border-radius: 5px;">
                        <asp:Label ID="lblHeading" runat="server" CssClass="lbl" Text="Prepare Payment Voucher" Font-Bold="true" Font-Size="16px"></asp:Label><hr />
                    </div>
                                ...
                                <asp:GridView ID="dgvReportForPaymentV" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="8"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ID" SortExpression="intBill">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("intBill") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="PO ID" SortExpression="strReff">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOID" runat="server" Text='<%# Bind("strReff") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                ...
                <ItemTemplate><asp:Label ID="lblPayDate" runat="server" Text='<%#Eval("dtePayDate", "{0:yyyy-MM-dd}") %>' Width="80px"></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="COA" SortExpression="intCOA">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCOA" runat="server" Text='<%# Bind("intCOA") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="TDS" SortExpression="TDSval">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTDS" runat="server" Text='<%# Bind("TDSval", "{0:n2}") %>' Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Approve Amount" SortExpression="monAppAmount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblApproveAmount" runat="server" Text='<%# Bind("monAppAmount", "{0:n2}") %>' Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="100px" />
                                        </asp:TemplateField>
