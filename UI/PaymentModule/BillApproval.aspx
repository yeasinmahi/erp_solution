                        ...
                        <td>
                            <div class="divbody" style="padding-right: 10px;">
                                <div id="divLevel1" class="tabs_container" style="background-color: #dcdbdb; padding-top: 10px; padding-left: 5px; padding-right: -50px; border-radius: 5px;">
                                    <asp:Label ID="lblHeading" runat="server" CssClass="lbl" Text="BILL APPROVAL" Font-Bold="true" Font-Size="16px"></asp:Label><hr />
                                </div>
                                ...
                                <table class="tbldecoration" style="width: auto; float: left;">
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Action"></asp:Label><span style="color: red; font-size: 14px;">*</span><span> :</span></td>
                                        <td style="text-align: left;">
                                            <asp:DropDownList ID="ddlAction" CssClass="ddList" Font-Bold="False" runat="server" Width="220px" Height="23px" DataSourceID="odsActionType" DataTextField="strApproveType" DataValueField="intID" AutoPostBack="false"></asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; padding: 0px 0px 10px 0px">
                                            <asp:Button ID="btnApproveAll" runat="server" class="myButton" Text="Approve All" OnClientClick="ConfirmAll()" OnClick="btnApproveAll_Click" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                            <hr />
