        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (hdnEnroll.Value != "1011" && hdnEnroll.Value != "1015" && hdnEnroll.Value != "1010" && hdnEnroll.Value != "1044" && hdnEnroll.Value != "1039" && hdnEnroll.Value != "11621" && hdnEnroll.Value != "32897" && hdnEnroll.Value != "42815" && hdnEnroll.Value != "292454")
                    {
