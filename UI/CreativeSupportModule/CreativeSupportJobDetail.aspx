...
<body>
    ...
    <div class="divbody" style="margin-left:135px; margin-top:20px; padding-left:15px;">
        <table class="tbldecoration" style="width:auto; float:left; ">
            ...
            <tr >
                <td style="text-align:right; padding-top:10px"><asp:Label ID="lblDate" runat="server" CssClass="lbl" Text="Required Date :"></asp:Label></td>                
                <td style="padding-top:10px"><asp:TextBox ID="txtRequiredDate" runat="server" CssClass="txtBox1" Width="120px" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox>
                <span style="padding-left:20px;"><asp:Label ID="lblstart" runat="server" CssClass="lbl" Text="Required Time :"></asp:Label>
                ...
                <td style="text-align: right; padding-top:10px; padding-left:20px"><asp:Label ID="Label11" runat="server" CssClass="lbl" Text="PO ID :"></asp:Label></td>
            ...
            <tr style="text-align:center;">
                ...
                <td colspan="5" style="text-align:left; padding-top:10px"><asp:TextBox ID="txtSpecialAssignTo" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke" Width="547px"></asp:TextBox></td>  
            </tr>
            <tr>
                <td style="text-align:right; padding-top:10px"><asp:Label ID="lblJobDesc" runat="server" CssClass="lbl" Text="Job Description :"></asp:Label></td>
                <td colspan="4" style="text-align:left; padding-top:10px"><asp:TextBox ID="txtJobDesc" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox>
                <span style="padding-left:43px"><asp:Label ID="Label2" runat="server" CssClass="lbl" Text="Job Type :"></asp:Label>
                <span style="border-left-style:groove; border-left-width:0.1px; border-color:gainsboro; padding: 10px 10px 10px 5px"><asp:RadioButton ID="rdoLarge" runat="server" Checked="true" Text=" Large" /></span>
                <span style=" border-left-style:groove; border-left-width:0.1px; border-color:gainsboro; padding: 10px 10px 10px 5px"><asp:RadioButton ID="rdoModerate" runat="server" Text=" Moderate" /></span>
                <span style="border-left-style:groove; border-left-width:0.1px; border-color:gainsboro; padding: 10px 10px 10px 5px"><asp:RadioButton ID="rdoMinor" runat="server" Text=" Minor"/></span></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <asp:TemplateField HeaderText="Item Name" SortExpression="strCreativeItemName"><ItemTemplate>            
                <asp:Label ID="lblItemName" runat="server" Text='<%# Bind("strCreativeItemName") %>'></asp:Label></ItemTemplate>
                <ItemStyle HorizontalAlign="Left" Width="322px"/>
                <FooterTemplate><asp:Label ID="lblT" runat="server" Text="Total" /></FooterTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Quantity" SortExpression="intQty"><ItemTemplate>            
                <asp:Label ID="lblQty" runat="server" Text='<%# Bind("intQty") %>'></asp:Label></ItemTemplate>
                <ItemStyle HorizontalAlign="center" Width="85px"/>
                <FooterTemplate ><asp:Label ID="lblQtyTotal" runat="server" DataFormatString="{0:0.00}" Text="<%# totalqty %>" /></FooterTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Point" SortExpression="intPoint"><ItemTemplate>            
                <asp:Label ID="lblPoint" runat="server" Text='<%# Bind("intPoint") %>'></asp:Label></ItemTemplate>
                <ItemStyle HorizontalAlign="center" Width="85px"/>
            ...
            <tr>
                ...
                <asp:TemplateField HeaderText="File Name" SortExpression="strFilePath"><ItemTemplate>            
                <asp:Label ID="lblFileName" runat="server" Text='<%# Bind("strFilePath") %>'></asp:Label></ItemTemplate>
                ...
                <ItemTemplate><asp:Button ID="btnView" class="myButtonGrid" Font-Bold="true" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="View"  
                ...
                <ItemTemplate><asp:Button ID="btnDownload" class="myButtonGrid" Font-Bold="true" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="Download"  
                Text="Download"/></ItemTemplate><ItemStyle HorizontalAlign="center"/></asp:TemplateField>
            ...
            <tr>
                ...
                <td colspan="5" style="padding-top:10px"><asp:TextBox ID="txtRemarks" runat="server" CssClass="txtBox1" TextMode="MultiLine" Width="547px" Height="50px" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>                
            </tr> 
