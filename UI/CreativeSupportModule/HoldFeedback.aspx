...
<body>
    ...
    <div class="divbody" style="margin-left:150px; margin-top:20px; padding-left:15px;">
        ...
        <table class="tbldecoration" style="width:auto; float:left; ">
            <tr>
                <td style="text-align:right; padding-top:10px"><asp:Label ID="lblJobDesc" runat="server" CssClass="lbl" Text="Status :"></asp:Label></td>
                <td><asp:TextBox ID="txtStatus" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
                <td style="text-align:right; "><asp:Label ID="Label3" runat="server" Text=""></asp:Label></td>
                <td style="text-align:right;"><asp:Label ID="Label8" runat="server" Text="Job Code :" CssClass="lbl" ></asp:Label></td>
                <td style="padding-right:10px"><asp:TextBox ID="txtJobCode" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label1" runat="server" Text="Sender :" CssClass="lbl" ></asp:Label></td>
                <td><asp:TextBox ID="txtSender" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
                <td style="text-align:right; "><asp:Label ID="Label2" runat="server" Text=""></asp:Label></td>
                <td style="text-align:right;"><asp:Label ID="Label4" runat="server" Text="Receiver :" CssClass="lbl" ></asp:Label></td>
                <td><asp:TextBox ID="txtReceiver" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label5" runat="server" Text="Job Description :" CssClass="lbl" ></asp:Label></td>
                <td><asp:TextBox ID="txtJobDescription" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
                <td style="text-align:right; "><asp:Label ID="Label6" runat="server" Text=""></asp:Label></td>
                <td style="text-align:right;"><asp:Label ID="Label7" runat="server" Text="Attachment :" CssClass="lbl" ></asp:Label></td>                
                <td colspan="5" style="text-align:left;"><asp:FileUpload ID="txtWorkOrderUpload" runat="server" AllowMultiple="true" Height="25px" Width="130px"/>
                    <span style="padding-left:18px"><asp:Button ID="btnDocUpload" runat="server" class="myButton" Text="Add" Height="30px" OnClientClick="FTPUpload()"/></span>
                </td>
            </tr>
            ...
            <tr>
                <td style="text-align:right; padding-top:12px; padding-left:27px;  position:absolute;"><asp:Label ID="Label9" runat="server" Text="Remarks" CssClass="lbl"></asp:Label><span style="color:red; font-size:14px;">*</span><span> :</span></td>
                <td colspan="5" style="padding-top:10px; padding-right:10px"><asp:TextBox ID="txtRemarks" runat="server" CssClass="txtBox1" TextMode="MultiLine" Width="520px" Height="100px"></asp:TextBox></td>                
            </tr> 
            <tr>
                ...
                <span style="padding-left:50px"><asp:Button ID="btnSend" runat="server" class="myButton" Text="Send" Height="30px" OnClientClick="FTPUpload1()"/></span></td>
            </tr>
