        ...
        <asp:UpdatePanel ID="UpdatePanel0" runat="server">
            <ContentTemplate>
                ...
                <div style="padding-right: 10px;">
                    ...
                    <table class="tbldecoration" style="width: 100%; float: left; padding-bottom: 15px;">
                        <tr>
                            <td colspan="5">
                ...
                <div style="text-align: center; width: 100%; padding-top: 40px;"><span style="font-size: 20px; text-align: center; font-weight: bold;">Terms & Conditions </span></div>
                        ...
                        <tr>
                            <td colspan="2">
                                <p style="text-align: left; line-height: 160%; font-size: 15px; text-align: justify;">
                                    ...
                                    <br />
                                    <span style="text-decoration: underline; font: bold; font-weight: 900">POSM & Item: </span><span>Final text & measurement are must. You may attach reference (if any) here. You can submit maximum 03 items in one Job Order at once.</span>
                                    <br />
                                    <span style="text-decoration: underline; font: bold; font-weight: 900;">Quantity:</span><span> Every single unique design will be counted as one (01) quantity. (For example, if you have 02 different banner design which will be printed 2000 pieces then fill the Item: Banner, Quantity:02)</span>
                                    <br />
                                    <span style="text-decoration: underline; font: bold; font-weight: 900">Branding & Event:</span><span> Prior job type (Large, Moderate & Minor), PO ID & work order are must.</span>
                                    <br />
                                    <span style="text-decoration: underline; font: bold; font-weight: 900">Note:</span><span> For any incomplete information (text, measurement etc.), any received job will be hold and the job sender will get a job hold message with explanation. In this case, job senders are requested to complete the information within 30 minutes, otherwise the next job on queue will be started automatically. With the completion of each job you’ll get feedback message. Your standard time for any feedback is 24 hours. </span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span style="font-size: 35px">
                                    <asp:CheckBox ID="ckbAgree" runat="server" /></span>
                            ...
                            <td style="text-align: left; padding-top: 30px; padding-bottom: 20px;">
                                <asp:Button ID="btnGo" runat="server" class="myButton" Style="" Text="GO >>>" ToolTip="Go To Customer Support" OnClick="btnGo_Click" /></td>
