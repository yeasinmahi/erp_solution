<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1"
    Inherits="UI.Accounts.ChartOfAccount.ChartOfAccountsNew" Codebehind="ChartOfAccountsNew.aspx.cs" %>
...
//         animatedcollapse.init()    
           var curHeight= 4;
            var dv;
        function ShowDiv(parent,addEdit,gridNum)
        {
            ...
            if(addEdit==1)
            {
                    ...
                    //window.event.clientY+document.documentElement.scrollTop+10;
	                //dv2.style.left = window.event.clientX+ document.documentElement.scrollLeft;
              
	               
	                PageMethods.GetInfo(parent, onSucess);
	                function onSucess(result) {
	                    GetEditInfo(result[0], result[1], result[2], result[3], result[4], result[5], result[6], result[7], result[8], result[9]);
	                }
            ...
            else //add
            {
             ...
             document.getElementById("hdnGridNum").value = gridNum;
        ...
        function GetEditInfo(strAccName, ysnModule, intModuleID, codeLength, ysnSLedger, ysnLedger, ysnTrBalance, ysnIncomeSt, ysnBalanceSt, currentBalance) {
            ...
            dv2.style.top = 120;
            dv2.style.left = 200 + document.documentElement.scrollLeft;
...
<body>
    <!--<iframe height="0" id="addEdit" name="addEdit" src="" width="0"></iframe>-->
    <form id="form1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true" ScriptMode="Release" LoadScriptsBeforeUI="false">
    </asp:ScriptManager>
    <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
        ...
        <div id="divControl" class="divPopUp2" style="width: 100%; height: 80px; float: right;">
            ...
            <br />
            &nbsp &nbsp Unit
            <asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="True" DataSourceID="UnitObjectDataSource"
                DataTextField="strUnit" DataValueField="intUnitID" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            </asp:DropDownList>
            &nbsp;
            <asp:Button ID="btnReloadCOA" runat="server" onclick="btnReloadCOA_Click" 
                Text="Reload COA" />
            <asp:ObjectDataSource ID="UnitObjectDataSource" runat="server" SelectMethod="GetUnits"
        ...
        <ContentTemplate>
            <div id="divRootGrid">
                <asp:GridView ID="GridView1" SkinID="sknGrid1" runat="server" AutoGenerateColumns="False"
                    DataSourceID="RootGridObjectDataSource">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Account Name" SortExpression="strAccName">
                            <ItemTemplate>
                                <%# GetData("" + Eval("intAccID"), "1", "" + Eval("strAccName"), "true", "" + Eval("intModulesAutoID"), "" + Eval("ysnEnable"))%>
                                <%--<asp:Label ID="Label2" runat="server" Text='<%# Bind("strAccName") %>'></asp:Label>--%>
                                <%--<a href="ChartOfAccountsNew.aspx?COAID=<%# Eval("intAccID")%>&dataGrid=1&accName=<%# Eval("strAccName")%>"> <%# Eval("strAccName")%> </a>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Current Balance" SortExpression="monCurrentBalance">
                            <ItemTemplate>
                                <asp:Label ID="Label3" runat="server"   Text='<%# Bind("monCurrentBalance","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Total Child" SortExpression="intChildCount">
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("intChildCount") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sub-Ledger" SortExpression="ysnSubLedger">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Bind("ysnSubLedger") %>'
                                    Enabled="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Ledger" SortExpression="ysnLedger">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("ysnLedger") %>' Enabled="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Trial Balance" SortExpression="ysnTrBalance">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox3" runat="server" Checked='<%# Bind("ysnTrBalance") %>'
                                    Enabled="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <%# GetDataForEdit("" + Eval("intAccID"), "1", "" + Eval("strAccName"), "true", "" + Eval("intModulesAutoID"), "" + Eval("ysnEnable"))%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <asp:ObjectDataSource ID="RootGridObjectDataSource" runat="server" SelectMethod="GetChildDataByParentID"
                    TypeName="BLL.Accounts.ChartOfAccount.ChartOfAcc">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="hdnUnit" DefaultValue="1" Name="unitID" PropertyName="Value"
                            Type="Int32" />
            ...
            <div id="divOthers">
                <asp:GridView ID="GridView2" SkinID="sknGrid1" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Account Name" SortExpression="strAccName">
                            <ItemTemplate>
                                <%# GetData("" + Eval("intAccID"), "2", "" + Eval("strAccName"), "" + Eval("ysnHasChild"), "" + Eval("intModulesAutoID"), "" + Eval("ysnEnable"))%>
                                <%--<asp:Label ID="Label2" runat="server" Text='<%# Bind("strAccName") %>'></asp:Label>--%>
                                <%--<a href="ChartOfAccountsNew.aspx?COAID=<%# Eval("intAccID")%>&dataGrid=2&accName=<%# Eval("strAccName")%>"> <%# Eval("strAccName")%> </a>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Current Balance" SortExpression="monCurrentBalance">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <%# GetDataForEdit("" + Eval("intAccID"), "2", "" + Eval("strAccName"), "true", "" + Eval("intModulesAutoID"), "" + Eval("ysnEnable"))%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                ...
                <span>
                    <table style="width: 100%" class="tablekk">
                        <tr>
                            ...
                            <td align="right">
                                &nbsp;
                                <input id="btnClosePopDiv" type="button" value="X" onclick="HideDiv('divPopUp')" />
                            </td>
                        </tr>
                        <tr id="trText">
                            <td class="style1">
                            ...
                            <td class="style1">
                                <asp:TextBox ID="txtAcc" runat="server" Width="200"></asp:TextBox>
                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtAcc"
                                    ServiceMethod="GetCOAList" MinimumPrefixLength="1" CompletionSetCount="1" CompletionInterval="1"
                                    DelimiterCharacters="%" FirstRowSelected="true" EnableCaching="false" CompletionListCssClass="autocomplete_completionListElementBig"
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="msgBoxClass" style="font-size: 9px; font-weight: bold;"></span>
                            </td>
                        </tr>
                        <tr style="visibility: hidden">
                            <td>
                                Module Name &nbsp
                                <asp:CheckBox ID="ChkModule" runat="server" Checked="false" onclick="ShowModule(this);" />
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlModule" runat="server" DataSourceID="ObjectDataSource1"
                                    DataTextField="strModuleName" DataValueField="intModuleID" CssClass="ddlStyle">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetModuleData"
                                    TypeName="BLL.Accounts.Module.Module"></asp:ObjectDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="tbLevel" runat="server" Text="Trails Balance"></asp:Label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chkTrBal" runat="server" Checked="false" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="chkIncSt" runat="server" Checked="false" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="chkBalSht" runat="server" Checked="false" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td align="right">
                                <asp:Button ID="btnPopSubmit" runat="server" Text="Add" OnClick="btnPopSubmit_Click" />
                            </td>
                        </tr>
                    </table>
                </span>
            ...
            <asp:HiddenField ID="hdnGridNum" runat="server" />
            <asp:HiddenField ID="hdnAccountForEdit" runat="server" />
...
//                <%# jsString %>      
    ...
    <!--
    <form name="frmAddEditInfo" action="#" id="frmAddEditInfo" method="post" target="addEdit"
    style="display: none">
