...
{
    public partial class VoucherEntryEdit : BasePage
    {
        ...
        private void ViewAfterSave(bool isSuccess, string code, string chqNo, string pr, string id, string type, bool? isDr, bool isChqPrint, bool isMRPrint, string unitID)
        {
            if (isSuccess)
            {
                ...
                lblCEdit.Text = "<a href=\"#\" onclick=\"ShowPopUpE('VoucherEntry.aspx?id=" + id + "&type=" + type + @"&isDr=" + isDr.ToString().ToLower() + "&unit=" + unitID + "')\"class=\"link\">Edit</a>";
