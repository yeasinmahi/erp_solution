<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoucherEntryEdit.aspx.cs" Inherits="UI.Accounts.Voucher.VoucherEntryEdit" %>
                ...
                <asp:Panel ID="pnlAfterSave" runat="server" Visible="false">
                    <table style="width: 100%; vertical-align: bottom; padding-left: 10px;">
                        ...
                        <tr style="background-color: #F0F0FF;">
                            ...
                            <td>
                                <asp:Label ID="lblCPR" runat="server"></asp:Label>
                            </td>
                            <td>
