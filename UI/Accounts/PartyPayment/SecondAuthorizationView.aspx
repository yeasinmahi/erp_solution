<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecondAuthorizationView.aspx.cs" Inherits="UI.Accounts.PartyPayment.SecondAuthorizationView" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>.:: Complete Party Voucher ::.</title>
...
<body>
    <form id="frmsecondauthorization" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="divs_content_container" style="width:570px"> <div class="tabs_container">Bank Instruction Cheque List :<hr /><asp:HiddenField ID="hdnconfirm" runat="server" /></div>
         <table border="0";>
         <tr>
         ...
         <td colspan="3"><asp:HiddenField ID="hdnprinted" runat="server" /> 
         <asp:RadioButtonList ID="rdoprintstatus" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Visible="false">
         <asp:ListItem Selected="True" Value="True">Printed</asp:ListItem></asp:RadioButtonList> </td>
         <td>   
         <asp:CheckBox ID="chkAll" runat="server" Text="All Cheque" OnCheckedChanged="chkAll_CheckedChanged" AutoPostBack="true"/>
         <asp:Button ID="btnCompleteAll" runat="server" font-size="11px" Text="Complete All" OnClick="btnCompleteAll_Click" OnClientClick = "Confirm()"/>
         </td>
    ...
    <asp:GridView ID="dgvAuthorizedPartyCheque" runat="server" AutoGenerateColumns="False" SkinID="sknGrid2" AllowPaging="True" PageSize="20" Font-Size="11px"
        ...
        <Columns>    
          ...
          Text="Clickme" OnClick="Complete_Click" OnClientClick = "Confirm()"/></ItemTemplate> <ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
       </Columns>
    </asp:GridView>
