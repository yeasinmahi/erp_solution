...
{
    public partial class AccountsViewAdjustment : BasePage
    {
        ...
        protected void dgvViewBill_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                grdAdvance += double.Parse(((Label)e.Row.Cells[4].FindControl("lblAdvance")).Text);
                grdThisbill += double.Parse(((Label)e.Row.Cells[5].FindControl("lblThisbill")).Text);
            }
        }
                ...
                try
                {
                    ...
                    for (int i = 0; i < rowCount; i++)
                    {
                        ...
                        if (ysnChecked)
                        {
                            ...
                            decimal amountcr = GetSubstringValue(((HiddenField)dgvViewBill.Rows[i].FindControl("hdnthisbill")).Value.ToString());
                            ...
                            decimal amountdr = GetSubstringValue(((HiddenField)dgvViewBill.Rows[i].FindControl("hdnthisbill")).Value.ToString());
                            ...
                            ((HiddenField)dgvViewBill.Rows[i].FindControl("hdnpoid")).Value.ToString() + " and Bill no. " + ((HiddenField)dgvViewBill.Rows[i].FindControl("hdnreff")).Value.ToString();
                            #endregion
