<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsViewCashCredit.aspx.cs" Inherits="UI.Accounts.PartyPayment.AccountsViewCashCredit" %>
...
<script>
   function Confirm() {
       ...
       var txtbox = document.forms["frmcashcredit"]["txtChkNo"].value;
        var chequedate = document.forms["frmcashcredit"]["dteCheque"].value;
        var actualpaydate = document.forms["frmcashcredit"]["dteActualPay"].value;
   ...
   $(document).ready(function () {
       $("[id*=txtExpense]").autocomplete({
           source: function (request, response) {
               $.ajax({
                   url: "AutoComplete.asmx/GetExpenceList",
...
<body>
    <form id="frmcashcredit" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container">View Cash/Credit Bill :<hr /><asp:HiddenField ID="hdnuserid" runat="server"/><asp:HiddenField ID="hdnconfirm" runat="server"/></div>
            <asp:GridView ID="dgvViewBill" runat="server" AutoGenerateColumns="False" SkinID="sknGrid2" Font-Size="11px" 
                OnRowDataBound="dgvViewBill_OnRowDataBound" BackColor="White" DataSourceID="odsloadgrid" ShowFooter="True">
                <Columns>    
                  ...
                  <asp:TemplateField  HeaderText="Accounts Head" ItemStyle-HorizontalAlign="Center"> 
                  <ItemTemplate><asp:TextBox ID="txtExpense" runat="server" CssClass="txtBox" ></asp:TextBox> 
                  <asp:HiddenField ID="hfaccId" runat="server"/></ItemTemplate></asp:TemplateField>
                  ...
                  <ItemTemplate> <input id="btnShowBill" type="button" class="nextclick" style="cursor:pointer" value="Preview" onclick="<%# GetJSShowBillVATPOMRR(  Eval("intBillID"), Eval("intPOID"), Eval("intShipmentID"), "Bill") %>" />
                  ...
                  <ItemTemplate> <input id="btnShowVat" type="button" class="nextclick" style="cursor:pointer" value="Preview" onclick="<%# GetJSShowBillVATPOMRR(  Eval("intBillID"), Eval("intPOID"), Eval("intShipmentID"), "Vat") %>" />
                  </ItemTemplate> <ItemStyle HorizontalAlign="Left" /></asp:TemplateField> 
            ...
            <asp:ObjectDataSource ID="odsloadgrid" runat="server" SelectMethod="GetPartyCashCreditBill" TypeName="BLL.Accounts.PartyPayment.PartyBill">
    ...
    <table border="0" style="text-align:justify;">
     ...
     <tr>
            ...
            <%--<asp:Button ID="btnCancel" runat="server" class="nextclick" style="font-size:11px;" Text="Cancel" OnClick="btnCancel_Click"  OnClientClick = "Confirm()"/>--%>
