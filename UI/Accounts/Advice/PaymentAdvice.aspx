    ...
    <table style="width:auto; float:left;">
       ...
       <table  class="tbldecoration" style="width:auto; float:left;">
           <div style="background-color:cadetblue;font-size:18px"  class="tabs_container">
               <caption>
                   <b>PAYMENT ADVICE FORM</b><hr /></caption>
           </div>
        ...
        <tr>
           ...
           <tr><td colspan="6">
               ...
               <AlternatingRowStyle BackColor="#CCCCCC" /><Columns>
                ...
                <ItemTemplate><asp:Label ID="lblID" runat="server" Text='<%# Bind("intID") %>'></asp:Label>
                ...
                <ItemTemplate><asp:Label ID="lblACType" runat="server" Text='<%# Bind("strAccType") %>'></asp:Label>
                </ItemTemplate><ItemStyle HorizontalAlign="left" /></asp:TemplateField>
        ...
        <tr><td>
         ...
         <table>
            <tr><td style="font-weight:bold; text-decoration:underline; font-size:22px; color:#000000; text-align:center"><asp:Label ID="lblUnitName" runat="server"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; text-decoration:underline; font-size:18px; color:#000000; text-align:center"><asp:Label ID="lblUnitAddress" runat="server"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblTo" runat="server" Text="To"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblManager" runat="server" Text="The Manager"></asp:Label></td></tr>
            <tr><td style="font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblBankName" runat="server"></asp:Label></td></tr>
            <tr><td style="font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblBankAddress" runat="server"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblSubject" runat="server" Text="<u>Subject : Payment Instruction by BEFTN.</u>"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblDearSir" runat="server" Text="Dear Sir,"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblMailBody" runat="server"></asp:Label></td></tr>
            <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblDetails" runat="server" Text="Detailed particulars of each Account Holder :"></asp:Label></td></tr>
            ...
            <tr><td>
               ...
               <AlternatingRowStyle BackColor="#CCCCCC" /><Columns>
                ...
                <asp:TemplateField HeaderText="Instrument No" ItemStyle-HorizontalAlign="right" SortExpression="intInstrumentNo">
                <ItemTemplate><asp:Label ID="lblInstrumentNo" runat="server" Text='<%# Bind("intInstrumentNo") %>'></asp:Label>
                </ItemTemplate><ItemStyle HorizontalAlign="left" /></asp:TemplateField>
                ...
                <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblWord" runat="server"></asp:Label></td></tr>
                <tr><td style="height:30px"></td></tr>
                <tr><td style="font-weight:bold; font-size:18px; color:#000000; text-align:left" class="auto-style1"><asp:Label ID="lblForUnit" runat="server"></asp:Label></td></tr>
                <tr><td style="height:70px"></td></tr>
                <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblAuth1" runat="server" Text="Authorize Signature"></asp:Label>
         ...
         <table>
            ...
            <tr><td>
               ...
               <AlternatingRowStyle BackColor="#CCCCCC" /><Columns>
                ...
                <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblWordIBBL" runat="server"></asp:Label></td></tr>
                <tr><td style="height:30px"></td></tr>
                <tr><td style="font-weight:bold; font-size:18px; color:#000000; text-align:left" class="auto-style1"><asp:Label ID="lblForUnitIBBL" runat="server"></asp:Label></td></tr>
                <tr><td style="height:70px"></td></tr>
                <tr><td style="font-weight:bold; font-size:15px; color:#000000; text-align:left"><asp:Label ID="lblAuthIBBL1" runat="server" Text="Authorize Signature"></asp:Label>
