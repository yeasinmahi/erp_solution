<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelfResignCancel.aspx.cs" Inherits="UI.HR.Settlement.SelfResignCancel" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4">Self Resign Cancel :</td></tr>
