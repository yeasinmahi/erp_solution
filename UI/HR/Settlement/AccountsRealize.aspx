<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsRealize.aspx.cs" Inherits="UI.HR.Settlement.AccountsRealize" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Accounts Realize :</td></tr>
        ...
        <ItemTemplate><a class="button" style="Font-Size:10px; color:green" href="#" onclick="<%#  FilterControlsAccountsRealizeResign(""+Eval("strEmployeeCode"),""+Eval("intEmployeeID"),""+Eval("strEmployeeName"),""+
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ListItem Selected="True" Value="1">Perfectly handover Accounts Dues</asp:ListItem><asp:ListItem Value="2">Handover partial Accounts Dues</asp:ListItem></asp:DropDownList>
        </td>  
    ...
    <tr>
        <td colspan="4" style="text-align:right;">            
            <a class="button" onclick="AccountsRealizeResign()">Realize</a>            
        </td>
    </tr>
    ...
    <tr>  
        ...
        <td style="text-align:right;" colspan="2">   
            <a class="button" style="text-align:left;" onclick="ClearControlsAccountsRealize()">Close</a>
        </td>
    </tr>
