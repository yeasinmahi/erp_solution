...
{
    public partial class HRResignStatus : BasePage
    {
        public string strhrresignstatus1 = "";
        public string strhrresignstatus2 = "";
        ...
        private void GetSearchResult(string empCode)
        {
            if (!String.IsNullOrEmpty(empCode))
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        //style='width:60%;'
                        strhrresignstatus1 = @" <table class = 'tbldecoration' align='left'>
                        ...
                        pnlhrresignstatus1.DataBind();


                        strhrresignstatus2 = @" <table class = 'tbldecoration' align='left'>
                            <tr class='tblheader'>
