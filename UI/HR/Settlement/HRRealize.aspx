<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRRealize.aspx.cs" Inherits="UI.HR.Settlement.HRRealize" %>
...
<head runat="server">
    ...
    <script>$(document).ready(function () {
    document.getElementById("hiddenbox4").style.display = "none";
});</script>
...
<body>
    <form id="frmahrrealize" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
  ...
  <div id="divcontentholder">
    ...
    <tr class="tblheader"><td> HR Realize :</td></tr>
 
               
            <tr><td> <%--<asp:HiddenField ID="hdnconfirm" runat="server" />--%>
            ...
            <asp:BoundField DataField="intID" HeaderText="intSeparationID" Visible="false" ItemStyle-HorizontalAlign="Center" SortExpression="intID">
            ...
            <asp:BoundField DataField="ysnGetBenifit" Visible="false" HeaderText="Benifit" ItemStyle-HorizontalAlign="Center" SortExpression="ysnGetBenifit">
            <ItemStyle HorizontalAlign="left" Width="225px"/></asp:BoundField>
                
            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" SortExpression="">
            <ItemTemplate><a class="button" style="Font-Size:10px; color:green" href="#" onclick="<%#  FilterControlsHRRealizeResign(""+Eval("strEmployeeCode"),""+Eval("intEmployeeID"),""+Eval("strEmployeeName"),""+
            Eval("strDesignation"),""+Eval("monSalary"),""+Eval("dteResignationDate"),""+Eval("dteLastOfficeDate"),""+Eval("dteLastOfficeDateByUser"),""+Eval("dteLastOfficeDateByAuthority"),""+Eval("strSeparateName"),""+Eval("strSeparateReason"),""+Eval("ysnGetBenifit")) %>">View</a></ItemTemplate><ItemStyle HorizontalAlign="Left" Width="35px" /></asp:TemplateField>

            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" SortExpression="">
            <ItemTemplate><a class="button" style="Font-Size:10px; color:green" href="#" onclick="<%#  FilterControlsHRRealizeResignDocUp(""+Eval("intEmployeeID"),""+Eval("intID")) %>">Document Upload</a></ItemTemplate><ItemStyle HorizontalAlign="Left" Width="35px" /></asp:TemplateField>
    ...
    <div id="hiddenbox2" style="margin-top:250px;"><asp:HiddenField ID="hdnID" runat="server" /><asp:HiddenField ID="hdnconfirm" runat="server" /><asp:HiddenField ID="hdnBenifit" runat="server" />
    <table style="width:Auto";>
           
    <tr class="tblheader"><td colspan="4"> HR Realize :</td></tr>
    
    <tr>
        <td style="text-align:right;"><asp:Label ID="lblServiceBenifit" CssClass="lbl" runat="server" Text="Service Benifit : "></asp:Label></td>        
        <td><asp:CheckBox ID="CheckBox1" runat="server" />
        </td> 
        
        <td style="text-align:right;"><asp:Label ID="lblOthersAmount" CssClass="lbl" runat="server" Text="Others Amount : "></asp:Label></td>
        <td><asp:TextBox ID="txtOthersAmount" runat="server" CssClass="txtBox"></asp:TextBox></td>             
    </tr>
    <tr>                                
        ...
        <td style="text-align:right;"><asp:Label ID="lblReasonOfOtherAmount" CssClass="lbl" runat="server" Text="Reason Of Others Amount : "></asp:Label></td>
        <td><asp:TextBox ID="txtReasonOfOtherAmount" runat="server" CssClass="txtBox"></asp:TextBox></td>             
    </tr>
    ...
    <tr>        
        ...
        <td colspan="2" style="text-align:right;">            
            <a class="button" onclick="HRRealizeResign()">Realize</a>            
        </td>
    </tr> 
    ...
    <tr>  
        ...
        <td style="text-align:right;" colspan="2">   
            <a class="button" style="text-align:left;" onclick="ClearControlsHRRealize()">Close</a>
        </td>
    </tr>
    ...
    <div id="hiddenbox4" style="margin-top:200px;"><asp:HiddenField ID="hdnSeprationID" runat="server" />
        <table style="width:Auto";>
           
            <tr class="tblheader"><td colspan="3"> Document Upload :</td></tr>            
            <tr class="tblrowodd">           
                <td style='text-align: right; width:180px;'>Document Upload : </td>
                <td style='text-align: center;'>
                    <asp:FileUpload ID="txtDocUpload" runat="server" /></td>
                <td><a class="nextclick" onclick="FTPUpload()">Upload</a></td> 
            </tr>
            ...
            <tr>
                <td style="text-align:right;" colspan="2"> 
                    ...
                    <br>
                    <br></br>
                    <a class="button" onclick="ClearControlsHRRealizeDoc()" style="text-align:left;">Close</a>
                    <br></br>
                    </br>
                    </br>  
                </td>
