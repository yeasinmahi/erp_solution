...
{
    public partial class SelfResignStatus : BasePage
    {
        public string strselfresignstatus1 = "";
        public string strselfresignstatus2 = "";

        HRClass objhr = new HRClass();
        SelfClass obj = new SelfClass(); GlobalClass objG = new GlobalClass();
        DataTable dt;

        int intEnroll; int intSeparateType; string dteLastOfficeDate; string dteLastOfficeDateByUser;
        DateTime dteSeparateDateTime; string strSeparateReason; int intSVID; string dteLastOfficeDateByAuthority;
        ...
        private void GetSearchResult()
        {
            ...
            dt = new DataTable();
            dt = objG.GetDetailsReportAll(intEnroll);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    //style='width:60%;'
                    strselfresignstatus1 = @" <table class = 'tbldecoration' align='left'>
                    ...
                    pnlselfResignstatus1.DataBind();


                    strselfresignstatus2 = @" <table class = 'tbldecoration' align='left'>
                            <tr class='tblheader'>
