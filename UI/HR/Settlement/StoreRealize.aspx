<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreRealize.aspx.cs" Inherits="UI.HR.Settlement.StoreRealize" %>
...
<body>    
    <form id="frmstorerealize" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Store Realize :</td></tr>
            ...
            <ItemTemplate><a class="button" style="Font-Size:10px; color:green" href="#" onclick="<%#  FilterControlsStoreRealize(""+Eval("strEmployeeCode"),""+Eval("intEmployeeID"),""+Eval("strEmployeeName"),""+
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ListItem Selected="True" Value="1">Perfectly handover official product</asp:ListItem><asp:ListItem Value="2">Handover partial official product</asp:ListItem></asp:DropDownList>
        </td>  
    ...
    <tr>
        <td colspan="4" style="text-align:right;">            
            <a class="button" onclick="StoreRealizeResign()">Realize</a>            
        </td>
    </tr>
    ...
    <tr>  
        ...
        <td style="text-align:right;" colspan="2">   
            <a class="button" style="text-align:left;" onclick="ClearControlsStoreRealize()">Close</a>
        </td>
    </tr>
