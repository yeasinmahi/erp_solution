...
{
    public partial class StoreRealize : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (hdnconfirm.Value == "1") { StoreRealizeResign(); }
            } LoadGrid(); 
        }
        ...
        public string FilterControlsStoreRealize(string empcode, string enroll, string empname, string designation, string salary, string resignDate, string lastdate, string lastdateuser, string lastdateAuthority, string separateName, string reason)
        { return "FilterControlsStoreRealize('" + empcode + "','" + enroll + "','" + empname + "','" + designation + "','" + salary + "','" + resignDate + "','" + lastdate + "','" + lastdateuser + "','" + lastdateAuthority + "','" + separateName + "','" + reason + "')"; }

        private void StoreRealizeResign()
        {
            if (hdnconfirm.Value == "1")
            {
                try
                {
                    ...
                    intPart = 5;
                    if (ddlRemarks.Text == "1") { strRemarks = "Perfectly handover official product"; }
                    else if (ddlRemarks.Text == "2") { strRemarks = "Handover partial official product"; }
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Clearcontrol", "ClearControlsStoreRealize();", true);
                    ScriptManager.RegisterStartupScript(Page, typeof(Page), "StartupScript", "alert('Store Realize Successfully.');", true);
                }
                catch { }
