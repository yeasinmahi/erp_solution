<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsVoucherRealize.aspx.cs" Inherits="UI.HR.Settlement.AccountsVoucherRealize" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Accounts Voucher Realize :</td></tr>
            ...
            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" SortExpression="">
            <ItemTemplate><asp:Button ID="btnVP" class="button" runat="server" Font-Size="9px" OnClick="VP_Click"
            CommandArgument='<%# Eval("intEmployeeID") %>' Text="Prepare Voucher" /></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="50px" /></asp:TemplateField>
