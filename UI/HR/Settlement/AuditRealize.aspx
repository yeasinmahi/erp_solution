<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditRealize.aspx.cs" Inherits="UI.HR.Settlement.AuditRealize" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Audit Realize :</td></tr>
           
              
        <tr><td colspan="4"> <asp:HiddenField ID="hdnID" runat="server" /><asp:HiddenField ID="hdnSeparationID" runat="server" /> <%--<asp:HiddenField ID="hdnconfirm" runat="server" />--%>
        ...
        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" SortExpression="">
        <ItemTemplate><asp:Button ID="btnAccept" class="button" runat="server" Font-Size="9px" OnClick="Accept_Click" OnClientClick="ConfirmAll()"
        CommandArgument='<%# Eval("intEmployeeID") %>' Text="Accept" /></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="50px" /></asp:TemplateField>
        
        <%--<asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" SortExpression="">
        <ItemTemplate><asp:Button ID="btnViewDoc" class="button" runat="server" Font-Size="9px" OnClick="ViewDoc_Click"
        CommandArgument='<%# Eval("intID") %>' Text="View Document" /></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="50px" /></asp:TemplateField>--%>
