...
{
    public partial class LegalDeptRealizeDetails : BasePage
    {
        public string legaldeptrealizedetails1 = "";
        public string legaldeptrealizedetails2 = "";
            ...
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int row = 0; row < dt.Rows.Count; row++)
                    {
                        ...
                        //style='width:60%;'
                        legaldeptrealizedetails1 = @" <table class = 'tbldecoration' align='left'>
                   ...
                   <tr style='font-size: 11px; background-color: #F0F0F0;'>
                    ...
                    <tr class='tblheader'><td colspan='4' style='text-align: center; background-color: #999999; padding:2px 0px 2px 2px;'> </td></tr>
                        ...
                        pnllegaldeptrealizedetails1.DataBind();

                        legaldeptrealizedetails2 = @" <table class = 'tbldecoration' align='left'>
                    <tr class='tblheader'>
                    ...
                    <tr style='font-size: 11px; font-weight: bold; background-color: #999999;'>
                        ...
                        pnllegaldeptrealizedetails2.DataBind();
        ...
        private void LegalClrarance()
        {
            if (hdnconfirm.Value == "1")
            {
                ...
                {
                    intPart = 8;
                    monAmount = Convert.ToDecimal(txtAdjustAmount.Text.ToString());
                    strRemarks = txtCommentsByLegalDept.Text;
                    intEnroll = int.Parse(Session["enrollcheck"].ToString());
                    ...
                    ScriptManager.RegisterStartupScript(Page, typeof(Page), "StartupScript", "alert('Legal Dept. Clearance Successfully.');", true);
                    Response.Redirect("LegalDeptRealize.aspx");
                }
                catch { ScriptManager.RegisterStartupScript(Page, typeof(Page), "StartupScript", "alert('Please input & try again');", true); }
