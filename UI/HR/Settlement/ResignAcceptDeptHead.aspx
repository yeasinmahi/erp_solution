<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResignAcceptDeptHead.aspx.cs" Inherits="UI.HR.Settlement.ResignAcceptDeptHead" %>
...
<body>    
    <form id="frmdeptheadaccept" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Resign Accept Deppartment Head :</td></tr>
            ...
            <ItemTemplate><a class="button" style="Font-Size:10px; color:green" href="#" onclick="<%#  FilterControls(""+Eval("strEmployeeCode"),""+Eval("intEmployeeID"),""+Eval("strEmployeeName"),""+
    ...
    <div id="hiddenbox" style="margin-top:250px;"><asp:HiddenField ID="hdnID" runat="server" /><asp:HiddenField ID="hdnconfirm" runat="server" />
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txtLastWorkingDateByAuthority" BackColor="LightGray" runat="server" CssClass="txtBox"></asp:TextBox>
        <script type="text/javascript"> new datepickr('txtLastWorkingDateByAuthority', { 'dateFormat': 'Y-m-d' });</script></td>

        <td style="text-align:center;">  
            <asp:Button ID="btnAccept" runat="server" Text="Accept" CssClass="button" OnClientClick="DeptHeadAccept()" />                      
        </td>
        <td style="text-align:center;">
            <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="button" OnClientClick="DHReject()" />            
        </td>
    </tr>
    ...
    <tr>        
        <td style="text-align:right;" colspan="4">   
            <a class="button" style="text-align:left;" onclick="ClearControls()">Close</a>
        </td>
    </tr>
