...
{
    public partial class AuditRealizeDetails : BasePage
    {
        public string auditdeptrealizedetails1 = "";
        public string auditdeptrealizedetails2 = "";
            ...
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int row = 0; row < dt.Rows.Count; row++)
                    {
                        ...
                        //style='width:60%;'
                        auditdeptrealizedetails1 = @" <table class = 'tbldecoration' align='left'>
                   ...
                   <tr style='font-size: 11px; background-color: #F0F0F0;'>
                    ...
                    <tr class='tblheader'><td colspan='4' style='text-align: center; background-color: #999999; padding:2px 0px 2px 2px;'> </td></tr>
                        ...
                        pnlauditdeptrealizedetails1.DataBind();


                        auditdeptrealizedetails2 = @" <table class = 'tbldecoration' align='left'>
                    <tr class='tblheader'>
                    ...
                    <tr style='font-size: 11px; font-weight: bold; background-color: #999999;'>
                        ...
                        pnlauditdeptrealizedetails2.DataBind();
        ...
        {
            Response.Redirect("AuditRealize.aspx");
        }
