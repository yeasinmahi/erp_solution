...
{
    public partial class AccountsVoucherRealize : BasePage
    {
        ...
        protected void Details_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AccountsVoucherRealizeDetails.aspx");

        }

        protected void VP_Click(object sender, EventArgs e)
        {
            char[] delimiterChars = { '^' };
            string temp1 = ((Button)sender).CommandArgument.ToString();
            string temp = temp1.Replace("'", " ");
