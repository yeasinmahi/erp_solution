...
{
    public partial class HRClearangeDetails : BasePage
    {
        ...
        decimal monAmount; string strRemarks;
        ...
        public string hrclearance1 = "";
        public string hrclearance2 = "";
        public string paymentfstatus1 = "";
        public string paymentfstatus2 = "";
            ...
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int row = 0; row < dt.Rows.Count; row++)
                    {
                        ...
                        //style='width:60%;'
                        hrclearance1 = @" <table class = 'tbldecoration' align='left'>
                   ...
                   <tr style='font-size: 11px; background-color: #F0F0F0;'>
                    ...
                    <tr class='tblheader'><td colspan='4' style='text-align: center; background-color: #999999; padding:2px 0px 2px 2px;'> </td></tr>
                        ...
                        pnlHRClearance1.DataBind();


                        hrclearance2 = @" <table class = 'tbldecoration' align='left'>
                    <tr class='tblheader'>
                    ...
                    <tr style='font-size: 11px; font-weight: bold; background-color: #999999;'>
                        ...
                        pnlHRClearance2.DataBind();

                    }
                }

                strDate = DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss");
                nb.Text = "N.B.: This is a computer generated letter in the time of " + strDate + " and does not require any signature.";
            }
            else
            {
                intenroll = Session["enrollcheck"].ToString();
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int row = 0; row < dt.Rows.Count; row++)
                    {
                        ...
                        /////////////////////////////////////
                        //style='width:60%;'
                        paymentfstatus1 = @" <table class = 'tbldecoration' align='left'>
                   ...
                   <tr style='font-size: 11px; background-color: #F0F0F0;'>
                    ...
                    <tr class='tblheader'><td colspan='4' style='text-align: center; background-color: #999999; padding:2px 0px 2px 2px;'> </td></tr>
                        ...
                        //pnlpaymentfstatus1.DataBind();


                        paymentfstatus2 = @" <table class = 'tbldecoration' align='left'>
                    <tr class='tblheader'>
                        <td colspan='2' style='text-align: center; padding:4px 0px 4px 2px;'> Payment </td>
                        <td colspan='2' style='text-align: center; padding:4px 0px 4px 2px;'> Deduction </td>
                    </tr>
        ...
        private void HRClrarance()
        {
            if (hdnconfirm.Value == "1")
            {
                intPart = 10;
                strEmailAdd = txtRequestEmailAddress.Text;
                strCurrentAddress = txtHRClearnaceRemarks.Text;
                intEnroll = int.Parse(Session["enrollcheck"].ToString());
                ...
                Response.Redirect("HRClearange.aspx");
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "StartupScript", "alert('HR Clearance Successfully.');", true);
                //LoadGrid();
