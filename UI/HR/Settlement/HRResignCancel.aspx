<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRResignCancel.aspx.cs" Inherits="UI.HR.Settlement.HRResignCancel" %>
                ...
                $("#txtEmployeeSearch").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            ...
                            url: "HRResignCancel.aspx/GetAutoCompleteData",
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4">HR Resign Cancel :</td></tr>
    ...
    <tr class="tblroweven">  
        ...
        <asp:Button ID="btnSubmit" runat="server" CssClass="button" Text="Withdraw Resign" OnClientClick="ConfirmAll()" OnClick="btnSubmit_Click"/></td>        
    </tr> 
