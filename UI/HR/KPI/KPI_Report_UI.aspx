    ...
    <div class="tabs_container" align="Center" >Employee Performance Assessment Through KPI</div>
                ...
                <table class="tblrowodd" >
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:RadioButton ID="RadioEmp" runat="server" GroupName="dti" Text="Employee" />  </td> <td>
          ...
          <table>
            ...
            <asp:TemplateField HeaderText="Marks"><ItemTemplate>
              <asp:Label ID="lblGradeNumber" runat="server"    Width="100px" Text='<%# Bind("decGradeNumber") %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="lblGrade" runat="server" Text='<%# Bind("strGrade") %>'></asp:Label></ItemTemplate>
