                                ...
                                <asp:GridView ID="dgvGridView" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Marks">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGradeNumber" runat="server" CssClass="txtBoxGridAmount" TextMode="Number" MaxLength="3" Width="100px" Text='<%# Bind("decGradeNumber") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Grade" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGrade" runat="server" CssClass="gradepoint" Text='<%# Bind("strGrade") %>'></asp:Label></ItemTemplate>
