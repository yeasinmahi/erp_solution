...
<head runat="server">
  ...
  <script type="text/javascript">
    ...
    width:8%; height: 20%;    margin-left:530px;  margin-top: 00px; margin-right:00px; padding: 15px; overflow-y:scroll; }
    </style>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container" align="Center" >Employee Performance Assessment Examine by Supervisor</div>
     ...
     <tr class="tblroweven"><td><asp:Label ID="lblTask" runat="server" Text="Assignment Assessment: " Font-Size="small"  Font-Bold="true" ></asp:Label></td></tr>
            ...
            <ItemTemplate><asp:Label ID="lblTitle" runat="server" Text='<%# Bind("strTaskTitle") %>' ></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="140px"/></asp:TemplateField>
               ...
               <asp:BoundField DataField="strRemarks" HeaderText="Remarks" SortExpression="strRemarks">
                    <ItemStyle HorizontalAlign="right" Width="150px"/></asp:BoundField>
               <asp:BoundField DataField="dteComplete" HeaderText="CompleteDate" SortExpression="dteComplete"/>
              
             <asp:TemplateField HeaderText="Proposed Marks"><ItemTemplate>
            <asp:Label ID="lblMarks" runat="server" Text='<%# Bind("intPropostMarks") %>' ></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /></asp:TemplateField>
         <asp:TemplateField HeaderText="Approved Marks"><ItemTemplate>
            <asp:Label ID="lblExamineMarks" runat="server" Text='<%# Bind("intApproveMarks") %>' ></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /></asp:TemplateField>
     ...
     <table class="tbldecoration">
          ...
          <tr class="tblroweven"><td><asp:Label ID="lblJdcs" runat="server" Font-Size="Small"  Font-Bold="true" Text="Routine Dscription Assessment" ></asp:Label></td></tr>
      ...
      <tr>
            ...
            <ItemTemplate><asp:Label ID="lblDesc" runat="server" Text='<%# Bind("strDescription") %>' ></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="240px"/></asp:TemplateField>
                                   
               
              
             <asp:TemplateField HeaderText="Marks"><ItemTemplate>
            <asp:TextBox ID="TxtRegMarks" runat="server" Text='<%# Bind("decMarks") %>'    ></asp:TextBox></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /></asp:TemplateField>
    ...
    <tr class="tblroweven"><td><asp:Label ID="lblBehaviors" Font-Size="Small"  Font-Bold="true" runat="server" Text="Behavior Assessment Of competencies :" ></asp:Label></td></tr>
            ...
            <ItemTemplate><asp:Label ID="lblBehavior" runat="server" Text='<%# Bind("strBehavior") %>' ></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="140px"/></asp:TemplateField>
                               
               
              
             <asp:TemplateField HeaderText="Marks"><ItemTemplate>
            <asp:TextBox ID="TxtBehaviorMarks" runat="server" ReadOnly="true" Width="50" Text='<%# Bind("decMarks") %>' ></asp:TextBox></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /></asp:TemplateField>
    ...
    <asp:ListItem Text="EXCELENT (10)" Value="10"></asp:ListItem><asp:ListItem Text="Very GOOD (8)" Value="8"></asp:ListItem><asp:ListItem Text="GOOD (6)" Value="6"></asp:ListItem>
    <asp:ListItem Text="SATISFACTORY (4)" Value="4"></asp:ListItem><asp:ListItem Text="UNSATISFACTORY (0)" Value="0"></asp:ListItem>
          ...
          <tr class="tblrowodd"><td style="font:bold 12px verdana; background-color:yellow; text-align:right; padding-right:25px;"><asp:Label ID="lblrcd" runat="server"></asp:Label>
  <asp:Label ID="lblgrdTotal" runat="server"></asp:Label></td></tr>
    ...
    <td style="text-align:right;"><asp:Label ID="lbldoc" CssClass="lbl" runat="server" Text="Task Weight : "></asp:Label></td>
 
   <td style="text-align:left;"> <asp:TextBox ID="txtTaskWeight" Width="100"  TextMode="Number" Text="0" runat="server"></asp:TextBox></td>
    </tr>
        <tr class="tblrowodd">
   
    <td style="text-align:right;"><asp:Label ID="Label1" CssClass="lbl" runat="server" Text="JobDescription Weight : "></asp:Label></td>
 
   <td style="text-align:left;"> <asp:TextBox ID="txtJdWight" Width="100" Text="0" runat="server"></asp:TextBox></td>
    </tr>
        
  <tr class="tblrowodd"><td></td>
     <td style="text-align:left;"> <asp:Button ID="btnSaves" runat="server" BackColor="GreenYellow" OnClick="BtnSubmit_Click"   Text="Submit" />
