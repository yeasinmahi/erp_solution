<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicMovement.aspx.cs" Inherits="UI.HR.OfficialMovement.PublicMovement1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>.: Official Movement :.</title>
    ...
    <script>
        ...
        function Confirm() {
            ...
            var txtEmployeeSearch = document.forms["frmmovement"]["txtEmployeeSearch"].value;
            var txtDteFrom = document.forms["frmmovement"]["txtDteFrom"].value;
            var txtDteTo = document.forms["frmmovement"]["txtDteTo"].value;
            var txtDescription = document.forms["frmmovement"]["txtDescription"].value;
            var txtAddress = document.forms["frmmovement"]["txtAddress"].value;
...
<body>
    <form id="frmmovement" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <table border="0" style="width:Auto";>
        ...
        <asp:Button ID="btnUpdate" runat="server" class="nextclick" style="font-size:11px;" Text="Update" OnClick="btnUpdate_Click"  OnClientClick = "Confirm()"/>        
        <asp:Button ID="btnExit" runat="server" class="nextclick" style="font-size:11px;" Text="Cancel" OnClick="btnExit_Click"/>
