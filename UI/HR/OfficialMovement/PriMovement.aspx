<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriMovement.aspx.cs" Inherits="UI.HR.OfficialMovement.PriMovement" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
    ...
    <script>
        ...
        function Confirm() {
            ...
            var txtEmployeeSearch = document.forms["frmprimvmnt"]["txtEmployeeSearch"].value;
            var txtDteFrom = document.forms["frmprimvmnt"]["txtDteFrom"].value;
            var txtDteTo = document.forms["frmprimvmnt"]["txtDteTo"].value;
            var txtDescription = document.forms["frmprimvmnt"]["txtDescription"].value;
            var txtAddress = document.forms["frmprimvmnt"]["txtAddress"].value;
...
<body>
    <form id="frmprimvmnt" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <table border="0" style="width:Auto";>
        ...
        <td><asp:HiddenField ID="hdfEmpCode" runat="server" /><asp:TextBox ID="txtEmployeeSearch" runat="server" CssClass="txtBox" ReadOnly="true" AutoPostBack="false"></asp:TextBox></td>
