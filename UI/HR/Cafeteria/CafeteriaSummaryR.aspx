<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CafeteriaSummaryR.aspx.cs" Inherits="UI.HR.Cafeteria.CafeteriaSummaryR" %>
...
<body>
    ...
    <tr><td>
        ...
        <tr class="tblheader"><td colspan="4" style="color:black; text-align:center; font-size:18px"> CAFETERIA SUMMARY REPORT </td></tr>
    ...
    <tr><td>
        ...
        <ItemTemplate><asp:Label ID="lblGTK" runat="server" Text='<%# Bind("GuestTk") %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="35px"/>
        <FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# tgtk %>' /></FooterTemplate>
        </asp:TemplateField>
