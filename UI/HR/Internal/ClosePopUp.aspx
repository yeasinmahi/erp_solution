<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClosePopUp.aspx.cs" Inherits="UI.HR.Internal.ClosePopUp" %>
            ...
            $("#TxtEmpAddress").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "ClosePopUp.aspx/GetAutoCompleteData",
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container" align="Center" >Internal Approval</div>
       ...
       <td style="text-align:right;" > <asp:Label ID="LblAsset" runat="server"  Visible="false"   CssClass="lbl" font-size="small" Text="To Address:"></asp:Label></td>
          <td style="text-align:left;"> <asp:TextBox ID="TxtEmpAddress" runat="server" BackColor="#808080" CssClass="txtBox" Width="457px" AutoPostBack="true" onchange="javascript: Changed();"  Font-Bold="False"  ></asp:TextBox>
          ...
          <td style="text-align:left;"> <asp:TextBox ID="TxtDescription" runat="server" CssClass="txtBox" Font-Bold="False" Height="50px" Width="457px" TextMode="MultiLine"></asp:TextBox>
           ...
           <td style="text-align:right;">  <asp:HiddenField ID="HiddenClose" runat="server" />
                       <a class="nextclick" onclick="SaveC()">Close</a> </td>
                   </tr>
                </table>
