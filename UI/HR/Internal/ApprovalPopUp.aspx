<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalPopUp.aspx.cs" Inherits="UI.HR.Internal.ApprovalPopUp" %>
            ...
            $("#TxtEmpAddress").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "ApprovalPopUp.aspx/GetAutoCompleteData",
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hfEmployeeIdp" runat="server" /><asp:HiddenField ID="hdnstation" runat="server" />  <asp:HiddenField ID="HiddenDocvalue" runat="server" />       
          ...
          <td style="text-align:left;"> <asp:TextBox ID="TxtDescription" runat="server" CssClass="txtBox" Font-Bold="False" Height="50px" Width="457px" TextMode="MultiLine"></asp:TextBox>
            ...
            <table>
             <tr>
              ...
              <td></td>
                 <td style="text-align:right;">  <asp:HiddenField ID="hdnApprove" runat="server" />
                       <a class="nextclick" onclick="Save()">Approve</a> </td>
