<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptDispatchPopup.aspx.cs" Inherits="UI.HR.Dispatch.rptDispatchPopup" %>
...
<body>
    ...
    <div id="hdnDivisionDispatch" style="width:auto;"><table style="width:auto; float:left; ">            
    ...
    <tr class="tblroweven">
        ...
        <td style="text-align:right;" colspan="2"><asp:Button ID="btnDispatchDT" runat="server" CssClass="button" Text="Dispatch" OnClientClick="ConfirmAll()" OnClick="btnDispatchDT_Click" /></td>
    </tr> 
