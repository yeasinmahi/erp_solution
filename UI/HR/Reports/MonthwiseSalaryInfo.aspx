<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="UI.HR.Reports.MonthwiseSalaryInfo" Codebehind="MonthwiseSalaryInfo.aspx.cs" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                    ControlToValidate="ddlUnit" ErrorMessage="*" ForeColor="#FF5050" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                    ControlToValidate="ddlJobStation" ErrorMessage="*" ForeColor="#FF5050" 
                                    ValidationGroup="VG"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:ObjectDataSource ID="odsJobstationByUnit" runat="server" 
                                    OldValuesParameterFormatString="original_{0}" 
                                    SelectMethod="GetJobStationIdAndNameByUnitID" 
                                    TypeName="HR_BLL.Global.JobStation">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddlUnit" Name="intUnitID" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                    ControlToValidate="txtDate" ErrorMessage="*" ForeColor="#FF5050" 
                                    ValidationGroup="VG"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                &nbsp;</td>
