...
{
    public partial class EmpSalaryStatement : BasePage
    {
        int userID;
        ...
        private void ShowReportDetails()
        {
            ...
            string path = HttpContext.Current.Server.MapPath("~/HR/Reports/ReportsTemplate/EmpSalaryStatementReport.rdlc");
            ...
            HR_BLL.Reports.EmpSalaryStatement empSalary = new HR_BLL.Reports.EmpSalaryStatement();
            oDTReportData = empSalary.EmpSalary(int.Parse(ddlJobStation.SelectedValue), selectedDate);
            ...
            if (oDTReportData.Rows.Count > 0)
            {
                ...
                parameters.Add(new ReportParameter("Title", "Employee Salary Detail."));
                ...
                reportDataSource.Name = "odsEmpSalaryStatement";
