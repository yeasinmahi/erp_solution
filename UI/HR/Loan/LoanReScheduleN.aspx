<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanReScheduleN.aspx.cs" Inherits="UI.HR.Loan.LoanReScheduleN" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>

<html>
<head runat="server">
    <title>::. Loan Re-Schedule </title>
...
<body>
    <form id="frmReSchedule" runat="server">        
    ...
    <div class="divbody" style="padding-right:10px;">
        <div class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;"> LOAN SCHEDULE MODIFY<hr /></div>
        <table class="tbldecoration" style="width:auto; float:left;">
            <tr>
                ...
                <td style="text-align:right;"><asp:Label ID="Label15" runat="server" Text="Application ID :" CssClass="lbl"></asp:Label></td>
                <td><asp:TextBox ID="txtApplicationID" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
            </tr>
            ...
            <tr><td colspan="5"><hr /></td></tr>   
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label16" runat="server" Text="Remarks (For Complete)" CssClass="lbl"></asp:Label><span style="color:red; font-size:14px;">*</span><span> :</span></td>
            ...
            <tr><td colspan="5"><hr /></td></tr> 
            <tr>
                <td colspan="5" style="text-align:right; padding: 0px 0px 0px 0px"><asp:Button ID="btnAdd" runat="server" class="myButtonGrey" Text="Re-Schedule" OnClientClick = "ConfirmAll()" OnClick="btnAdd_Click"/></td>        
            </tr>            
        </table>
    </div>
    ...
    <table>
        ...
        <tr><td>   
            ...
            <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center" SortExpression="">
            <ItemTemplate><asp:Button ID="btnSelect" class="myButtonGrid" Font-Bold="true" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="S"  
            Text="Select"/></ItemTemplate><ItemStyle HorizontalAlign="center"/></asp:TemplateField>
