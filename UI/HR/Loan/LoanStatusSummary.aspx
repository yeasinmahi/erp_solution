<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanStatusSummary.aspx.cs" Inherits="UI.HR.Loan.LoanStatusSummary" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript"> 
        ...
        function ViewDispatchPopup(Id) {
            window.open('LoanSummaryPrint.aspx?ID=' + Id, 'sub', "height=500, width=900, scrollbars=yes, left=100, top=25, resizable=no, title=Preview");
        }
        function ViewLoanDetailsPopup(Id) {
...
<body>
    ...
    <div class="divbody" style="padding-right:10px;">
        <div class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;"> LOAN STATUS REPORT<hr /></div>
    ...
    <table>        
        <tr>
            <td style="text-align:right; padding: 0px 0px 0px 0px"><asp:Button ID="btnSummaryPrint" runat="server" class="myButtonGrey" Text="Summary Print" OnClick="btnSummaryPrint_Click"/></td>        
        </tr> 
        <tr><td><hr /></td></tr>
        <tr><td>   
            ...
            <asp:TemplateField HeaderText="Schedule Details" ItemStyle-HorizontalAlign="Center" SortExpression="">
