...
<body>
    ...
    <div class="divbody" style="padding-right:10px;">
        <div class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;"> REWARD ENTRY FORM<hr /></div>
        <table class="tbldecoration" style="width:auto; float:left;">
            <tr>
                ...
                <td style="text-align:right;"><asp:Label ID="lblLoanType" runat="server" CssClass="lbl" Text="Reward Type"></asp:Label><span style="color:red; font-size:14px;">*</span><span> :</span></td>
            ...
            <tr>
                <td style="text-align:right;"><asp:Label ID="lblFromDate" runat="server" CssClass="lbl" Text="Date :"></asp:Label></td>                
                ...
                <td style="text-align:right;"><asp:Label ID="Label11" runat="server" Text="Amount :" CssClass="lbl"></asp:Label></td>
                <td><asp:TextBox ID="txtAmount" runat="server" CssClass="txtBox1"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label8" runat="server" Text="Remarks" CssClass="lbl"></asp:Label><span style="color:red; font-size:14px;">*</span><span> :</span></td>
