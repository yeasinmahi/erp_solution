...
namespace UI.HR.Loan
{
    public partial class LoanComplete : BasePage
    {
        ...
        string location = "HR";
        string start = "starting HR/Loan/LoanComplete.aspx";
        string stop = "stopping HR/Loan/LoanComplete.aspx";
        ...
        protected void txtSearchEmp_TextChanged(object sender, EventArgs e)
        {
            ...
            var tracker = new PerfTracker("Performance on HR/Loan/LoanComplete.aspx Show", "", fd.UserName, fd.Location,
            fd.Product, fd.Layer);
        ...
        private void LoadGrid()
        {
            ...
            // starting performance tracker
            var tracker = new PerfTracker("Performance on HR/Loan/LoanComplete.aspx LoadGrid", "", fd.UserName, fd.Location,
            fd.Product, fd.Layer);
        ...
        protected void dgvLoan_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            // starting performance tracker
            var tracker = new PerfTracker("Performance on HR/Loan/LoanComplete.aspx dgvLoan_RowCommand", "", fd.UserName, fd.Location,
            fd.Product, fd.Layer);
