...
namespace UI.HR.Leave
{
    public partial class PubLeave : BasePage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var tracker = new PerfTracker("Performance on HR/Leave/PubLeave.aspx btnDelete_Click", "", fd.UserName, fd.Location,
            fd.Product, fd.Layer);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            // starting performance tracker
            var tracker = new PerfTracker("Performance on HR/Leave/PubLeave.aspx btnSubmit_Click", "", fd.UserName, fd.Location,
            fd.Product, fd.Layer);
