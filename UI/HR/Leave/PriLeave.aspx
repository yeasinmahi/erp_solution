<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriLeave.aspx.cs" Inherits="UI.HR.Leave.PriLeave" %>
...
<webopt:BundleReference ID="BundleReference1" runat="server" Path="~/Content/Bundle/hrCSS" />
    <script>
        function Confirm() {
            ...
            var txtEmployeeSearch = document.forms["frmprilv"]["txtEmployeeSearch"].value;
            var txtDteFrom = document.forms["frmprilv"]["txtDteFrom"].value;
            var txtDteTo = document.forms["frmprilv"]["txtDteTo"].value;
            var txtDescription = document.forms["frmprilv"]["txtReason"].value;
            var txtAddress = document.forms["frmprilv"]["txtAddress"].value;
