<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveApplicationPublic.aspx.cs" Inherits="UI.HR.Leave.LeaveApplicationPublic" %>
...
<head runat="server">
   <title>::. Public Apply Leave Application </title>
...
<body>
<form id="frmLeaveApplicationpublic" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="leaveApplication_container"> 
        ...
        <table border="0px"; style="width:Auto"; align="center" >
            ...
            <td><asp:TextBox ID="txtDesig" runat="server" CssClass="txtBox" ReadOnly="true"></asp:TextBox></td>
            </tr>
            ...
            <td><asp:TextBox ID="txtContact" runat="server" CssClass="txtBox" ReadOnly="true"></asp:TextBox></td>
            </tr>
            ...
            <tr>
                ...
                <td><asp:DropDownList ID="ddlLvType" runat="server" CssClass="dropdownList" DataSourceID="odsleavetype" DataTextField="strLeaveType" DataValueField="intLeaveTypeID"></asp:DropDownList>
            ...
            <tr><td colspan="4"><hr /><asp:HiddenField ID="hdnAction" runat="server"/>
            <asp:HiddenField ID="hdnAppId" runat="server"/>
            <a class="nextclick" onclick="DeleteApplication()">Delete</a>
            <a class="nextclick" onclick="Update()">Edit</a>
            <a class="nextclick" onclick="Submit()">Submit</a>
            </td></tr>              
