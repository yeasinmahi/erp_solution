<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Experienceupdate.aspx.cs" Inherits="UI.HR.IssuedLetter.Experienceupdate" %>
...
<body>
    <form id="frmexpupdt" runat="server"><asp:ScriptManager ID="ScriptManager1" EnablePageMethods="true" runat="server"></asp:ScriptManager>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class='tblroweven'><td colspan="4" style="text-align:right;"><asp:Button ID="btnExAdd" runat="server" CssClass="button" Text="ADD" OnClick="btnExAdd_Click" /></td></tr>
    <tr class=""><td style="text-align:justify;" colspan="4">
