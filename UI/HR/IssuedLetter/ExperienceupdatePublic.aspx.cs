...
{
    public partial class ExperienceupdatePublic : BasePage
    {
        ...
        int actionby; int loginuser;
        protected void Page_Load(object sender, EventArgs e)
        {
            hdnloginenroll.Value = HttpContext.Current.Session[SessionParams.USER_ID].ToString();
            hdnloginstation.Value = HttpContext.Current.Session[SessionParams.JOBSTATION_ID].ToString();
        ...
        public void Loadcontrols()
        {
            ...
            hdnactionby.Value = dt.Rows[0]["intEmployeeID"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            actionby = int.Parse(hdnactionby.Value);
            ...
            try
            {
                if ((File.Exists(eduxmlpath)) || (File.Exists(traxmlpath)) || (File.Exists(expxmlpath)))
                {
                    ...
                    dgvexp.DataSource = ""; dgvexp.DataBind(); Clearcontrols(); strinformation = ""; pnlpersonalinformation.DataBind();
                }
                else
        ...
        public void Clearcontrols()
        {
            ...
            txtTotal.Text = ""; txtFullName.Text = "";
        }
