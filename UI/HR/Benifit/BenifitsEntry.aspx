    ...
    <table class="tbldecoration" style="width:auto; float:left;">
       ...
       <tr><td colspan="4" class="auto-style2"></td></tr>
        ...
        <tr>
            ...
            <td class="" style="text-align:right;"><asp:Label ID="Label11" CssClass="lbl" runat="server" Text="Date : "></asp:Label></td>
            <td class=""><asp:TextBox ID="txtDate" runat="server" CssClass="txtBox1"></asp:TextBox>
