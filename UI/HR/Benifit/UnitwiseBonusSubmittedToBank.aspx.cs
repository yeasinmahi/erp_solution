...
{
    public partial class UnitwiseBonusSubmittedToBank : BasePage
    {
        ...
        protected void dgvUnitwiseBonusSubmittedToBank_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        public string GetStr(object intUnitID, object intBonusId)
        {
            return "ShowBonusAdviceToBank('" + intUnitID.ToString() + "','" + intBonusId.ToString() + "')";
        }
        protected void ddlBonusType_DataBound(object sender, EventArgs e)
        {
            hdnLoginUserId.Value = Session[SessionParams.USER_ID].ToString();
            dgvUnitwiseBonusSubmittedToBank.DataBind();
        }
