    ...
    <form id="frmselfresign" runat="server">
        ...
        <div class="leaveApplication_container">
            ...
            <ItemStyle HorizontalAlign="Left" Width="250px"/></asp:TemplateField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="Medical Type" SortExpression="strMedicaltype">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMedicaltype" runat="server" Text='<%# Bind("strMedicaltype") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
