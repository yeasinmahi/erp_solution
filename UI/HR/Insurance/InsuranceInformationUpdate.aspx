        ...
        <table>
            <tr>
             ...
             <tr>
               ...
               <tr>
                   <td style="text-align:right;"> <asp:Label ID="lblTtype" font-size="small" runat="server" CssClass="lbl" Text="Type"></asp:Label></td>
                <td style="text-align:left;"><asp:DropDownList ID="drdltype" runat="server">
        ...
        <table  class="tbldecoration" style="width:auto; float:left;">  
           ...
           <%--<asp:TemplateField HeaderText="Parent" SortExpression="SlParent"><ItemTemplate>            
            ...
            <ItemStyle HorizontalAlign="Left" Width="250px"/></asp:TemplateField>--%>
                ...
                <asp:TemplateField HeaderText="UpdateInsuranceType"><ItemTemplate><asp:DropDownList ID="drdlInsuranceType2" runat="server" CssClass="ddList" Width="150px" AutoPostBack="false">
                </asp:DropDownList></ItemTemplate></asp:TemplateField>
                 
                 <asp:TemplateField HeaderText="pkid" SortExpression="strMedical"><ItemTemplate>
                      <asp:HiddenField ID="hdnintpkid" runat="server" Value='<%# Eval("intpkid") %>' />
            <asp:Label ID="lblpkid" runat="server" Text='<%# Bind("intpkid") %>' Width="100px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="250px"/></asp:TemplateField>
