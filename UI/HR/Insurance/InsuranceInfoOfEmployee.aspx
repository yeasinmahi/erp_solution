...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <div id="divcontentholder" class="leaveApplication_container"> <asp:HiddenField ID="hdnEnrollUnit" runat="server" /> 

    <table class="tbldecoration" style="width:auto; float:left;">
    <tr class="tblheader"><td colspan="4"> INSURANCE INFORMATION OF EMPLOYEE</td></tr>
   
    <tr class="tblroweven">    
        
        <td style="text-align:right;" class="auto-style1"><asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Employee-Search : "></asp:Label></td>
            <td style="text-align:left;" class="auto-style1"><asp:TextBox ID="txtEmployeeSearch" runat="server" AutoPostBack="true"  CssClass="txtBox" Width="210px" OnTextChanged="txtEmployeeSearch_TextChanged"></asp:TextBox>
            ...
            <td style="text-align:right;" class="auto-style1"> <asp:Label ID="Label6" font-size="small" runat="server" CssClass="lbl" Text=""></asp:Label></td>
            <td style="text-align:left;" class="auto-style1"><asp:CheckBox ID="chkGroup" runat="server" Text=" Group" AutoPostBack="true" OnCheckedChanged="chkGroup_CheckedChanged" />
...
<input id="platypus" type="checkbox" name="monotreme" value="platypus" />
  <select name="answer" id="answer">
    ...
    <tr class="tblroweven"> 
        ...
        <td style="text-align:right;"><asp:Label ID="Label4" CssClass="lbl" runat="server" Text="Contact No. : "></asp:Label></td>
        <td><asp:TextBox ID="txtContact" BackColor="LightGray" runat="server" CssClass="txtBox" ReadOnly="true" Enabled="true" ></asp:TextBox></td>       
    ...
    <tr class="tblroweven">          
        ...
        <td style="text-align:right;"><asp:Label ID="Label3" Font-Bold="true" ForeColor="Green" CssClass="lbl" runat="server" Text="Date Of Birth : "></asp:Label></td>
        <td><asp:TextBox ID="txtDateOfB" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true"></asp:TextBox>
            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateOfB"></cc1:CalendarExtender></td>   
    ...
    <tr><td colspan="4"><hr /></td></tr>  
    <tr class="tblheader"><td colspan="4">Dependant Information :</td></tr> 
    <tr class="tblrowodd">                                     
        <td style="text-align:right;"><asp:Label ID="lblDependantName" CssClass="lbl" runat="server" Text="Dependant Name : "></asp:Label></td>
        <td><asp:TextBox ID="txtDependantName" runat="server" CssClass="txtBox" Enabled="true"></asp:TextBox></td>
        
        <td style="text-align:right;"><asp:Label ID="lblRelationType" CssClass="lbl" runat="server" Text="Relation : "></asp:Label></td>
        <td>
    ...
    <tr class="tblrowodd">
        <td style="text-align:right;"><asp:Label ID="lblInDate" runat="server" CssClass="lbl" Text="Date Of Birth :"></asp:Label></td>                
            <td><asp:TextBox ID="txtDateOfBirthD" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true"></asp:TextBox>
            <cc1:CalendarExtender ID="fdt" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateOfBirthD"></cc1:CalendarExtender></td>   
    ...
    <tr><td colspan="4"> 
        ...
        <asp:TemplateField HeaderText="Dependant Name" SortExpression="dependantn"><ItemTemplate>            
        <asp:Label ID="lbldependantn" runat="server" Text='<%# Bind("dependantn") %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="320px"/></asp:TemplateField>

        <asp:TemplateField HeaderText="Relation" SortExpression="relation"><ItemTemplate>            
        <asp:Label ID="lblrelation" runat="server" Text='<%# Bind("relation") %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="105px"/></asp:TemplateField>

        <asp:TemplateField HeaderText="Date Of Birth" SortExpression="dateofbirthd"><ItemTemplate>            
        <asp:Label ID="lbldateofbirthd" runat="server" Text='<%# Bind("dateofbirthd") %>'></asp:Label></ItemTemplate>
