<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Familyday.aspx.cs" Inherits="UI.HR.Penalty.Familyday" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr class="tblheader"><td colspan="4"> Akij Group Corporate Family Day' 2019:<asp:HiddenField ID="hdnconfirm" runat="server" />
    <asp:HiddenField ID="hdncode" runat="server" /></td></tr>
        
    <tr class="tblrowodd"><td style="text-align:right;"><asp:Label ID="lblsrch" CssClass="lbl" runat="server" Text="Name : "></asp:Label></td>
    <td><asp:TextBox ID="txtEmployeeSearch" runat="server" CssClass="txtBox" AutoPostBack="false" Enabled="false"></asp:TextBox></td>
    ...
    <td><asp:TextBox ID="txtSDOB" runat="server" CssClass="txtBox" ReadOnly="true" autocomplete="off"></asp:TextBox><asp:HiddenField ID="hdnsdob" runat="server"/>
    ...
    <td><asp:TextBox ID="txtCDOB" runat="server" CssClass="txtBox" ReadOnly="true" autocomplete="off"></asp:TextBox><asp:HiddenField ID="hdncdob" runat="server"/>
