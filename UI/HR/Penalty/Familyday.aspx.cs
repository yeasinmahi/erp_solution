    ...
    public partial class Familyday : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    hdnsearch.Value = HttpContext.Current.Session[SessionParams.USER_CODE].ToString();
        ...
        private void FillControls(string employeeCode)
        {
            ...
            if (objDT.Rows.Count > 0)
            {
                ...
                hdnsearch.Value = employeeCode;// objDT.Rows[0]["strEmployeeCode"].ToString();
        ...
        private void LoadGridwithXml()
        {
            try
            {
                ...
                else { dgvfml.DataSource = ""; } dgvfml.DataBind(); txtChild.Text = ""; txtDOB.Text = "";
            }
            catch { }
        }
