<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentSearch.aspx.cs" Inherits="UI.HR.DocumentTracking.DocumentSearch" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container" align="Center" >Document Search</div>
       ...
       <table>
           <tr >                  
            ...
            <tr>
               <td style="text-align:right" colspan="4"><asp:Button ID="btnShow" runat="server" Text="Show" OnClick="btnShow_Click" /></td>
            </tr>
              ...
              <tr>
                   <td>
                       <asp:GridView ID="dgvDocReq" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
                        ...
                        <ItemTemplate><asp:Button ID="btnDownload" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" 
                        CommandArgument='<%# Eval("intDocRegID") %>'    Text="Download" OnClick="btnDownload_Click"/>
