<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentIssue.aspx.cs" Inherits="UI.HR.DocumentTracking.DocumentIssue" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container" align="Center" >Document Issue</div>
        <table>
               <tr>
        ...
        <table>
              <tr>
                   <td>
                       <asp:GridView ID="dgvDocIssue" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Issue" >
                        <ItemTemplate><asp:Button ID="btnIssue" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" 
                        CommandArgument='<%# Eval("intID") %>'    Text="Issue" OnClick="btnIssue_Click"/>
