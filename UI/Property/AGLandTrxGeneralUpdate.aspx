<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGLandTrxGeneralUpdate.aspx.cs" Inherits="UI.Property.AGLandTrxGeneralUpdate" %>
...
<head runat="server">
    <title>AG Land Trx. General Update</title>
...
<body>
    <form id="frmAGLandTrxGeneralUpdate" runat="server">
        ...
        <asp:HiddenField runat="server" ID="hfAGLPKID" />
                    ...
                    <asp:View runat="server" ID="viewLMMaster">
                        <table class="table70">
                            ...
                            <tr>
                                ...
                                <td class="td-txt-ddl2">
                                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="txt-field" TextMode="MultiLine" Text="N/A" AutoComplete="off"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table70">
                            ...
                            <tr>
                                ...
                                <td class="td-txt-ddl2">
                                    <asp:TextBox ID="txtMutationFee" runat="server" CssClass="txt-field" AutoComplete="off"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td-lbl2">
                            ...
                            <tr>
                                ...
                                <td class="td-txt-ddl2" colspan="2">
                                    ...
                                    <asp:TextBox ID="txtPercentage" style="width:50px" runat="server" CssClass="txt-field" AutoComplete="off" 
                        ...
                        <table class="table70">
                            ...
                            <tr>
                                <td colspan="4">
                                    <asp:Button runat="server" ID="btnMasterDataUpdate" CssClass="btn btn-submit" style="float:right;margin-right:6%" Text="Update Master Data" OnClick="btnMasterDataUpdate_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:View>
                            ...
                            <div class="div-body-left2">
                                ...
                                <table class="table3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-txt-ddl2">
                                            <asp:TextBox ID="txtPurchasedPlot" runat="server" CssClass="txt-field" AutoComplete="off" AutoPostBack="true" OnTextChanged="txtPurchasedPlot_TextChanged"></asp:TextBox>
                        ...
                        <div style="margin-top: 2px">
                            <table class="table2" style="width: 30%">
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:Button ID="btnFileAdd" runat="server" Text="Add Document" CssClass="btn btn-add" OnClick="btnFileAdd_Click" Style="float: right;margin-right: 17%; margin-left: 2px;"></asp:Button>
                                        <asp:Button ID="btnFileUploadSubmit" runat="server" class="btn btn-submit" Font-Bold="true" Style="float: right;" 
                                            OnClientClick="FTPUpload1()" Text="Update Document" />
                                    </td>
                                </tr>
                            </table>
                            <div style="margin-top: 5px"></div>
