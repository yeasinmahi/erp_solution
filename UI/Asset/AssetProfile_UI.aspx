<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetProfile_UI.aspx.cs" Inherits="UI.Asset.AssetProfile_UI" %>
...
<body>
      ...
      <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
        ...
        <div id="divControl" class="divPopUp2" style="width: 100%; height: 80px; float: right;">
           ...
           <tr>
                ...
                <td>&nbsp</td>
                <td colspan="2">
                     <asp:DropDownList ID="ddlJobStation" runat="server"></asp:DropDownList>
  ...
  <td> Report Type</td>
                <td>&nbsp</td>
                <td colspan="2">
                     <asp:DropDownList ID="DdlReportType" runat="server"></asp:DropDownList></td>
               <td>
