...
namespace UI.Asset
{
    public partial class AssetManualRegistration :BasePage
    {
        ...
        protected void DdlUnit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string assetcode = "0".ToString();
            int Mnumber = Int32.Parse(DdlUnit.SelectedValue.ToString());
            ...
            int intUnitID = Int32.Parse(DdlUnit.SelectedValue.ToString());
            dt = objregister.RegCostCenter(intUnitID);
            DdlCostCenterF.DataSource = dt;
            DdlCostCenterF.DataTextField = "Name";
            DdlCostCenterF.DataValueField = "Id";
        ...
        protected void ddlUnits_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string assetcode = "0".ToString();
            int Mnumber = int.Parse(ddlUnits.SelectedValue.ToString());
            ...
            int Unitid = int.Parse(ddlUnits.SelectedValue.ToString());
            ...
            dt = objregister.DepertmentName(int.Parse(Ddljob.SelectedValue));
            DdlDepartments.DataSource = dt;
            DdlDepartments.DataTextField = "strDepatrment";
            DdlDepartments.DataValueField = "intDepartmentID";
            DdlDepartments.DataBind();
