<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepreciationConfig_UI.aspx.cs" Inherits="UI.Asset.DepreciationConfig_UI" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container" align="Center" >Dpreciation Configuration</div>
                ...
                <td><asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="True" CssClass="ddList" Width="100" OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged" ></asp:DropDownList> </td>
               ...
               <asp:GridView ID="dgvGridView" runat="server" AutoGenerateColumns="False" OnRowDataBound = "OnRowDataBound" >
                   <Columns>
                           ...
                           <ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="GlobalCOA" Visible="False">
                                  <ItemTemplate>
                                      <asp:Label ID="intGlobalCOA" runat="server" Text='<%# Eval("intGlobalCOA") %>'></asp:Label>
                                  </ItemTemplate>
                        </asp:TemplateField>
                       <asp:TemplateField HeaderText="strCOACode" Visible="False">
                                  <ItemTemplate>
                                      <asp:Label ID="strCOACode" runat="server" Text='<%# Eval("strCOACode") %>'></asp:Label>
                                  </ItemTemplate>
                        </asp:TemplateField>
                             
                    <asp:BoundField DataField="strCOAName" HeaderText="GL.COA.Name" SortExpression="strCOAName"/>
                       <asp:BoundField DataField="strUnit" HeaderText="Unit" SortExpression="strUnit" />
                     
                             <asp:TemplateField HeaderText="Depreciation Percentage">
                                 <ItemTemplate>
                                     <asp:TextBox ID="TxtPercentage" runat="server" Text='<%# Bind("decDepreciation") %>'></asp:TextBox>
                                 </ItemTemplate>
                             </asp:TemplateField>
