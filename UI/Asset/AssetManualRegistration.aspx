...
<head runat="server">
    ...
    <script>
        function Confirm() {
            ...
            try { var dept = e.options[e.selectedIndex].value; } catch (err) {var dept=0 } 

            if ($.trim(TxtAssetName) == 0 || $.trim(TxtAssetName) == "" || $.trim(TxtAssetName) == null || $.trim(TxtAssetName) == undefined || $.trim(TxtAssetName) == " ") { document.getElementById("hdnconfirm").value = "0"; alert('Please set valid asset Name'); }
            else if ($.trim(TxtManuProvideSl) == 0 || $.trim(TxtManuProvideSl) == "" || $.trim(TxtManuProvideSl) == null || $.trim(TxtManuProvideSl) == undefined) { document.getElementById("hdnconfirm").value = "0"; alert('Please set manufacturing sl No'); }
            else if ($.trim(TxtDteInstalation) == 0 || $.trim(TxtDteInstalation) == "" || $.trim(TxtDteInstalation) == null || $.trim(TxtDteInstalation) == undefined) { document.getElementById("hdnconfirm").value = "0"; alert('Please set Instalation Date'); }
            else if ($.trim(dept) == 0 || $.trim(dept) == "" || $.trim(dept) == null || $.trim(dept) == undefined) { document.getElementById("hdnconfirm").value = "0"; alert('Please select Department'); }
            else {
            ...
            <ContentTemplate>
                ...
                <%--=========================================Start My Code From Here===============================================--%>
                    <div class="leaveApplication_container">
                        ...
                        <input type="hidden" id="DATE" name="DATE" value="WOULD_LIKE_TO_ADD_DATE_HERE">
                        <td>
                            <asp:Button Text="General Registration" BorderStyle="Solid" ID="Tab1" CssClass="Initial" runat="server" OnClick="Tab1_Click" BackColor="#FFCC99" />
                            <asp:Button Text="Vehicle Registration" BorderStyle="Solid" ID="Tab2" CssClass="Initial" runat="server" BackColor="#FFCC99" OnClick="Tab2_Click" />
                            <asp:Button Text="Land Registration" BorderStyle="Solid" ID="Tab3" CssClass="Initial" runat="server" OnClick="Tab3_Click" BackColor="#FFCC99" />
                            <asp:Button Text="Building Registration" BorderStyle="Solid" ID="Tab4" CssClass="Initial" runat="server" OnClick="Tab4_Click" BackColor="#FFCC99" />
             ...
             <tr>
                 ...
                 <td>
                  ...
                  <tr>
                        ...
                        <td></td>
                        <td style="text-align:right;">
                            <asp:Button ID="btnGeneral" runat="server" OnClientClick="Confirm();" OnClick="BtnGeneral_Click"  Text="Save" Width="128px" />
                        </td>
                    </tr>                   
             </table>
              <table>
...
<tr>
           ...
           <td style="text-align:right;"> <asp:Label ID="Label70" runat="server" CssClass="lbl" Text="SA Dag No : "></asp:Label>
            ...
            <td> <asp:TextBox ID="txtdagcs" runat="server"  TextMode="Number" CssClass="txtBox"></asp:TextBox><span style="color:red">*</span></td>
            <td style="text-align:right"><asp:Label ID="Labeldagsa" CssClass="lbl" runat="server" Text="DAG SA:  " ></asp:Label></td>   
            <td> <asp:TextBox ID="txtdagsa" runat="server"  TextMode="Number" OnTextChanged="txtdagsa_TextChanged" CssClass="txtBox"></asp:TextBox></td>

            <td style="text-align:right"><asp:Label ID="Labeldagrs" CssClass="lbl" runat="server" Text="DAG RS:  " ></asp:Label></td>   
            <td> <asp:TextBox ID="txtdagrs" runat="server"  TextMode="Number" CssClass="txtBox" OnTextChanged="txtdagrs_TextChanged"></asp:TextBox></td></tr>                
