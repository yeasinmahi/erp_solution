    ...
    public partial class AssertReport : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { 
                ...
                Mnumber = Int32.Parse("0".ToString());
                pnlUpperControl.DataBind();
                dt = new DataTable();
                intItem = 40;
            
                dt = objPMConfigure.JobstationDropdoownlist(intItem, Mnumber, intenroll, intjobid, intdept);
                ...
                dt = objPMConfigure.JobstationDepartment(intItem, Mnumber, intenroll, intjobid, intdept);
                ...
                dt = new DataTable();
                intItem =56;
                dt = objPMConfigure.ReportpageAssetTypeName(intItem, Mnumber, intenroll, intjobid, intdept);
        ...
        protected void BtnReport_Click(object sender, EventArgs e)
        {
            DateTime dtefrom;
            DateTime dteto;
            Int32 intjobid = Int32.Parse(DdlJostation.SelectedValue.ToString()); ;
            ...
            Int32 intdept = Int32.Parse(DdlDept.SelectedValue.ToString());
