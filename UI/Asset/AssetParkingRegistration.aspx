...
<head runat="server">
    ...
    color:Green;
     ...
     <script type="text/javascript">
        ...
        width:100%; height: 100%;    margin-left:100px;  margin-top:100px; margin-right:00px; padding: 15px; overflow-y:scroll; }
        </style>
    ...
    <style type="text/css"> 
        ...
        width:80%; height:80%;    margin-left:100px;  margin-top:20%; margin-right:00px; padding: 15px; overflow-y:scroll; }
        </style>
     <style type="text/css"> 
        .rounds {
        height:100px;
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnEnrollUnit" runat="server" /><asp:HiddenField ID="hdnReceive" runat="server" /><asp:HiddenField ID="hdnItemID" runat="server" />
     ...
     <%--   General Asset Parking Registratiron         class="hdnDivision" --%>
                ...
                <tr><td style="text-align:left;" colspan="4"><asp:Label ID="Label105" CssClass="lbl" runat="server" Font-Size="small" Font-Bold="true"  Text="Asset Additon/Recognition/Registration: "></asp:Label></td>
                </tr>
               ...
               <td style="text-align:right;"><asp:Label ID="Label15" CssClass="lbl" runat="server" Text="Asset Name:"></asp:Label></td>
                ...
                <td><asp:DropDownList ID="ddlAssetType" runat="server"  CssClass="dropdownList"  >
