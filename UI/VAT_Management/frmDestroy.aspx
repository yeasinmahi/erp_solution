...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr><td style="text-align:right"></td>                                     
     ...
     <tr><td>
        ...
        <ItemTemplate><asp:Label ID="lblpurchasevat" runat="server" Text='<%# Bind("purchasevat","{0:n0}") %>' Width="50px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="100px" />
        <FooterTemplate><asp:Label ID="lblllbpurchasevat" runat="server" DataFormatString="{0:n0}" Text="<%# totalPurchasevat %>" /></FooterTemplate>
        </asp:TemplateField>
