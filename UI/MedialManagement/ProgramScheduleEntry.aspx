    ...
    <div class="divbody" style="padding-right:10px;">
        ...
        <table class="tbldecoration" style="width:auto; float:left;">
            ...
            <tr>
                ...
                <td style="text-align:left"><asp:DropDownList ID="ddlSupplierName" runat="server" CssClass="ddList" Width="225px" height="23px" BackColor="WhiteSmoke"></asp:DropDownList></td>
