<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePermit.aspx.cs" Inherits="UI.Vehicle_Registration_Renewal.RoutePermit" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnMillage" runat="server" /><asp:HiddenField ID="hdnHightMilage" runat="server" />
        ...
        <tr>  
            ...
            <td style="text-align:left;"><asp:TextBox ID="TxtUnit" runat="server" CssClass="txtBox"  ReadOnly="true" BorderColor="green" Width="190px"></asp:TextBox>
        ...
        <td style="text-align:right;"><asp:Label ID="Label2" runat="server" CssClass="lbl" Text="RoutePermit"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtRootPermit" runat="server" CssClass="txtBox"  ReadOnly="true"  BorderColor="green" Width="190px"></asp:TextBox></td>                                                                                                              
       ...
       <td style="text-align:right;"><asp:Label ID="Label4" runat="server" CssClass="lbl" Text="RoutePermit Misc"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtRootMisc" runat="server"   ReadOnly="true" CssClass="txtBox"  BorderColor="green" Width="190px"></asp:TextBox></td>                                                                                                              
