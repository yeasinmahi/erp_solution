<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportYearlyCostDetaills.aspx.cs" Inherits="UI.Vehicle_Registration_Renewal.TransportYearlyCostDetaills" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> Vheicle renewal Cost Report :<asp:HiddenField ID="hdnAreamanagerEnrol" runat="server"/>
        ...
        <td> <asp:TextBox ID="txtVheicleNumber" runat="server" BackColor="#ffff99"  AutoPostBack="false" CssClass="txtBox"  Width="200px" ></asp:TextBox></td>
                ...
                <td>
                    ...
                    <asp:GridView ID="grdvForRouteTransportcostDet" runat="server" Font-Size="Smaller" AutoGenerateColumns="False" AllowPaging="false"  BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" HeaderStyle-Wrap="true" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="grdvForRouteTransportcostDet_PageIndexChanging" OnRowDataBound="grdvForRouteTransportcostDet_RowDataBound" style="margin-top: 21px">
                     ...
                     <Columns>
                        ...
                        <ItemTemplate><asp:Label ID="Label78" runat="server" Text='<%# Eval("aprv78") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <ItemTemplate>
                        <asp:Button ID="btnDetRegistration" runat="server" class="button" CommandName="complete" OnClick="btnDetRegistration_Click"   CommandArgument='<%# Eval("id78") %>'  Text='<%# Bind("aprv78") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                    ...
                    <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label79" runat="server" Text='<%# Eval("aprv79") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="Det.">
                        <ItemTemplate>
                        <asp:Button ID="btnDetTaxToken" runat="server"  class="button" CommandName="complete" OnClick="btnDetTaxToken_Click"   CommandArgument='<%# Eval("id79") %>'  Text='<%# Bind("aprv79") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                      ...
                      <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label80" runat="server" Text='<%# Eval("aprv80") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="Det.">
                        <ItemTemplate>
                        <asp:Button ID="btnDetFitness" runat="server"  class="button" CommandName="complete" OnClick="btnDetFitness_Click"   CommandArgument='<%# Eval("id80") %>'  Text='<%# Bind("aprv80") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:BoundField DataField="id81" HeaderText="idRoutePermit" Visible="false" SortExpression="310081" />
                        ...
                        <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label81" runat="server" Text='<%# Eval("aprv81") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Det.">
                        <ItemTemplate>
                        <asp:Button ID="btnDetRoutePermit" runat="server"  class="button" CommandName="complete" OnClick="btnDetRoutePermit_Click"   CommandArgument='<%# Eval("id81") %>'  Text='<%# Bind("aprv81") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label82" runat="server" Text='<%# Eval("aprv82") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Det.">
                        <ItemTemplate>
                        <asp:Button ID="btnDetInsurance" runat="server" class="button" CommandName="complete" OnClick="btnDetInsurance_Click"   CommandArgument='<%# Eval("id82") %>'  Text='<%# Bind("aprv82") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                       ...
                       <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label83" runat="server" Text='<%# Eval("aprv83") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Det.">
                        <ItemTemplate>
                        <asp:Button ID="btnDetNamePlate" runat="server"  class="button" CommandName="complete" OnClick="btnDetNamePlate_Click"   CommandArgument='<%# Eval("id83") %>'  Text='<%# Bind("aprv83") %>' /></ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:BoundField DataField="DRC" HeaderText="DRC Cost" SortExpression="DRC" ItemStyle-HorizontalAlign="Center" />
                         <asp:TemplateField HeaderText="Status" Visible="false" ControlStyle-Width="75px" >
                        <ItemTemplate><asp:Label ID="Label108" runat="server" Text='<%# Eval("aprv108") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Det.">
                          <ItemTemplate>
                        <asp:Button ID="btnDRC" runat="server" class="button" CommandName="complete" OnClick="btnDRC_Click"   CommandArgument='<%# Eval("id108") %>'   Text='<%# Bind("aprv108") %>' /></ItemTemplate>
                        </asp:TemplateField> 
