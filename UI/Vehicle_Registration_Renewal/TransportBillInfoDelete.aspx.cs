...
{
    public partial class TransportBillInfoDelete : System.Web.UI.Page
    {
        ...
        private void LoadFieldValue(string vhclname)
        {
            try
            {
                ...
                objDT = bll.RouteTransportCostDelete(strvheiclename);
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt = bll.RouteTransportCostDelete(strvheiclename);
            }
            catch
            {
                //
        ...
        protected void btnDetRegistration_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                message = bll.transportcostdeletebyuser(AutoID, inactiveby);
