<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Registration_UI.aspx.cs" Inherits="UI.Vehicle_Registration_Renewal.Print_Registration_UI" %>
        ...
        <tr> 
           <td style="text-align:right;"><asp:Label ID="lblVehicleT" runat="server" CssClass="lbl" Text="Vehicle Number :"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="txtVehicleName" runat="server" CssClass="txtBox"   ReadOnly="true" Width="398px" ></asp:TextBox>
             ...
             <tr> 
           <td style="text-align:right;"><asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Vehicle Type :"></asp:Label></td>                  
