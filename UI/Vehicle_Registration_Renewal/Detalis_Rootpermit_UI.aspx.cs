...
{
    public partial class Detalis_Rootpermit_UI : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                TxtNextExp.Text =Convert.ToDateTime(dt.Rows[0]["dteNextSubmitDate"].ToString()).ToShortDateString();
                TxtExpire.Text = Convert.ToDateTime(dt.Rows[0]["dteExpireDate"].ToString()).ToShortDateString();
