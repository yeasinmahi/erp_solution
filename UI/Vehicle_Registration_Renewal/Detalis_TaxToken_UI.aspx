<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detalis_TaxToken_UI.aspx.cs" Inherits="UI.Vehicle_Registration_Renewal.Detalis_TaxToken_UI" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnMillage" runat="server" /><asp:HiddenField ID="hdnHightMilage" runat="server" />
        ...
        <div class="tabs_container">Tax Token Bill <hr /></div>
        ...
        <tr> 
           ...
           <td style="text-align:right;"><asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Vehicle Type :"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtVehicleType" runat="server" CssClass="txtBox"   ReadOnly="true" Width="398px" ></asp:TextBox>
                </td>
                  </tr>
             <tr> 
