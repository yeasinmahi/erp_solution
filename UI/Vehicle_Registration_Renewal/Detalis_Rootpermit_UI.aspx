<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detalis_Rootpermit_UI.aspx.cs" Inherits="UI.Vehicle_Registration_Renewal.Detalis_Rootpermit_UI" %>
        ...
        <tr> 
           <td style="text-align:right;"><asp:Label ID="lblVehicleT" runat="server" CssClass="lbl" Text="Vehicle Number :"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="txtVehicleName" runat="server" CssClass="txtBox"   ReadOnly="true" Width="398px" ></asp:TextBox>
             ...
             <tr> 
           <td style="text-align:right;"><asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Vehicle Type :"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtVehicleType" runat="server" CssClass="txtBox"   ReadOnly="true"  ></asp:TextBox>
                </td>
                  </tr>
             <tr> 
           <td style="text-align:right;"><asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Renewal Date:"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtRegistrationDate" runat="server" CssClass="txtBox"  ReadOnly="true" Width="190px" ></asp:TextBox>
             ...
             <tr> 
           <td style="text-align:right;"><asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Exp.Date:"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtExpire" runat="server" CssClass="txtBox"  ReadOnly="true" Width="190px" ></asp:TextBox>
                </td>
                  </tr>
            <tr> 
           <td style="text-align:right;"><asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Next Exp.Date:"></asp:Label></td>                  
            <td style="text-align:left;"><asp:TextBox ID="TxtNextExp" runat="server" CssClass="txtBox"  ReadOnly="true" Width="190px" ></asp:TextBox>
                </td>
                  </tr>
             <tr> 
