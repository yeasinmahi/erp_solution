...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdfEmpCode" runat="server" /><asp:HiddenField ID="hdfSearchBoxTextChange" runat="server" />
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtFromDate" runat="server" Visible="false" AutoPostBack="false" CssClass="txtBox" Enabled="true" Width="210px"></asp:TextBox>
            ...
            <td><asp:TextBox ID="txtToDate" runat="server" Visible="false" AutoPostBack="false" CssClass="txtBox" Enabled="true" Width="210px"></asp:TextBox>
