...
<head runat="server">
    ...
    <script>
        function ConfirmAll() {
            ...
            var txtDriverName = document.forms["frmgp"]["txtDriverName"].value;
            var txtContact = document.forms["frmgp"]["txtContact"].value;
...
<body>
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                    ...
                    <table border="0" style="width: Auto">
                        <tr class="tblrowodd">
                            <td style="text-align: right;">
                                <asp:Label ID="lbldt" CssClass="lbl" runat="server" Text="Date : "></asp:Label>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="lblfadd" CssClass="lbl" runat="server" Text="From-Address : "></asp:Label>
                                <span style="color: red; font-size: 14px; text-align: left">*</span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtFromAddress" runat="server" CssClass="txtBox" Enabled="false"></asp:TextBox></td>
                        </tr>


                        <tr class="tblrowodd">
                            <td style="text-align: right;">
                                <asp:Label ID="lblto" CssClass="lbl" runat="server" Text="To-Address : "></asp:Label>
                                <span style="color: red; font-size: 14px; text-align: left">*</span>
                            </td>
                            <td colspan="3">
                                <asp:TextBox ID="txtAddress" runat="server" AutoCompleteType="Search" CssClass="txtBox" AutoPostBack="true" Width="427px"></asp:TextBox>
        ...
        <asp:ObjectDataSource ID="odspnt" runat="server" SelectMethod="GetAllJobStation" TypeName="HR_BLL.Global.JobStation"></asp:ObjectDataSource>--%>
                                ...
                                <asp:TextBox ID="txtToOther" Width="467px" runat="server" CssClass="txtBox"></asp:TextBox></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtDriverName" runat="server" CssClass="txtBox" Width="477"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="Label2" CssClass="lbl" runat="server" Text="Contact No:"></asp:Label>
                                <span style="color: red; font-size: 14px; text-align: left">*</span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtContact" runat="server" CssClass="txtBox" TextMode="Phone"></asp:TextBox>
                            </td>
                            <td style="text-align: right;">
                                <asp:Label ID="Label3" CssClass="lbl" runat="server" Text="Vehicle:"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtVehicle" runat="server" CssClass="txtBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="lblquantity" CssClass="lbl" runat="server" Text="Quantity : "></asp:Label>
                                <span style="color: red; font-size: 14px; text-align: left">*</span>
                            </td>
                            <td colspan="2">
