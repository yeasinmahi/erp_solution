<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandItemChallanComplete.aspx.cs" Inherits="UI.Inventory.BrandItemChallanComplete" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" SkinID="sknGrid1" runat="server" 
                ...
                DataKeyNames="intId" DataSourceID="odschallaninfo" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>                            
                            <a href="#" onclick="ShowPopUpC('BrandItemChallanPrint.aspx?id=<%# Eval("intId") %>&unit=<%# ddlUnit.SelectedValue %>')" class="link">Print</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
            ...
            <asp:ObjectDataSource ID="odschallaninfo" runat="server" SelectMethod="GetBrandItemInformationForChallan" TypeName="HR_BLL.TourPlan.TourPlanning">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlUnit" Name="unitID" PropertyName="SelectedValue" Type="String" />
                    <asp:ControlParameter ControlID="ddlShip" Name="shippointid" PropertyName="SelectedValue" Type="String" />
                    <asp:ControlParameter ControlID="ddlSo" Name="salesofficeid" PropertyName="SelectedValue" Type="String" />
                    ...
                    <asp:ControlParameter ControlID="rdoComplete" Name="rdbselection" PropertyName="SelectedValue" Type="String" />
                </SelectParameters>
            </asp:ObjectDataSource>
