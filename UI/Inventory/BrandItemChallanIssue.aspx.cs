...
{
    public partial class BrandItemChallanIssue : BasePage
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (table.Rows.Count > 0)
                    {
                        ...
                        {
                            string[][] items = xm.CreateItemsbrand(tbl[i].BrandPid.ToString()
                                , tbl[i].strItemName
                                , tbl[i].numQuantity.ToString()
                                , tbl[i].intUOMId.ToString()
                                , tbl[i].strUOM.ToString()
                                , tbl[i].strNarration
                                //  , tbl[i].
                                //, tbl[i].() ? "0" : tbl[i].intPromItemCOAId.ToString()
                                );
        ...
        public static string[] GetProductList(string prefixText, int count)
        {
            ...
            return TourPlanning.GetProductDataForAutoFill(HttpContext.Current.Session[SessionParams.CURRENT_UNIT].ToString(), prefixText);
 ...
 //&& rest >= 0
            if (ddlUOM.Items.Count > 0 && hdnCustomer.Value != "" && hdnProduct.Value != "" && txtQun.Text.Trim() != "") // Change By konock @ 14052016
            {
                ...
                //{
                    ...
                    string[][] items = xm.CreateItemsbrand(hdnProduct.Value, hdnProductText.Value
