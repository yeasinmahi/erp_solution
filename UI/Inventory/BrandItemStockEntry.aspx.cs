...
{
    public partial class BrandItemStockEntry : System.Web.UI.Page
    {
        ...
        {
            xmlpath = Server.MapPath("~/Inventory/Data/BrandITEMReceivbywh_" + HttpContext.Current.Session[SessionParams.USER_ID].ToString() + "_" + "brandItemRecvbywh.xml");
            ...
            if (dgv.Rows.Count > 0)
            {
                try
                {
                    ...
                    if (File.Exists(xmlpath))
                    {
                        ...
                        dtbl = bll.CreateBrandItmRecvChallanbyWH(0, int.Parse(HttpContext.Current.Session[SessionParams.USER_ID].ToString()), xmlString, 0, DateTime.Now, DateTime.Now, int.Parse(HttpContext.Current.Session[SessionParams.UNIT_ID].ToString()));
