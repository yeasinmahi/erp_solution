<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandItemRequisitionApprove.aspx.cs" Inherits="UI.Inventory.BrandItemRequisitionApprove" %>
...
<%--=========================================Start My Code From Here===============================================--%>
     ...
     <div id="approvedDiv" style="margin-top:25px;">
        ...
        <asp:Button ID="btnItemDtls" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" CommandArgument='<%# Container.DataItemIndex +"^"+ Eval("Req") + "^"+Eval("Item")+"^"+Eval("Quantity")+"^"+Eval("Section") %>' Text="Histry" OnClick="btnItemDtls_Click"/>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
