<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RAWMaterialTransfer.aspx.cs" Inherits="UI.Inventory.RAWMaterialTransfer" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 450px; float: right;">
                    ...
                    <table style="width: 850px; height: 150px; background-color:lemonchiffon;">
                        <tr>
                            <td>
                                Unit
                            </td>
                        ...
                        <tr class="tblroweven">
                            ...
                            <td class="auto-style1">
                              ...
                              <td style="text-align:center"><asp:Label ID="lblCreatedChallan" CssClass="lbl" BackColor="#00ff00" runat="server"></asp:Label></td> 
                        </tr>
                        <tr class="tblrowodd">
                            <td>
                                Customer
                    ...
                    <table style="width: 850px; background-color:aliceblue;">
                        <tr>
                    ...
                    <table style="width: 850px; background-color:navajowhite;">
                        <tr>
                            <td>
                                <b style="">Product</b>
                            </td>
                            <td>
                                ...
                                <asp:TextBox ID="txtProduct" runat="server" AutoCompleteType="Search" Width="250px"
                                    AutoPostBack="true" OnTextChanged="txtProduct_TextChanged" ReadOnly="False"></asp:TextBox>
                    ...
                    <table style="width: 850px;">
                        <tr style="background-color: #D0B0B0; text-align: center;">
                            <td>
                                UOM
                            </td>
                            <td>
                        ...
                        <tr style="background-color: #D0B0B0;">
                       <td>
                                <asp:HiddenField ID="hdnUOM" runat="server" />
                                <asp:DropDownList ID="ddlUOM" runat="server"  AutoPostBack="True" OnDataBound="ddlUOM_DataBound" OnSelectedIndexChanged="ddlUOM_SelectedIndexChanged" DataSourceID="odsUOM" DataTextField="strUOM" DataValueField="intID">
                                </asp:DropDownList>
                              
                                <asp:ObjectDataSource ID="odsUOM" runat="server" SelectMethod="GetUOMRelationforInventoryitem"
                                    TypeName="HR_BLL.TourPlan.TourPlanning" OldValuesParameterFormatString="original_{0}">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="hdnProduct" DefaultValue="3059" Name="productId" PropertyName="Value"
                                            Type="String" />
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView SkinID="sknGrid1" ID="GridView1" runat="server" DataSourceID="XmlDataSource1"
                            AutoGenerateColumns="False" CaptionAlign="Top" Caption="Brand Item Challan Details" ShowFooter="true" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PName" HeaderText="Brand Item Name" SortExpression="PName" />
                                ...
                                <asp:BoundField DataField="Price" HeaderText="Price" ItemStyle-HorizontalAlign="Right"
                                    SortExpression="Price" Visible="true">
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                 <asp:TemplateField HeaderText="Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label Visible="true" ID="Label3" runat="server" Text='<%# GetTotal(""+Eval("Price"),  ""+Eval("Qnt")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label Visible="true" ID="Label4" runat="server" Text='<%# GetGrandTotal(4) %>'></asp:Label>
                                    </FooterTemplate>
