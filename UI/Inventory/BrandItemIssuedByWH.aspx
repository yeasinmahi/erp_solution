<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandItemIssuedByWH.aspx.cs" Inherits="UI.Inventory.BrandItemIssuedByWH" %>
...
<%--=========================================Start My Code From Here===============================================--%>
        <div class="leaveApplication_container"> <div class="tabs_container"> Brand Item Issue Information by WH : <asp:HiddenField ID="hdnuserid" runat="server"/><asp:HiddenField ID="hdnconfirm" runat="server" /><hr /></div>
        ...
        <ItemStyle HorizontalAlign="Left" Width="70px" /></asp:BoundField>
        <asp:BoundField DataField="AppQuantity" HeaderText="Aprv. Quantity" ItemStyle-HorizontalAlign="Center" SortExpression="AppQuantity" DataFormatString="{0:0.0000}">
