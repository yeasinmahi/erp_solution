...
<body>
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    <div class="tabs_container">Store Requisition Information :
                    ...
                    <table border="0" style="width: Auto">
                        ...
                        <tr>
                            <td style="text-align: right;" colspan="4">
                                <asp:Button ID="btnShow" runat="server" Text="Show" Font-Bold="true" OnClick="btnShow_Click"></asp:Button></td>
                        </tr>
                    ...
                    <table border="0">
                        <tr>
                            <td style="text-align: left; width: 100px;">
                                <asp:Image runat="server" ImageUrl="../Content/images/img/ag.png" ID="img"/>
                            </td>
                            <td style="text-align: center; font: bold 14px verdana;" colspan="3"><b><u>Store Requisition</u></b><br />
                                ...
                                <u><asp:Label ID="lblwh" CssClass="lbl" runat="server" Style="font: bold 11px verdana;"></asp:Label></u>
                            </td>
                        </tr>

                        <tr style="font: bold 10px verdana;">
                            <td style="text-align: right; width: 100px;">
                                <asp:Label ID="lblc" runat="server" Text="Requisition No: "></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td colspan="4" style="font: normal 10px verdana;">
                                <asp:GridView ID="dgv" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="App. Quantity">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdnitemid" runat="server" Value='<%# Eval("Item") %>' />
                                                <asp:HiddenField ID="hdnreq" runat="server" Value='<%# Eval("Quantity") %>' />
                                                <asp:HiddenField ID="hdnreqid" runat="server" Value='<%# Eval("Req") %>' />
                                                <asp:TextBox ID="txtAppQuantity" CssClass="txtBox" runat="server" Width="100px"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Histry">
                                            <ItemTemplate>
        ...
        <asp:Button ID="btnApp" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" CommandArgument='<%# Container.DataItemIndex +"^"+ Eval("Req") + "^"+Eval("Item")+"^"+Eval("Quantity")+"^"+Eval("Section") %>' Text="Approved" OnClientClick="Confirm()"  OnClick="App_Click"/>
                                    ...
                                    <HeaderStyle BorderStyle="Solid" BorderColor="Black" BorderWidth="1px" Font-Bold="True" />
                                    <PagerStyle BackColor="#999999" ForeColor="Black" BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Center" />
                                </asp:GridView>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;" colspan="4">
                                ...
                                <asp:Button ID="btnApp" runat="server" class="nextclick" Style="cursor: pointer; font-size: 11px;" Text="Approved" OnClientClick="Confirm()" OnClick="btnApp_Click" /><br />
                            </td>
                            <tr>
                                <td style="text-align: left;" colspan="3">
                                    <br />
                                    <asp:Label ID="issby" runat="server"></asp:Label></td>
                                <td style="text-align: right;"><a onclick="Closediv(1);" title="Close" style="cursor: pointer; text-align: right; color: red; font: bold 15px verdana;">X</a></td>
                            </tr>
                    </table>
                </div>

                <div id="itmdtlsDiv" style="margin-top: 25px;">
                    <table>
                        <tr>
                            <td style="text-align: right;">
                                <a onclick="CloseItem();" title="Close" style="cursor: pointer; text-align: right; color: red; font: bold 8px verdana;">X</a></td>
                        </tr>
                        <tr>
                            <td>
                                <div id="report" runat="server" style="padding: 1%;"></div>
                            </td>
                        </tr>
                    </table>
                </div>
