<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandItemStockEntry.aspx.cs" Inherits="UI.Inventory.BrandItemStockEntry" %>
             ...
             $("#txtItem").autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         ...
                         url: "BrandItemStockEntry.aspx/GetAutoCompleteBrandItemNameWithStockStatus",
...
<%--=========================================Start My Code From Here===============================================--%>
         ...
         <div class="leaveApplication_container"> <div class="tabs_container"> Brand Item Receive Information by WH : <asp:HiddenField ID="hdnuserid" runat="server"/><asp:HiddenField ID="hdnconfirm" runat="server" /><asp:HiddenField ID="hdnunitid" runat="server"/><hr /></div>
        ...
        <asp:HiddenField ID="hdnAction" runat="server"/><asp:HiddenField ID="hdnunit" runat="server"/><asp:HiddenField ID="hdnwh" runat="server"/>
               ...
               <tr class="tblrowodd">
                ...
                <td colspan="3"><asp:DropDownList ID="ddlWH" runat="server" AutoPostBack="True" CssClass="ddList" DataTextField="WH" DataValueField="intWHID" OnDataBound="ddlWH_DataBound" OnSelectedIndexChanged="ddlWH_SelectedIndexChanged" DataSourceID="odswh"></asp:DropDownList>
