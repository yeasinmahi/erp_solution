<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotmentApprove.aspx.cs" Inherits="UI.Inventory.AllotmentApprove" %>
...
<%--=========================================Start My Code From Here===============================================--%>
         ...
         <div class="leaveApplication_container"> <div class="tabs_container"> Brand Item Requisition Information : <asp:HiddenField ID="hdnuserid" runat="server"/><asp:HiddenField ID="hdnconfirm" runat="server" /><hr /></div>
    ...
    <td colspan="3"><asp:DropDownList ID="ddlWH" runat="server" AutoPostBack="true" CssClass="ddList" DataSourceID="odswh" DataTextField="WH" DataValueField="intWHID" OnDataBound="ddlWH_DataBound" OnSelectedIndexChanged="ddlWH_SelectedIndexChanged"></asp:DropDownList>
    ...
    <SelectParameters><asp:SessionParameter Name="enroll" SessionField="sesUserID" Type="Int32" /><asp:ControlParameter ControlID="hdntype" Name="type" PropertyName="Value" Type="Int32" />
        ...
        BorderWidth="1px" CellPadding="3" GridLines="Horizontal" BorderColor="#E7E7FF"><AlternatingRowStyle BackColor="#F7F7F7" />
        <Columns>
        ...
        <ItemStyle HorizontalAlign="Left" Width="100px"/></asp:BoundField>
        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Details" ControlStyle-BackColor="#ff9999" ><ItemTemplate>
     ...
     <div id="approvedDiv" style="margin-top:25px;">
        <table border="0";>
         ...
         <td style="text-align:center;font:bold 14px verdana;" colspan="3"><b style="font-style:italic"><u>Brand Item Approve</u></b><br />
        ...
        <ItemStyle HorizontalAlign="Left" Width="225px" /></asp:BoundField>
            <asp:BoundField DataField="strPointName" HeaderText="strPointName" ItemStyle-HorizontalAlign="Center" SortExpression="strPointName">
        ...
        <asp:HiddenField ID="hdnreqid" runat="server" Value='<%# Eval("Req") %>'/>
            ...
            <asp:HiddenField ID="hdnUnitid" runat="server" Value='<%# Eval("intUntid") %>'/>
             ...
             <asp:HiddenField ID="hdndirectpointid" runat="server" Value='<%# Eval("intPointid") %>'/>
               <asp:TextBox ID="txtAppQuantity" CssClass="txtBox" runat="server" Width="100px"></asp:TextBox></ItemTemplate>
        ...
        <asp:Button ID="btnItemDtls" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" CommandArgument='<%# Container.DataItemIndex +"^"+ Eval("Req") + "^"+Eval("Item")+"^"+Eval("Quantity")+"^"+Eval("Section")+"^"+Eval("whid")+"^"+Eval("intUntid")+"^"+Eval("DDate")+"^"+Eval("intPointid") %>' Text="Histry" OnClick="btnItemDtls_Click"/>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
