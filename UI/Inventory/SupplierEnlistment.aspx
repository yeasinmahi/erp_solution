...
<body>
   ...
   <asp:ScriptManager ID="ScriptManager0" EnablePageMethods="true" runat="server"></asp:ScriptManager>
    ...
    <div id="divControl" class="divPopUp2" style="width: 100%; height: 97px; float: right;">&nbsp;</div></asp:Panel>
...
<div class="divs_content_container" style="width: 630px; float:left;"> 
 <br />
    <asp:HiddenField ID="hdnconfirm" runat="server" /> <asp:HiddenField ID="hdnUnit" runat="server" />
    <br /><br /> 
    <br />
    <h1 class="auto-style30">New Supplier Enlistment</h1>
        <fieldset class="row2">
            <legend font-size: 10pt; style="color: #3399FF"><span class="auto-style20">Details</span> </legend>
            <table style="height:auto" >

      <tr>
            <td style="text-align:right;"><asp:Label ID="lblSupname" runat="server" CssClass="lbl" Text="Supplier Name :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtSuppliername" runat="server" CssClass="txtBox" Width="190px" BackColor="white" AutoPostBack="true"  OnTextChanged="txtSuppliername_TextChanged" BorderColor="Gray" BorderStyle="Ridge"></asp:TextBox></td>

            <td style="text-align:right;"><asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Contact :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtContactNo" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>
      </tr>

       <tr>
            <td style="text-align:right;"><asp:Label ID="Label2" runat="server" CssClass="lbl" Text="Address :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtAddress" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>

            <td style="text-align:right;"><asp:Label ID="Label6" runat="server" CssClass="lbl" Text="Fax No :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtFax" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>
       </tr>
                
       <tr>
           <td style="text-align:right;"><asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Email :"></asp:Label></td>
           <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtemail" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray" ForeColor="Blue"></asp:TextBox></td>
                  
           <td style="text-align:right;"><asp:Label ID="Label5" runat="server" CssClass="lbl" Text="BIN :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtBin" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>
        </tr>

        <tr>
             <td style="text-align:right;"><asp:Label ID="Label8" runat="server" CssClass="lbl" Text="Vat Reg. :"></asp:Label></td>
             <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtVatReg" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>

             <td style="text-align:right;"><asp:Label ID="Label16" runat="server" CssClass="lbl" Text="TIN :"></asp:Label></td>
             <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtTin" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>         
       </tr>

       <tr>
            <td style="text-align:right;"><asp:Label ID="Label11" runat="server" CssClass="lbl" Text="Trade License :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtTradeLicn" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>

            <td style="text-align:right;"><asp:Label ID="lblCategory" runat="server" CssClass="lbl" Text="Business Type :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style1"><asp:DropDownList ID="ddlBussType" CssClass="ddList" Font-Bold="False" BackColor="Lightgray" BorderColor="Gray" runat="server" Width="195px" ForeColor="Black">
       ...
       <tr>
            <td style="text-align:right;"><asp:Label ID="Label12" runat="server" CssClass="lbl" Text="Contact Person :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtContactP" runat="server" CssClass="txtBox" Width="190px" BackColor="white" BorderColor="Gray"></asp:TextBox></td>

            <td style="text-align:right;"><asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Service Type :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style1"><asp:DropDownList ID="ddlservice" CssClass="ddList" Font-Bold="False" BackColor="Lightgray" BorderColor="Gray" runat="server" Width="195px" ForeColor="Black">
       ...
       <tr>
            <td style="text-align:right;"><asp:Label ID="Label13" runat="server" CssClass="lbl" Text="Phone No :"></asp:Label></td>
            <td style="text-align:left;" class="auto-style5"><asp:TextBox ID="txtPhone" runat="server" CssClass="txtBox" Width="190px" BackColor="white" onkeypress="javascript:return isNumber (event)"  BorderColor="Gray"></asp:TextBox></td>

             <td style="text-align:right;"><asp:Label ID="Label7" runat="server" CssClass="lbl" Text="Supplier Type :"></asp:Label></td>
             <td style="text-align:left;" class="auto-style1"><asp:DropDownList ID="ddlSupplierType" CssClass="ddList" Font-Bold="False" BackColor="Lightgray" BorderColor="Gray" runat="server" Width="195px" ForeColor="Black" OnSelectedIndexChanged="ddlSupplierType_SelectedIndexChanged" AutoPostBack="True">
        ...
        <tr>
             <td style="text-align:right;"><asp:Label ID="Label15" runat="server" CssClass="lbl" Text="Short Name :"></asp:Label></td>
             <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtShortName" runat="server" BackColor="Lightgray" BorderColor="Gray" CssClass="txtBox" Width="190px" Enabled="false"></asp:TextBox></td>
                
              <td style="text-align:right;"><asp:Label ID="Label9" runat="server" CssClass="lbl" Text="Enlishment Date :"></asp:Label></td>
              <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtEnlishmentDate" runat="server" BackColor="white" BorderColor="Gray" 
         ...
         <td>
              ...
              </td><td style="font-weight: 700; font-size: x-small">
        ...
        <tr>
            <td style="text-align:right;"><asp:Label ID="lblpayto" runat="server" CssClass="lbl" Text="Pay To Name :"></asp:Label></td>
            <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtPayTo" runat="server" BackColor="white" BorderColor="Gray" CssClass="txtBox" Width="190px"></asp:TextBox></td>

             <td style="text-align:right;"><asp:Label ID="lblrouting" runat="server" CssClass="lbl" Text="Routing :"></asp:Label></td>
             <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtRouting" runat="server" BackColor="Lightyellow" BorderColor="Gray" CssClass="txtBox" onkeypress="return RoutingNoCheck();" ForeColor="#990000" style="text-align:center" Width="120px"></asp:TextBox>
        ...
        <tr>
          ...
          <td style="text-align:right;"><asp:Label ID="lblAcNo" runat="server" CssClass="lbl" Text="A C Number :"></asp:Label></td>
          <%--<td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtACNo" runat="server" BackColor="white" BorderColor="Gray" CssClass="txtBox" onchange="javascript: Changed(this.value);" onkeypress="javascript:return isNumber (event)" Width="190px"></asp:TextBox></td>--%>
            <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtACNo" runat="server" BackColor="white" BorderColor="Gray" CssClass="txtBox" onkeypress="return ACNoCheck();" Width="190px"></asp:TextBox></td>
             
           <td style="text-align:right;"><asp:Label ID="lblbank" runat="server" CssClass="lbl" Text="Bank :"></asp:Label></td>
           <td class="auto-style5" style="text-align:left;"><asp:TextBox ID="txtBank" runat="server" BackColor="Lightgray" BorderColor="Gray" CssClass="txtBox" Width="190px" ForeColor="#0066FF" Enabled="false"></asp:TextBox></td>
         ...
         <tr>
             <td style="text-align:right;">
              ...
              <td class="auto-style5" style="text-align:left;">
               ...
               <td style="text-align:right;"><asp:Label ID="lblbranch" runat="server" CssClass="lbl" Text="Branch :"></asp:Label></td>
               <td class="auto-style5" style="text-align:left;">
           ...
           <tr>
              ...
              <tr>
                <td><asp:HiddenField ID="hid" runat="server"/></td>
                        <td>
                    ...
                    <tr>
                        <td class="auto-style25">
                            ...
                            <td class="auto-style6"> <asp:Button ID="btnApprove"  runat="server" ForeColor="Blue" Height="28px" OnClick="btnEdit_Click" style="text-align: center" Text="Approve" visible="false" Width="110px" />
                                &nbsp;</td>
                        </td>
            ...
            <td>
                ...
                <asp:ListItem Value="2">Trade License</asp:ListItem><asp:ListItem Value="3">VAT Registration</asp:ListItem>
                <asp:ListItem Value="4">TIN</asp:ListItem> <asp:ListItem Value="5">BIN</asp:ListItem>              
                </asp:DropDownList>
            </td>        
        ...
        <tr><td colspan="4"> 
           ...
           <div class="leaveSummary_container" style=" width:364px; height: 396px; margin: 60px 0px 0px 0px; ">
