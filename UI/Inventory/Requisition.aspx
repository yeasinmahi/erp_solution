    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    <table border="0" style="width: Auto">
                        <tr>
                            <td colspan="2" class="tblheader">Store Requisition Entry :<asp:HiddenField ID="hdnsearch" runat="server" />
                                <asp:HiddenField ID="hdnunit" runat="server" />
                            </td>
                            <td>
                                <asp:LinkButton ID="linkGoSomewhere" Text="Policy" runat="server" OnClick="linkGoSomewhere_Click" /></td>
                        </tr>
                        <tr class="tblrowodd">
                            ...
                            <td>
                                <asp:Label ID="lblDept" CssClass="lbl" runat="server"></asp:Label></td>
                        </tr>
                        ...
                        <tr class='tblroweven'>
                            ...
                            <td>
                                <asp:TextBox ID="txtQuantity" runat="server" CssClass="txtBox" Text="0.00"></asp:TextBox></td>
                        </tr>
                        <tr class="tblrowodd">
                            <td style="text-align: right;">
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtItem" runat="server" AutoCompleteType="Search" CssClass="txtBox" AutoPostBack="true" Width="500px"></asp:TextBox>
                        ...
                        <tr class='tblrowodd'>
                            <td style="text-align: right;">
                                <asp:Label ID="lblremarks" CssClass="lbl" runat="server" Text="Remarks :"></asp:Label></td>
                            <td colspan="3">
                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="txtBox" TextMode="MultiLine" Width="500px"></asp:TextBox></td>
                        </tr>
                        <tr class='tblroweven'>
                            <td style="text-align: right;">
                                <asp:Label ID="lblsec" CssClass="lbl" runat="server" Text="Section Name : "></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtSection" runat="server" CssClass="txtBox" AutoPostBack="false"></asp:TextBox></td>
                            <td style="text-align: right;">
                                <asp:Label ID="Label2" CssClass="lbl" runat="server" Text="Cost Center: "></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="DdlCostCenter" runat="server" AutoPostBack="true"></asp:DropDownList>
                                <asp:Button ID="btnAdd" runat="server" Text="ADD" Font-Bold="true"
                                    OnClientClick="return Confirm()" OnClick="btnAdd_Click"></asp:Button>
                                <asp:HiddenField ID="hdnconfirm" runat="server" />
                            </td>
                        </tr>
                        <tr class='tblrowodd'>
                            <td style="text-align: right;">
                                <asp:Label ID="lblReqBy" CssClass="lbl" runat="server" Text="Requisition By :"></asp:Label></td>
                            <td colspan="3">
                                <asp:TextBox ID="txtSearchAssignedTo" runat="server" AutoPostBack="true" CssClass="txtBox" Width="500px" OnTextChanged="txtSearchAssignedTo_TextChanged"></asp:TextBox>
                                ...
                                <asp:GridView ID="dgv" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL.">
                                            <ItemTemplate><%# Container.DataItemIndex + 1 %><asp:HiddenField ID="hdnitmid" runat="server" Value='<%# Bind("itemid") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Due Date" SortExpression="dudt">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldudt" runat="server" Text='<%# Bind("dudt") %>'></asp:Label></ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="70px" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Section" SortExpression="sec">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSec" runat="server" Text='<%# Bind("sec") %>'></asp:Label></ItemTemplate>
                        ...
                        <tr class='tblrowodd'>
                            <td colspan="4" style="text-align: right;">
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" Font-Bold="true" OnClick="btnSubmit_Click" /></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="leaveSummary_container">
                    <div class="tabs_container">Requisition Summary :<hr />
                    </div>
                    <asp:GridView ID="dgvlist" runat="server" AutoGenerateColumns="False" Font-Size="11px" BackColor="White" BorderStyle="Solid"
                        BorderWidth="0px" CellPadding="1" ForeColor="Black" GridLines="Vertical" AllowPaging="True" PageSize="25" DataSourceID="odsqwnreq">
                        <AlternatingRowStyle BackColor="#CCCCCC" />
                        <Columns>
                            <asp:TemplateField HeaderText="SL">
                    ...
                    <asp:GridView ID="dgvListByEnroll" runat="server" AutoGenerateColumns="False" Font-Size="11px" BackColor="White" BorderStyle="Solid"
                        BorderWidth="0px" CellPadding="1" ForeColor="Black" GridLines="Vertical" AllowPaging="True" PageSize="25">
                        <AlternatingRowStyle BackColor="#CCCCCC" />
                        <Columns>
                            <asp:TemplateField HeaderText="SL">
                                <ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate>
