...
<head runat="server">
    ...
    <script>function Print() {
            ...
            if (stat == 'Approved') { document.getElementById("btnprint").style.display = "none"; window.print(); self.close(); }
            else { alert('This challan is not approved. Please try later.'); }
        ...
        <table align="center" border="0" style="width: 500px">
            <tr>
                <td style="text-align: left; width: 100px;">
                    <img src="../Content/images/img/ag.png" /></td>
                <td style="text-align: center; font: bold 14px verdana;" colspan="2">
                    <b><u>GATE PASS</u></b><br />
            ...
            <tr style="font: bold 11px verdana;">
                <td style="text-align: right; width: 100px;">
                    <asp:Label ID="lblc" runat="server" Text="Challan No : "></asp:Label></td>
                <td>
                    <asp:Label ID="lblCN" runat="server"></asp:Label></td>
                <td style="text-align: right;">
                    <asp:Label ID="lbldt" runat="server"></asp:Label></td>
            </tr>
            <tr style="font: bold 11px verdana;">
                <td style="text-align: right; width: 100px;">
                    <asp:Label ID="lblf" runat="server" Text="From -Address : "></asp:Label></td>
                <td colspan="2">
                    <asp:Label ID="lblfadd" runat="server"></asp:Label></td>
            </tr>
            <tr style="font: bold 11px verdana;">
                <td style="text-align: right; width: 100px;">
                    <asp:Label ID="lblt" runat="server" Text="To -Address : "></asp:Label></td>
                <td colspan="2">
