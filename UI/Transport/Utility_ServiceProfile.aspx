<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Utility_ServiceProfile.aspx.cs" Inherits="UI.Transport.Utility_ServiceProfile" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> UTILITY PROFILE <hr /></div>
    ...
    <table  class="tbldecoration" style="width:auto; float:left;">                    
        <tr>                
            ...
            <td style="text-align:left;">
                <asp:DropDownList ID="ddlServiceList" CssClass="ddList" Font-Bold="False" AutoPostBack="false" runat="server"></asp:DropDownList>                                                                                       
            </td>            
        </tr>
        <tr>
