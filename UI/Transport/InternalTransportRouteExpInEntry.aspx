...
<%--=========================================Start My Code From Here===============================================--%>
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnEnroll" runat="server" /><asp:HiddenField ID="hdnUnit" runat="server" />
       ...
       <asp:HiddenField ID="hdndgvFTTotal" runat="server" /><asp:HiddenField ID="hdnconfirm" runat="server" />
       ...
       <asp:HiddenField ID="hdndgvDTFCash" runat="server" /> <asp:HiddenField ID="hdnQty" runat="server" />
        <asp:HiddenField ID="hdnDieselPerKMOutStation" runat="server" /><asp:HiddenField ID="hdnCNGPerKMOutStation" runat="server" />
       <div class="tabs_container"> VEHICLE TRIP IN COST ENTRY FORM<hr /></div>
        ...
        <tr>
            <td style="text-align:right;"><asp:Label ID="lblInDate" runat="server" CssClass="lbl" Text="In Date :"></asp:Label></td>                
            <td><asp:TextBox ID="txtInDate" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true" Width="190px"></asp:TextBox>
            <cc1:CalendarExtender ID="fdt" runat="server" Format="yyyy-MM-dd" TargetControlID="txtInDate"></cc1:CalendarExtender></td>                                
        ...
        <tr><td colspan="6"><hr /></td></tr>             
        <tr><td colspan="6" style="font-weight:bold; font-size:11px; color:#3369ff;">Fare:<hr /></td></tr>
        <tr>
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtAdditionalMillage" runat="server" CssClass="txtBox" Width="70px" onkeypress="return onlyNumbers();" onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblTotalMillage" runat="server" CssClass="lbl" Text="Total Millage :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtTotalMillage" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr>
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtAdditionalFare" runat="server" CssClass="txtBox" Width="70px" onkeypress="return onlyNumbers();" onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblTotalTripFare" runat="server" CssClass="lbl" Text="Total Trip Fare :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtTotalTripFare" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr><td colspan="6"><hr /></td></tr>             
        ...
        <tr>
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtTFCost" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                                      
        </tr>
        <tr>
        ...
        <tr><td colspan="6"> 
            ...
            <ItemStyle HorizontalAlign="Left" Width="300px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="Total" /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="inttype" Visible="false" SortExpression="inttype"><ItemTemplate>            
            <asp:Label ID="lblinttype" runat="server" Text='<%# Bind("inttype") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="45px"/></asp:TemplateField>
            ...
            <ItemStyle HorizontalAlign="right" Width="90px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldieselcredit %>' /></FooterTemplate></asp:TemplateField>
            ...
            <ItemStyle HorizontalAlign="right" Width="90px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalcngcredit %>' /></FooterTemplate></asp:TemplateField>
        ...
        <tr><td colspan="6"><hr /></td></tr>             
        <tr><td colspan="6" style="font-weight:bold; font-size:11px; color:#3369ff;">Down Trip Fare:<hr /></td></tr>
        <tr>            
            <td style="text-align:right;"><asp:Label ID="lblAgentName" runat="server" CssClass="lbl" Text="Agent Name :"></asp:Label></td>            
            <td style="text-align:left;"><asp:TextBox ID="txtAgentName" runat="server" CssClass="txtBox" TextMode="MultiLine" Width="190px"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblDTCach" runat="server" CssClass="lbl" Text="DT Fare (Cash) :"></asp:Label></td>
            <td colspan="4" style="text-align:left;"><asp:TextBox ID="txtDTFCash" runat="server" CssClass="txtBox" Width="200px" onkeypress="return onlyNumbers();" onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr style="background-color:lightgray"><td colspan="6"><asp:Button ID="btnDTFareCashAdd" runat="server" ForeColor="Green" Font-Bold="true" class="nextclick" Text="Add" OnClick="btnDTFareCashAdd_Click"/></td></tr>  
        <tr><td colspan="6"> 
            ...
            <asp:TemplateField HeaderText="Agent Name" SortExpression="agenttnam"><ItemTemplate>            
            <asp:Label ID="lblagenttnam" runat="server" Text='<%# Bind("agenttnam") %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="lblGrandTotaldtfareCash" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("dtfarecash"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="80px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# grandtotaldtfarecash %>' /></FooterTemplate></asp:TemplateField>
        ...
        <tr><td colspan="6"><hr /></td></tr> 
        <tr>            
            <td style="text-align:right;"><asp:Label ID="lblUnitNameDTF" runat="server" CssClass="lbl" Text="Unit Name :"></asp:Label></td>
            <td style="text-align:left;">
            ...
            <td style="text-align:right;"><asp:Label ID="lblShipPointDTF" runat="server" CssClass="lbl" Text="Ship Point Name :"></asp:Label></td>
            <td colspan="4" style="text-align:left;">
                <asp:DropDownList ID="ddlShipPointDTF" CssClass="ddList" Font-Bold="False" runat="server" Width="210px"></asp:DropDownList>                                                                                       
            </td>
        </tr>
        <tr>
            <td style="text-align:right;"><asp:Label ID="lblDTFareCredit" runat="server" CssClass="lbl" Text="DT Fare (Credit) :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtDTFareCredit" runat="server" CssClass="txtBox" Width="190px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr style="background-color:lightgray"><td colspan="6"><asp:Button ID="btnDTFareAdd" runat="server" ForeColor="Green" Font-Bold="true" class="nextclick" Text="Add" OnClick="btnDTFareAdd_Click1"/></td></tr>  
        <tr><td colspan="6"> 
            ...
            <asp:TemplateField HeaderText="shippointid" Visible="false" SortExpression="shippointid"><ItemTemplate>            
            <asp:Label ID="lblshippointid" runat="server" Text='<%# Bind("shippointid") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="45px"/></asp:TemplateField>

            <asp:TemplateField HeaderText="Unit Name" SortExpression="unitname"><ItemTemplate>            
            <asp:Label ID="lblunitname" runat="server" Text='<%# Bind("unitname") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="186px"/></asp:TemplateField>

            <asp:TemplateField HeaderText="Ship Point Name" SortExpression="shippointname"><ItemTemplate>            
            <asp:Label ID="lblshippointname" runat="server" Text='<%# Bind("shippointname") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="325px"/></asp:TemplateField>
                            
            <asp:TemplateField HeaderText="DT Fare (Credit)" ItemStyle-HorizontalAlign="right" SortExpression="dtfarecredit" >
            <ItemTemplate><asp:Label ID="lblGrandTotaldtfare" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("dtfarecredit"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="80px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# grandtotaldtfare %>' /></FooterTemplate></asp:TemplateField>
        ...
        <tr><td colspan="6"><hr /></td></tr>             
        <tr><td colspan="6" style="font-weight:bold; font-size:11px; color:#3369ff;">Allowance:<hr /></td></tr>
        <tr>
            <td style="text-align:right;"><asp:Label ID="lblTripBonus" runat="server" CssClass="lbl" Text="Trip Bonus :"></asp:Label></td>            
            <td style="text-align:left;"><asp:TextBox ID="txtTripBonus" runat="server" CssClass="txtBox" Width="190px" BackColor="LightGray" BorderColor="Gray"  onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              
            
            <td style="text-align:right;"><asp:Label ID="lblNoOfDA" runat="server" CssClass="lbl" Text="No. Of DA :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtNoOfDA" runat="server" CssClass="txtBox" Width="70px" onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td> 
            
            <td style="text-align:right;"><asp:Label ID="lblMillageAllowance" runat="server" CssClass="lbl" Text="Millage Allowance:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtMillageAllowance" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                           
        </tr>
        <tr>            
            <td style="text-align:right;"><asp:Label ID="lblTimeAllowance" runat="server" CssClass="lbl" Text="Time Allowance :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtTimeAllowance" runat="server" CssClass="txtBox" Width="190px" BackColor="LightGray" BorderColor="Gray"  onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              
            
            <td style="text-align:right;"><asp:Label ID="lblDailyAllowancetk" runat="server" CssClass="lbl" Text="Daily Allowance:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtDailyAlllownacetk" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                                                               

            <td style="text-align:right;"><asp:Label ID="lblDtripAllowance" runat="server" CssClass="lbl" Text="D. Trip Allowance:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtDtripAllowance" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                                                               
        </tr>         
        <tr><td colspan="6"><hr /></td></tr>             
        <tr><td colspan="6" style="font-weight:bold; font-size:11px; color:#3369ff;">Maintanance & Others Expence:<hr /></td></tr>
        <tr>            
            <td style="text-align:right;"><asp:Label ID="lblCauseOfMaintenance" runat="server" CssClass="lbl" Text="Cause Of Maintenance :"></asp:Label></td>
            <td colspan="3" style="text-align:left;"><asp:TextBox ID="txtCauseOfMaintenance" runat="server" CssClass="txtBox" Width="375px"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblMaintananceTK" runat="server" CssClass="lbl" Text="Maintanance (TK) :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtMaintananceTK" runat="server" CssClass="txtBox" Width="70px" onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr>            
            <td style="text-align:right;"><asp:Label ID="lblCauseOfOthers" runat="server" CssClass="lbl" Text="Cause Of Others (+-) :"></asp:Label></td>
            <td colspan="3" style="text-align:left;"><asp:TextBox ID="txtCauseOfOthers" runat="server" CssClass="txtBox" Width="375px"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblOthersTK" runat="server" CssClass="lbl" Text="Others (TK) :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtOthersTK" runat="server" CssClass="txtBox" Width="70px" onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              
        </tr>
        <tr>            
            ...
            <td style="text-align:right;"><asp:Label ID="lblBridge" runat="server" CssClass="lbl" Text="Bridge Toll :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtBridgeToll" runat="server" CssClass="txtBox" ReadOnly="true" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>              

            <td style="text-align:right;"><asp:Label ID="lblFerry" runat="server" CssClass="lbl" Text="Ferry Toll:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtFerryToll" runat="server" CssClass="txtBox" ReadOnly="true" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();"  onKeyUp="javascript:Add();" MaxLength="10"></asp:TextBox></td>                                                                                       
        </tr> 
        <tr>
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtTotalRouteExp" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                                                               

            <td style="text-align:right;"><asp:Label ID="lblNetPayable" runat="server" CssClass="lbl" Text="Net Payable :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtNetPayable" runat="server" CssClass="txtBox" BackColor="LightGray" BorderColor="Gray" Width="70px" onkeypress="return onlyNumbers();" MaxLength="10"></asp:TextBox></td>                                                               
        </tr>
