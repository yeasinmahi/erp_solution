<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InternalTReportForAudit.aspx.cs" Inherits="UI.Transport.InternalTReportForAudit" %>
...
<head runat="server">
    ...
    function ExportDivDataToExcel() {
        var html = $("#divExportExcel").html();
        html = $.trim(html);
        html = html.replace(/>/g, '&gt;');
        html = html.replace(/</g, '&lt;');
        $("input[id$='HdnValue']").val(html);
    }
    function ExportDivDataToExcelVT() {
        var html = $("#divVendorTReport").html();
        html = $.trim(html);
        html = html.replace(/>/g, '&gt;');
        html = html.replace(/</g, '&lt;');
        $("input[id$='HdnValue']").val(html);
    ...
    <script type="text/javascript">
        ...
        function GridviewScroll() {
            $('#<%=dgvReportVehicleNDateWise.ClientID%>').gridviewScroll({
                width: 925,
                height: 300,
                startHorizontal: 0,
                wheelstep: 10,
...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <div class="tabs_container"> REPORT FOR AUDIT <hr /></div>
        ...
        <asp:ListItem Value="3">Details Report (Export To Execl)</asp:ListItem><asp:ListItem Value="4">Vendor Transport Report</asp:ListItem>                
        </asp:DropDownList>
        </td> 
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <asp:DropDownList ID="ddlVehicleSupplier" CssClass="ddList" Font-Bold="False" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlVehicleSupplier_SelectedIndexChanged"></asp:DropDownList>                                                                                       
            </td>
        </tr>
        <tr>
        ...
        <td style="text-align:left;">
            <asp:Button ID="btnExport" runat="server" ForeColor="Green" Font-Bold="true" class="nextclick" Text="Export To Excel" OnClick="btnExport_Click" OnClientClick="ExportDivDataToExcel()"/>
            <asp:Button ID="btnExportVT" runat="server" ForeColor="Green" Font-Bold="true" class="nextclick" Text="Export To Excel" OnClick="btnExportVT_Click" OnClientClick="ExportDivDataToExcelVT()"/>
        </td>   
        <td style="text-align:left;"><asp:Button ID="btnShowReport" runat="server" ForeColor="Green" Font-Bold="true" class="nextclick" Text="Show Report" OnClientClick="LoaderBusy()" OnClick="btnShowReport_Click"/></td>
        </tr>
        </table>
        </div>
        ...
        <asp:Label ID="lblVehicleNo" runat="server" Text='<%# Bind("strRegNo") %>' Width="180px"></asp:Label></ItemTemplate>
        ...
        <asp:Label ID="lblDriverName1" runat="server" Text='<%# Bind("DriverName") %>' Width="200px"></asp:Label></ItemTemplate>
        ...
        <ItemStyle HorizontalAlign="Left" Width="150px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
               
        <asp:TemplateField HeaderText="Final Destination" SortExpression="strName"><ItemTemplate>            
        <asp:Label ID="lblCustomerName1" runat="server" Text='<%# Bind("strName") %>' Width="250px"></asp:Label></ItemTemplate>
        ...
        <ItemStyle HorizontalAlign="Left" Width="70px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblMillagekm" runat="server" Width="50px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("intMillage"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="50px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# millage %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblAMillage" runat="server" Width="80px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("intAdditionalMillage"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="80px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# almillage %>' /></FooterTemplate></asp:TemplateField>
                
        <asp:TemplateField HeaderText="Total Millage (KM)" ItemStyle-HorizontalAlign="right" SortExpression="intTotalMillage">
        <ItemTemplate><asp:Label ID="lblMillage" runat="server" Width="65px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("intTotalMillage"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="65px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalmillage %>' /></FooterTemplate></asp:TemplateField>
                
        <asp:TemplateField HeaderText="Diesel (Tk)" ItemStyle-HorizontalAlign="right" SortExpression="monDieselTotalTk" >
        <ItemTemplate><asp:Button ID="btnDslVew" runat="server" Width="70px" class="HyperLinkButtonStyle" style="cursor:pointer;" 
        ...
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldieseltk %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="CNG (Tk)" ItemStyle-HorizontalAlign="right" SortExpression="monCNGTotalTk" >
        <ItemTemplate><asp:Button ID="btnCngVew" runat="server" Width="70px" class="HyperLinkButtonStyle" style="cursor:pointer;" 
        CommandName="cng" CommandArgument='<%# Eval("intID") %>' Text='<%# Eval("monCNGTotalTk") %>' OnCommand="btnDslVew_Click"/>
        <%--<asp:Label ID="lblDieselTk" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDieselTotalTk"))) %>'></asp:Label>--%></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalcngtk %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblFerryExp" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monFerryEXP"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalferry %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Bridge Exp." ItemStyle-HorizontalAlign="right" SortExpression="monBridgeToll" >
        <ItemTemplate><asp:Label ID="lblBridgeExp" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monBridgeToll"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalbridge %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Button ID="btnMaintananceVew" runat="server" Width="70px" class="HyperLinkButtonStyle" style="cursor:pointer;" 
        CommandName="mainttk" CommandArgument='<%# Eval("intID") %>' Text='<%# Eval("monMaintenanceTK") %>' OnCommand="btnDslVew_Click"/>
        <%--<asp:Label ID="lblDieselTk" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDieselTotalTk"))) %>'></asp:Label>--%></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalmaintenance %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblpolice" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monPoliceEXP"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalpolice %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Labour Cost" ItemStyle-HorizontalAlign="right" SortExpression="monLabourEXP" >
        <ItemTemplate><asp:Label ID="lblLabour" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monLabourEXP"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totallabour %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Button ID="btnOtherVew" runat="server" Width="70px" class="HyperLinkButtonStyle" style="cursor:pointer;" 
        CommandName="othertk" CommandArgument='<%# Eval("intID") %>' Text='<%# Eval("monOthersTK") %>' OnCommand="btnDslVew_Click"/>
        <%--<asp:Label ID="lblDieselTk" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDieselTotalTk"))) %>'></asp:Label>--%></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalOther %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblMillageAllow" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monMillageAllow"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalmillageallow %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Down Trip Allowance" ItemStyle-HorizontalAlign="right" SortExpression="monDownTripAllow" >
        <ItemTemplate><asp:Label ID="lblDTripAllow" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDownTripAllow"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldtripallow %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Daily Allowance" ItemStyle-HorizontalAlign="right" SortExpression="monDailyAllow" >
        <ItemTemplate><asp:Label ID="lblDailyAllow" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDailyAllow"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldailyallow %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Trip Bonus" ItemStyle-HorizontalAlign="right" SortExpression="monTripBonus" >
        <ItemTemplate><asp:Label ID="lblTripBonus" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTripBonus"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaltripbonus %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Time Allowance" ItemStyle-HorizontalAlign="right" SortExpression="monTimeAllow" >
        <ItemTemplate><asp:Label ID="lblTimeAllow" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTimeAllow"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaltimeallow %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Fuel Cash" ItemStyle-HorizontalAlign="right" SortExpression="monFuelCash" >
        <ItemTemplate><asp:Label ID="lblFuelCash" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monFuelCash"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalfuelcash %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Total Route Exp." ItemStyle-HorizontalAlign="right" SortExpression="monTotalRouteEXP" >
        <ItemTemplate><asp:Label ID="lblTotalRouteExp" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalRouteEXP"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalrouteexp %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaltripfare %>' /></FooterTemplate></asp:TemplateField>
        ...
        <ItemTemplate><asp:Label ID="lblAdditionalFare" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monAdditionalFare"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaladitionalfare %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Fare + Additional Fare" ItemStyle-HorizontalAlign="right" SortExpression="monFareAndAddiFare" >
        <ItemTemplate><asp:Label ID="lblFareAdditionalFare" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monFareAndAddiFare"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalfareaditionalfare %>' /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Down Trip Fare Cash" ItemStyle-HorizontalAlign="right" SortExpression="monTotalDTripFareCash" >
        <ItemTemplate><asp:Label ID="lblDTFCash" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalDTripFareCash"))) %>'></asp:Label></ItemTemplate>
        ...
        <ItemTemplate><asp:Label ID="lblDTFCredit" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalDownTFareCredit"))) %>'></asp:Label></ItemTemplate>
        ...
        <ItemTemplate><asp:Label ID="lblTotalTripFare" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalTripFare"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalTotaltripfare %>' /></FooterTemplate></asp:TemplateField>
            
        <asp:TemplateField HeaderText="Diesel Total Credit" ItemStyle-HorizontalAlign="right" SortExpression="monTotalDieselCredit" >
        <ItemTemplate><asp:Label ID="lblDieselTotalCredit" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalDieselCredit"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldieseltotalcredit %>' /></FooterTemplate></asp:TemplateField>
            
        <asp:TemplateField HeaderText="CNG Total Credit" ItemStyle-HorizontalAlign="right" SortExpression="monTotalCNGCredit" >
        <ItemTemplate><asp:Label ID="lblCNGTotalCredit" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalCNGCredit"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalcngtotalcredit %>' /></FooterTemplate></asp:TemplateField>
            
        <asp:TemplateField HeaderText="Net Income" ItemStyle-HorizontalAlign="right" SortExpression="NetIncome" >
        <ItemTemplate><asp:Label ID="lblNetIncome" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("NetIncome"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalnetincome %>' /></FooterTemplate></asp:TemplateField>
            
        <asp:TemplateField HeaderText="Net Payable" ItemStyle-HorizontalAlign="right" SortExpression="monNetPayable" >
        <ItemTemplate><asp:Label ID="lblNetPayable" runat="server" Width="70px" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monNetPayable"))) %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="right" Width="70px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalnetpayable %>' /></FooterTemplate></asp:TemplateField>
        ...
        </table> <asp:HiddenField ID="HdnValue" runat="server" />    
        </div>
        ...
        <tr><td> 
        <asp:GridView ID="dgvDetailsRExcelToExport" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
        BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"  ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvDetailsRExcelToExport_RowDataBound">
        <AlternatingRowStyle BackColor="#CCCCCC" />
        <Columns>
        <asp:TemplateField HeaderText="SL No."><ItemStyle HorizontalAlign="center" Width="15px"/><ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>              
        ...
        <asp:TemplateField HeaderText="Diesel (Tk)" ItemStyle-HorizontalAlign="right" SortExpression="monCNGTotalTk" >
        <ItemTemplate><asp:Label ID="lblDieselTk" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDieselTotalTk"))) %>'></asp:Label></ItemTemplate>
