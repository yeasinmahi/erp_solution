<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InternalTLocalAccountsReport.aspx.cs" Inherits="UI.Transport.InternalTLocalAccountsReport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function hideGridAll() {
            ...
            document.getElementById("divDriverWiseLB").style.display = "none";
            document.getElementById("divDriverLBALL").style.display = "none";
            document.getElementById("divCashReceiveAndAdjustment").style.display = "none";
        }
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnconfirm" runat="server" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:ListItem Selected="True" Value="1">Fund Approval</asp:ListItem><asp:ListItem Value="2">Fund Paid Report</asp:ListItem> 
                <asp:ListItem Value="3">Trip Wise Details Report of Bill Payment</asp:ListItem><asp:ListItem Value="4">Trip Wise Details Bill Payment Report</asp:ListItem>
                <asp:ListItem Value="5">Driver Ledger</asp:ListItem><asp:ListItem Value="6">Accounts Schedule of Driver</asp:ListItem>
                <asp:ListItem Value="7">Trip Wise Details Bill Entry Report</asp:ListItem><asp:ListItem Value="8">Cash Receive</asp:ListItem>                                                
                </asp:DropDownList>
            </td> 

            <td style="text-align:right;"><asp:Label ID="lblSearchVehicle" runat="server" CssClass="lbl" Text="Search Vehicle:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtSearchVehicle" runat="server" CssClass="txtBox" Width="210px"></asp:TextBox></td>

            <%--<td style="text-align:right;"><asp:Label ID="lblBill" CssClass="lbl" runat="server" Text="Type : "></asp:Label></td>
            <td><asp:RadioButton ID="rdoPending" runat="server" Checked="true" Text="Entry" OnCheckedChanged="rdoPending_CheckedChanged" AutoPostBack="true" />
            <asp:RadioButton ID="rdoComplete" runat="server" Text="Report" OnCheckedChanged="rdoComplete_CheckedChanged"  AutoPostBack="true"  /></td>--%>
        ...
        <tr>
            <td style="text-align:right;"><asp:Label ID="lblSearchEnroll" runat="server" CssClass="lbl" Text="Driver Enroll:"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtSearchEnroll" runat="server" CssClass="txtBox" Width="210px"></asp:TextBox></td>

            <td style="text-align:right;"><asp:Label ID="lblDriver" runat="server" CssClass="lbl" Text="Driver Name :"></asp:Label></td>
            <td style="text-align:left;">
                <asp:DropDownList ID="ddlDriverName" CssClass="ddList" AutoPostBack="false" Font-Bold="False" runat="server"></asp:DropDownList>                                                                                       
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><asp:RadioButton ID="rdo12AM" runat="server" Text="12 AM" OnCheckedChanged="rdo12AM_CheckedChanged"  AutoPostBack="true"/>
            <asp:RadioButton ID="rdo6PM" runat="server" Checked="true" Text="6 PM" OnCheckedChanged="rdo6PM_CheckedChanged" AutoPostBack="true"/></td>
     ...
     <div id="divFundApproval">          
        <table  class="tbldecoration" style="width:auto; float:left;">  
            ...
            <tr><td> 
            <asp:GridView ID="dgvFundApproval" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
            BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"  ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvFundApproval_RowDataBound">
            ...
            <asp:TemplateField HeaderText="Requisition Date" SortExpression="dteRequisitionDate"><ItemTemplate>            
            <asp:Label ID="lblRequisitionDate" runat="server" Text='<%# Bind("dteRequisitionDate") %>' Width="70px"></asp:Label></ItemTemplate>
            ...
            <asp:Label ID="lblDriverName" runat="server" Text='<%# Bind("DriverName") %>' Width="150px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="250px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>

            <asp:TemplateField HeaderText="Final Destination" SortExpression="strName"><ItemTemplate>            
            <asp:Label ID="lblCustomerName" runat="server" Text='<%# Bind("strName") %>' Width="150px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="250px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Advance" ItemStyle-HorizontalAlign="right" SortExpression="monAdvance" >
            <ItemTemplate><asp:Label ID="lblAdvance" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monAdvance"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaladvance %>' /></FooterTemplate></asp:TemplateField>
            
            <%--<asp:TemplateField HeaderText="Advance" ItemStyle-HorizontalAlign="right" SortExpression="monAdvance" >
            <ItemTemplate><asp:Label ID="lblAdvance1" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monAdvance"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaladvance1 %>' /></FooterTemplate></asp:TemplateField>--%>
     
            <asp:TemplateField HeaderText="Advance" SortExpression="monAdvance"><ItemTemplate>
            <asp:TextBox ID="txtAdvanc1" runat="server" CssClass="txtBoxGridAmount" Text='<%# Bind("monAdvance") %>' TextMode="Number" Width="45px"></asp:TextBox></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaladvance1 %>' /></FooterTemplate></asp:TemplateField>
                       
            <asp:TemplateField HeaderText="Advance Date" SortExpression="dteAdvanceDate"><ItemTemplate>            
            <asp:Label ID="lblAdvanceDate" runat="server" Text='<%# Bind("dteAdvanceDate") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="55px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
               
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Submit" >
            <ItemTemplate><asp:Button ID="btnSubmitAdvance" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" 
            CommandArgument='<%# Eval("intID")+","+ Container.DataItemIndex %>' Text="Submit"  OnClientClick="ConfirmAll()" OnClick="SubmitAdvance_Click"/>
    ...
    <div id="divBillForLocalAccounts">          
        <table  class="tbldecoration" style="width:auto; float:left;">  
            <%--===========Summary Report============--%>
            ...
            <tr><td> 
            <asp:GridView ID="dgvBillForLocalAccounts" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
            BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"  ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvBillForLocalAccounts_RowDataBound">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
            <asp:TemplateField HeaderText="SL No."><ItemStyle HorizontalAlign="center" Width="15px"/><ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>              
            ...
            <asp:TemplateField HeaderText="Bill Date" SortExpression="BillDate"><ItemTemplate>            
            <asp:Label ID="lblBillDate" runat="server" Text='<%# Bind("BillDate") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="55px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
            ...
            <ItemTemplate><asp:Label ID="btnDslVew" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monDieselTotalTk"))) %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="btnCngVew" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monCNGTotalTk"))) %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="lblMaintanance" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monMaintenanceTK"))) %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="btnOtherVew" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monOthersTK"))) %>'></asp:Label></ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Total Route Exp." ItemStyle-HorizontalAlign="right" SortExpression="monTotalRouteEXP" >
            <ItemTemplate><asp:Label ID="lblTotalRouteExp" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monTotalRouteEXP"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalrouteexp1 %>' /></FooterTemplate></asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Total Payable" ItemStyle-HorizontalAlign="right" SortExpression="TotalPayable" >
            <ItemTemplate><asp:Label ID="lblTpayable" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("TotalPayable"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalpayalbe %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Advance" ItemStyle-HorizontalAlign="right" SortExpression="monAdvance" >
            <ItemTemplate><asp:Label ID="lbladvanc" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monAdvance"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaladvanc %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Net Payable" ItemStyle-HorizontalAlign="right" SortExpression="NetPayable" >
            <ItemTemplate><asp:Label ID="lblNetPayable" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("NetPayable"))) %>'></asp:Label></ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Paid Amount" SortExpression="PaidForAmount"><ItemTemplate>
            <asp:TextBox ID="txtPaidAmount" runat="server" CssClass="txtBoxGridAmount" Text='<%# Bind("PaidForAmount") %>' TextMode="Number" Width="45px"></asp:TextBox></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalpaidamount %>' /></FooterTemplate></asp:TemplateField>
                  
            <asp:TemplateField HeaderText="Paid Amount" ItemStyle-HorizontalAlign="right" SortExpression="Paidamount" >
            <ItemTemplate><asp:Label ID="lblPaidAm" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Paidamount"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalpaidam %>' /></FooterTemplate></asp:TemplateField>
                
            <asp:TemplateField HeaderText="Bill Paid Date" SortExpression="dteAccountsBillPayment"><ItemTemplate>            
            <asp:Label ID="lblBillPaidDate" runat="server" Text='<%# Bind("dteAccountsBillPayment") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="55px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
               
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Submit" >
            <ItemTemplate><asp:Button ID="btnSubmitBillPayment" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" 
            CommandArgument='<%# Eval("intID")+","+ Container.DataItemIndex %>' Text="Submit"  OnClientClick="ConfirmAll()" OnClick="SubmitBillPayment_Click"/>
            </ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField> 
    ...
    <div id="divDriverWiseLB">          
        <table  class="tbldecoration" style="width:auto; float:left;">  
            ...
            <tr><td> 
            <asp:GridView ID="dgvDriverWiseLB" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
            BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"  ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvDriverWiseLB_RowDataBound">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
            <asp:TemplateField HeaderText="SL No."><ItemStyle HorizontalAlign="center" Width="15px"/><ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>              
            
            <asp:TemplateField HeaderText="Trasaction Date" SortExpression="TDate"><ItemTemplate>            
            <asp:Label ID="lblTransactionDate" runat="server" Text='<%# Bind("TDate") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="55px"/><FooterTemplate><asp:Label ID="lblT" runat="server" /></FooterTemplate></asp:TemplateField>
               
            <asp:TemplateField HeaderText="Trip SL No." SortExpression="strTripSLNo"><ItemTemplate>            
            <asp:Label ID="lblTripSLNo" runat="server" Text='<%# Bind("strTripSLNo") %>' Width="150px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="160px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
               
            <asp:TemplateField HeaderText="Vehicle No." SortExpression="strRegNo"><ItemTemplate>            
            <asp:Label ID="lblVehicleNo" runat="server" Text='<%# Bind("strRegNo") %>' Width="150px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="160px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="Net Balance" /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Particulars" SortExpression="Particulars"><ItemTemplate>            
            <asp:Label ID="lblParticulars" runat="server" Text='<%# Bind("Particulars") %>' Width="100px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="50px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
                                
            <asp:TemplateField HeaderText="Debit" ItemStyle-HorizontalAlign="right" SortExpression="Debit" >
            <ItemTemplate><asp:Label ID="lblDebit" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Debit"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldebit %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Credit" ItemStyle-HorizontalAlign="right" SortExpression="Credit" >
            <ItemTemplate><asp:Label ID="lblCredit" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Credit"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalcredit %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Balance" ItemStyle-HorizontalAlign="right" SortExpression="Balance" >
            ...
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalbalance %>' /></FooterTemplate></asp:TemplateField>
    ...
    <div id="divDriverLBALL">          
        <table  class="tbldecoration" style="width:auto; float:left;">  
            ...
            <tr><td> 
            <asp:GridView ID="dgvDriverLBALL" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
            BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"   ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvDriverLBALL_RowDataBound">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
            <asp:TemplateField HeaderText="SL No."><ItemStyle HorizontalAlign="center" Width="15px"/><ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>              
            
            <asp:TemplateField HeaderText="Enroll" SortExpression="Enroll"><ItemTemplate>            
            <asp:Label ID="lblEnroll" runat="server" Text='<%# Bind("Enroll") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="70px"/><FooterTemplate><asp:Label ID="lblT" runat="server" /></FooterTemplate></asp:TemplateField>
               
            <asp:TemplateField HeaderText="Driver Name" SortExpression="EmpName"><ItemTemplate>            
            <asp:Label ID="lblEmpName" runat="server" Text='<%# Bind("EmpName") %>' Width="180px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="180px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="Total" /></FooterTemplate></asp:TemplateField>
                  
            <asp:TemplateField HeaderText="Openig" ItemStyle-HorizontalAlign="right" SortExpression="Opening" >
            <ItemTemplate><asp:Label ID="lblOpening" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Opening"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalOpening %>' /></FooterTemplate></asp:TemplateField>
                                        
            <asp:TemplateField HeaderText="Debit" ItemStyle-HorizontalAlign="right" SortExpression="Debit" >
            <ItemTemplate><asp:Label ID="lblDebit" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Debit"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totaldebit1 %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Credit" ItemStyle-HorizontalAlign="right" SortExpression="Credit" >
            <ItemTemplate><asp:Label ID="lblCredit" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Credit"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalcredit1 %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Balance" ItemStyle-HorizontalAlign="right" SortExpression="Balance" >
            <ItemTemplate><asp:Label ID="lblBalance" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("Balance"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalbalance1 %>' /></FooterTemplate></asp:TemplateField>
    ...
    <div id="divCashReceiveAndAdjustment">          
        <table  class="tbldecoration" style="width:auto; float:left;">  
            <%--===========Top Sheet Report============--%>
            ...
            <tr><td> 
            <asp:GridView ID="dgvCashReceiveAndAdjustment" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"  
            BorderWidth="1px" CellPadding="5" ForeColor="Black" GridLines="Vertical"  ShowFooter="true" FooterStyle-Font-Bold="true" FooterStyle-BackColor="#999999" FooterStyle-HorizontalAlign="Right" OnRowDataBound="dgvCashReceiveAndAdjustment_RowDataBound">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
            <asp:TemplateField HeaderText="SL No."><ItemStyle HorizontalAlign="center" Width="15px"/><ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>              
            ...
            <asp:TemplateField HeaderText="Trip Date" SortExpression="dteRequisitionDate"><ItemTemplate>            
            <asp:Label ID="lblRequisitionDate" runat="server" Text='<%# Bind("dteRequisitionDate") %>' Width="70px"></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="55px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="" /></FooterTemplate></asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Returnable" ItemStyle-HorizontalAlign="right" SortExpression="monNetPayable" >
            <ItemTemplate><asp:Label ID="lblNetPay" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monNetPayable"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalNetP %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Cash Received" ItemStyle-HorizontalAlign="right" SortExpression="monCashReceive" >
            <ItemTemplate><asp:Label ID="lblCashR" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monCashReceive"))) %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="40px"/><FooterTemplate><asp:Label ID="lbldm" runat="server" DataFormatString="{0:0.00}" Text ='<%# totalrec %>' /></FooterTemplate></asp:TemplateField>
            
            <asp:TemplateField HeaderText="Cash Receive"><ItemTemplate>
            <asp:TextBox ID="txtCashR" runat="server" CssClass="txtBoxGridAmount" TextMode="Number" Width="45px"></asp:TextBox></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="45px" /></asp:TemplateField>
                         
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Submit" >
            <ItemTemplate><asp:Button ID="btnSubmitAdvance" runat="server" class="nextclick" style="cursor:pointer; font-size:11px;" 
            CommandArgument='<%# Eval("intID")+","+ Container.DataItemIndex %>' Text="Submit"  OnClientClick="ConfirmAll()" OnClick="SubmitCashRAndAddj_Click"/>
            </ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField> 
