<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Utility_PaymentReport.aspx.cs" Inherits="UI.Transport.Utility_PaymentReport" %>
...
<head runat="server">
    ...
    <script>
        function DocListView(reqsid) {
            window.open('Utility_LocListView.aspx?intID=' + reqsid, 'sub', "height=500, width=700, scrollbars=yes, left=150, top=50, resizable=no, title=Preview");
        }
    </script>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnEnroll" runat="server" />
        ...
        <div class="tabs_container"> UTILITY PAYMENT REPORT <hr /></div>

        <table  class="tbldecoration" style="width:auto; float:left;">
        <tr>                
            <td style="text-align:right;"><asp:Label ID="lblUnit" runat="server" CssClass="lbl" Text="Unit :"></asp:Label></td>
            <td style="text-align:left;">
                <asp:DropDownList ID="ddlUnit" CssClass="ddList" Font-Bold="False" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged"></asp:DropDownList>                                                                                       
            </td>   
            
            <td style="text-align:right;"><asp:Label ID="lblServiceList" runat="server" CssClass="lbl" Text="Service Name :"></asp:Label></td>
            <td style="text-align:left;">
                <asp:DropDownList ID="ddlServiceList" CssClass="ddList" Font-Bold="False" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlServiceList_SelectedIndexChanged"></asp:DropDownList>                                                                                       
            </td>          
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><asp:RadioButton ID="rdoRenewal" runat="server" Checked="true" Text="Renewal" OnCheckedChanged="rdoRenewal_CheckedChanged" AutoPostBack="true" />
            <asp:RadioButton ID="rdoRegistration" runat="server" Text="Registration" OnCheckedChanged="rdoRegistration_CheckedChanged"  AutoPostBack="true"  /></td>
...
<div >  
        <table  class="tbldecoration" style="width:auto; float:left;">  
            ...
            <asp:TemplateField HeaderText="intAutoID" Visible="false" ItemStyle-HorizontalAlign="right" SortExpression="intAutoID" >
            <ItemTemplate><asp:Label ID="lblintAutoID" runat="server" DataFormatString="{0:0.00}" Text='<%# (""+Eval("intAutoID")) %>'></asp:Label></ItemTemplate></asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Gov-Fee" ItemStyle-HorizontalAlign="right" SortExpression="monGovFee" >
            ...
            <asp:TemplateField HeaderText="Incidental Cost" ItemStyle-HorizontalAlign="right" SortExpression="monIncidentalCost" >
            ...
            <asp:TemplateField HeaderText="Total Cost" ItemStyle-HorizontalAlign="right" SortExpression="monTotalCost" >
            ...
            <asp:BoundField DataField="strRemarks" HeaderText="Remarks" ItemStyle-HorizontalAlign="Center" SortExpression="strRemarks">
            <ItemStyle HorizontalAlign="left" Width="150px"/></asp:BoundField>
            ...
            CommandArgument='<%# Eval("intAutoID") %>' Text="Document View"  OnClick="btnDocVew_Click"/>
