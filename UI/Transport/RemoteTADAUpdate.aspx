<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoteTADAUpdate.aspx.cs" Inherits="UI.Transport.RemoteTADAUpdate" %>
            ...
            $("#txtVheicleName").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "RemoteTADAUpdate.aspx/Getstationvhcllist",
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    <div class="tabs_container">
                        TA - DA information update (Before approve by Supervisor)  :         
                    </div>
                    ...
                    <table border="0" style="width: Auto">
                       ...
                       <%-- <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="lbltype" CssClass="lbl" runat="server" Text="User Type:  "></asp:Label>
                            </td>
                            <td>
                                <asp:RadioButtonList ID="rdbUserOption" runat="server" OnSelectedIndexChanged="rdbUserOption_SelectedIndexChanged"
                        ...
                        <tr class="tblrowOdd">
                            <td style="text-align: right;">
                                <asp:Label ID="lblVhcName" CssClass="lbl" runat="server" Text="Vehicle Name: "></asp:Label>
                                <%--<asp:Label ID="lblfullname" CssClass="lbl" runat="server" Text="Employee Name: "></asp:Label>--%>
                            </td>
                            <td>
                                <asp:TextBox ID="txtVheicleName" runat="server" AutoPostBack="false" CssClass="txtBox"  Width="200px" ></asp:TextBox>
                                <%--<asp:TextBox ID="txtEmployeeSearch" runat="server" CssClass="txtBox" Width="350px" AutoPostBack="true" onchange="javascript: Changed();"></asp:TextBox>--%>
                                <asp:HiddenField ID="hdfEmpCode" runat="server" />
                                <asp:HiddenField ID="HiddenField2" runat="server" />
                            </td>
                            <tr class="tblrowOdd">
                                <td style="text-align: right" colspan="2">
                                    <asp:Button ID="btnApprTADAFoBikeCarUser" runat="server" Text="Show Bill Info" OnClick="btnApprTADAFoBikeCarUser_Click" /></td>
                            </tr>
                    </table>
                                ...
                                <asp:GridView ID="grdvForUpdateTADABikeCarUser" runat="server" AutoGenerateColumns="False" PageSize="3000" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" HeaderStyle-Wrap="true" OnRowDataBound="grdvForUpdateTADABikeCarUser_RowDataBound" GridLines="Vertical">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <EditItemTemplate>
                                                <asp:CheckBox ID="chkbx" runat="server" Checked="false" />
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkbx" runat="server" Checked="false" />
                    ...
                    <ItemStyle HorizontalAlign="Center" />
                                        ...
                                        <asp:TemplateField HeaderText="PK ID" SortExpression="PkID">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtPkID" CssClass="txtBox" runat="server" Width="35px" TextMode="SingleLine" ReadOnly="true" Text='<%# Bind("PkID") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="From Date" SortExpression="dteFromDate">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="dteFromdateNoBikeDet" CssClass="txtBox" runat="server" Width="150px" TextMode="Date" Text='<%# Bind("dteFromdate") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Employee  Name" SortExpression="strEmplName">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="strNamNoBikeDet" CssClass="txtBox" runat="server" Width="70px" TextMode="SingleLine" Text='<%# Bind("strNam") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="70px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Start Mlg" SortExpression="decstarmil">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecStartMilageT" CssClass="txtBox" runat="server" Width="50px" Text='<%# Bind("decStartMilageT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="End Mlg" SortExpression="decEndmil">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecEndMilageT" CssClass="txtBox" runat="server" Width="50px" Text='<%# Bind("decEndMilageT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cons Mlg" SortExpression="consumedkm">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecConsumedKmT" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decConsumedKmT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                       <%-- <asp:TemplateField HeaderText="Supporting" SortExpression="strsuppor">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtstrSupportingNoT" CssClass="txtBox" runat="server" Width="50px" TextMode="MultiLine" Text='<%# Bind("strSupportingNoT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                                        </asp:TemplateField>--%>
                                       <%-- <asp:TemplateField HeaderText="Qnt Petrol" SortExpression="decpet">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecQntPetrolT" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decQntPetrolT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cost Petrol" SortExpression="costpet">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCostPetrolT" OnTextChanged="txtdecCostPetrolT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCostPetrolT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Qnt Octen" SortExpression="decQntOcten">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecQntOctenT" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decQntOctenT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cost Octen" SortExpression="decCostOcten">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCostOctenT" OnTextChanged="txtdecCostOctenT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCostOctenT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Qnt CNG" SortExpression="decQntCNG">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecQntCarbonNitGasT" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decQntCarbonNitGasT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Cost CNG." SortExpression="CostCNG">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCostCarbonNitGasT" OnTextChanged="txtdecCostCarbonNitGasT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCostCarbonNitGasT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Qnt lubr" SortExpression="decQntLubricant">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecQntLubricant" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decLubricantQnt") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Cost Lubr." SortExpression="decCostLubricant">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCostLubricant" OnTextChanged="txtdecCostLubricant_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("lubricantcost") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bus" SortExpression="decBus">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecFareBusAmountT" OnTextChanged="txtdecFareBusAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decFareBusAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Rick" SortExpression="decRick">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecFareRickshawAmountT" OnTextChanged="txtdecFareRickshawAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decFareRickshawAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Taxi Cab" SortExpression="decTaxiCab">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecFareCNGAmountT" OnTextChanged="txtdecFareCNGAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decFareCNGAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Other Vhc." SortExpression="decOtherVhc">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecFareOtherVheicleAmountT" OnTextChanged="txtdecFareOtherVheicleAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decFareOtherVheicleAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Mnt. Cost" SortExpression="decMnt">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCostAmountMaintenaceT" OnTextChanged="txtdecCostAmountMaintenaceT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCostAmountMaintenaceT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Ferry Toll." SortExpression="ferytol">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecFeryTollCostT" OnTextChanged="txtdecFeryTollCostT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decFeryTollCostT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Own DA." SortExpression="decownda">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecDAAmountT" OnTextChanged="txtdecDAAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decDAAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Driver DA." SortExpression="decDriver">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecDriverDACostT" OnTextChanged="txtdecDriverDACostT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decDriverDACostT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                       ...
                                       <%-- <asp:TemplateField HeaderText="Own Hotel" SortExpression="decownhotel">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecHotelBillAmountT" OnTextChanged="txtdecHotelBillAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decHotelBillAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Driver Hotel" SortExpression="decdrivhotel">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecDriverHotelBillAmountT" OnTextChanged="txtdecDriverHotelBillAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decDriverHotelBillAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Photo copy" SortExpression="decPhotocopy">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecPhotoCopyCostT" OnTextChanged="txtdecPhotoCopyCostT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decPhotoCopyCostT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Courier" SortExpression="decCourier">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecCourierCostT" OnTextChanged="txtdecCourierCostT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCourierCostT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Other Cost" SortExpression="decOtherCostAmount">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecOtherBillAmountT" OnTextChanged="txtdecOtherBillAmountT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decOtherBillAmountT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Row Total" SortExpression="decrowtotal">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecRowTotalT" OnTextChanged="txtdecRowTotalT_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decRowTotalT") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="RowSl" SortExpression="pkrowsl">
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtRowSl" CssClass="txtBox" runat="server" Width="35px" TextMode="SingleLine" ReadOnly="true" Text='<%# Bind("pkrowsl") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="CNG Credit1 Amount" SortExpression="decCngCredit1Amont">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecSupplierCNG" OnTextChanged="txtdecSupplierCNG_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCngCredit1Amont") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Gas Station 1">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlCreditFuelStation1List" runat="server" CssClass="ddList" Width="150px" AutoPostBack="false">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="CNG Credit2 Amount" SortExpression="decCngCredit2Amont">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtCNGCredit2AMNT" OnTextChanged="txtdecSupplierCNG_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decCngCredit2Amont") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Gas Station 2">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlCreditFuelStation2List" runat="server" CssClass="ddList" Width="150px" AutoPostBack="false">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Oil Credit1 Amount" SortExpression="decOilCreditAmount">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtOilCreditAmnt" OnTextChanged="txtdecSupplierCNG_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decOilCreditAmount") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Oil Station">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlCreditFuelStation3List" runat="server" CssClass="ddList" Width="150px" AutoPostBack="false">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="PMlg Qnt" SortExpression="decPersonalMilage">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecPersonalMilage" OnTextChanged="txtdecPersonalMilage_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decPersonalMilage") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText=" Mlg. Rate" SortExpression="decMlgRate">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecMlgRate" OnTextChanged="txtdecMlgRate_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decMlgRate") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="P Mlag Total" SortExpression="decPersonalTotalcost">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtdecPersonalTotalcost" OnTextChanged="txtdecPersonalTotalcost_TextChanged" CssClass="txtBox" runat="server" Width="35px" Text='<%# Bind("decPersonalTotalcost") %>' AutoPostBack="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="35px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Det.">
                                            <ItemTemplate>
                                                ...
                                                <asp:Button ID="btnUpdateinf" runat="server" Text="Update" class="button" CommandName="complete" OnClick="btnUpdateinf_Click1" CommandArgument='<%# Eval("pkrowsl")+","+Eval("PkID")%>' />
                                            </ItemTemplate>
