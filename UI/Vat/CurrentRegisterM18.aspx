...
<%--=========================================Start My Code From Here===============================================--%>
    <div class="tabs_container">Current Register: <asp:HiddenField ID="hdnvtacc" runat="server" /> <asp:HiddenField ID="hdnconfirm" runat="server" /><hr />
        ...
        <td><asp:TextBox ID="txtFromDte" runat="server" CssClass="txtBox" autocomplete="off"></asp:TextBox>
        ...
        <td style="text-align:right;"><asp:TextBox ID="txtDteTo" runat="server" CssClass="txtBox" autocomplete="off"></asp:TextBox>
