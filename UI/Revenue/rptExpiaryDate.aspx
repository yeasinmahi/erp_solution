...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr>
        <td class="auto-style1">Surcharge:</td>
        <td class="auto-style1"><asp:TextBox ID="txtSurcharge" CssClass="txtBox"   MaxLength="10" runat="server"></asp:TextBox></td>
        <td class="auto-style1"> VAT:</td>
        <td class="auto-style1"><asp:TextBox ID="txtVAT" CssClass="txtBox"   MaxLength="10" runat="server"></asp:TextBox></td>
        <td class="auto-style1"></td>
        <td class="auto-style1"><asp:Button ID="btnAdd" runat="server" OnClientClick="ValidationBasicInfo()" class="myButton" OnClick="btnAdd_Click" Text="Add" /></td>  
    </tr>
    </table>
    </td></tr>
    <tr><td>
