<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLoadingSlipChallanDairy.aspx.cs" Inherits="UI.SAD.ExcelChallan.frmLoadingSlipChallanDairy" %>
...
<body>
    <form id="frmAutoChallanView" runat="server">
      ...
      <table  class="tbldecoration">
        ...
        <tr class="tblrowodd">
        <td>Mobile No:</td><td><asp:TextBox ID="txtMobile"  CssClass="txtBox"  runat="server"></asp:TextBox></td>
        <td>Slip No:</td><td><asp:TextBox ID="txtSlipno"  CssClass="txtBox"  runat="server"></asp:TextBox></td>                
        </tr>
        <tr class="tblrowodd"> 
          <td>Supplier Name:</td>
