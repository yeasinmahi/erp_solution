...
{
    public partial class frmMushok11Print : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dt = objMush.getChallanprint(Request.QueryString["Challanno"].ToString(),int.Parse(hdnAccno.Value), Request.QueryString["userEnroll"].ToString());
