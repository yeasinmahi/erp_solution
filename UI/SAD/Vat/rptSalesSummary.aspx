<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSalesSummary.aspx.cs" Inherits="UI.SAD.Vat.rptSalesSummary" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> SALES SUMMARY<hr /></div>
    <table><tr><td>
    ...
    <tr><td style="text-align:right" colspan="5"><asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Show Summary" /></td>       
    </tr>
    ...
    <tr><td>
        ...
        <ItemTemplate><asp:Label ID="lblQuantity" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column5","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        ...
        <ItemTemplate><asp:Label ID="lblWithout" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column6","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        <FooterTemplate><asp:Label ID="lblWithoutss" runat="server" DataFormatString="{0:0.00}" Text="<%# TotalSDVat %>" /></FooterTemplate></asp:TemplateField>
        ...
        <FooterTemplate><asp:Label ID="lblSDs" runat="server" DataFormatString="{0:0.00}" Text="<%# TotalSD %>" /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="VAT" SortExpression="qty">
        <ItemTemplate><asp:Label ID="lblVAT" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column8","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        <FooterTemplate><asp:Label ID="lblVATs" runat="server" DataFormatString="{0:0.00}" Text="<%# TotalVAT %>" /></FooterTemplate></asp:TemplateField>

        <asp:TemplateField HeaderText="Total" SortExpression="qty">
        <ItemTemplate><asp:Label ID="lblTotal" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column9","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        <FooterTemplate><asp:Label ID="lblTotals" runat="server" DataFormatString="{0:0.00}" Text="<%# TotalTotal %>" /></FooterTemplate></asp:TemplateField>
