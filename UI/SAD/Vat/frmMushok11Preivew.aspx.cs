...
{
    public partial class frmMushok11Preivew : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dt = objMush.getVatYear(int.Parse(hdnAccno.Value));

                ddlVatyear.DataTextField = "intVATTime";
                ddlVatyear.DataValueField = "intVATTime";
                ddlVatyear.DataSource = dt;
                ddlVatyear.DataBind();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            dt = objMush.getM11PrintExport(int.Parse(hdnAccno.Value),txtChallanno.Text);
