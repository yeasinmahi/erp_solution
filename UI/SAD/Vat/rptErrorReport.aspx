<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptErrorReport.aspx.cs" Inherits="UI.SAD.Vat.rptErrorReport" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> VAT Finding Error Report<hr /></div>
    <table><tr><td>
    ...
    <tr><td style="text-align:right" colspan="5"><asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Show" /></td>       
    </tr>
    ...
    <tr><td>
        ...
        <ItemTemplate><asp:Label ID="lblM11No" runat="server" Text='<%# Bind("intM11No","{0:d}") %>' Width="100px"></asp:Label>
        ...
        <ItemTemplate> <asp:Label ID="lblSVno" runat="server" Text='<%# Bind("strSVNo") %>' Width="200px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="200px" /></asp:TemplateField>

        <asp:TemplateField HeaderText="M11" SortExpression="qty">
        <ItemTemplate><asp:Label ID="lblintM11RowCount" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("intM11RowCount","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="M17" SortExpression="qty">
        <ItemTemplate><asp:Label ID="lblM17" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("intM17RowCount","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="M18" SortExpression="qty">
        <ItemTemplate><asp:Label ID="lblM18" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("intM18RowCount","{0:n0}") %>' Width="80px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
        </asp:TemplateField>
