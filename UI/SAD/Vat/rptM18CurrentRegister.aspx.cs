...
{
    public partial class rptM18CurrentRegister : BasePage
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
                ...
                dt = objMush.getCurrentRegM18(int.Parse(hdnAccno.Value), txtdtefdate.Text, txttodate.Text,int.Parse(ddltype.SelectedValue));
