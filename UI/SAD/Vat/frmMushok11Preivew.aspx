<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMushok11Preivew.aspx.cs" Inherits="UI.SAD.Vat.frmMushok11Preivew" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnEnroll" runat="server" />
       <asp:HiddenField ID="hdnVatAccount" runat="server" /><asp:HiddenField ID="hdnVatRegNo" runat="server" />
        ...
        <tr><td><asp:Label ID="lblVattimes" runat="server" Width="150" Font-Size="10" Text="Vat Time"></asp:Label></td>
            <td>:</td>
            <td> <asp:DropDownList ID="ddlVatyear" CssClass="ddList" runat="server"></asp:DropDownList> </td>        
            <td><asp:Label ID="Label9" runat="server" Width="150" Font-Size="10" Text="Challan NO"></asp:Label></td>
            <td>:</td>
            <td><asp:TextBox ID="txtChallanno" runat="server" Width="150"></asp:TextBox>
