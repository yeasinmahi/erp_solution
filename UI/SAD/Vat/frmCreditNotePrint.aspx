<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreditNotePrint.aspx.cs" Inherits="UI.SAD.Vat.frmCreditNotePrint" %>
...
<body>
    <form id="frmCreditNoteprint" runat="server">
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <tr> <td style="text-align:center" colspan="5">CREDIT NOTE</td></tr>
    <tr><td style="text-align:right" colspan="5">Mushak 12</td> </tr>
    ...
    <tr><td class="auto-style1">Customer Name: </td>
     ...
     <tr><td colspan="5"><asp:GridView ID="dgvRpt" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="8"
        ...
        <asp:TemplateField HeaderText="Prodcut Name" SortExpression="value">
        ...
        <ItemTemplate> <asp:Label ID="lblmonRtnOtherTax" runat="server" Text='<%# Bind("monRtnOtherTax") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>
       
        <asp:TemplateField HeaderText="VAT" SortExpression="itemname">
        <ItemTemplate> <asp:Label ID="lblVAT" runat="server" Text='<%# Bind("monRtnVAT") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>

        <asp:TemplateField HeaderText="Other Tax Amount" SortExpression="itemname">
        <ItemTemplate> <asp:Label ID="lblmonClnOtherTax" runat="server" Text='<%# Bind("monClnOtherTax") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>

        <asp:TemplateField HeaderText="VAT" SortExpression="itemname">
        <ItemTemplate> <asp:Label ID="lblmonRtnVAT" runat="server" Text='<%# Bind("monClnVAT") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>

        <asp:TemplateField HeaderText="Other Tax Amount" SortExpression="itemname">
        <ItemTemplate> <asp:Label ID="lblmonClnOtherTax" runat="server" Text='<%# Bind("monReduceTax") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>

        <asp:TemplateField HeaderText="VAT" SortExpression="itemname">
        <ItemTemplate> <asp:Label ID="lblVATf" runat="server" Text='<%# Bind("monReduceVat") %>' Width="40px"></asp:Label>
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="40px" /></asp:TemplateField>
        ...
        <tr><td colspan="6" style="text-align:right"><asp:Label ID="lblSingatrue" runat="server" Text="Seller Signature and Seal"></asp:Label></td>  </tr>
