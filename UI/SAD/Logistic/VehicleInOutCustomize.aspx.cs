    ...
    public partial class VehicleInOutCustomize : System.Web.UI.Page
    {
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            if (txtTrip.Text.Trim() != "")
            {
                ...
                if (unitid == 90 || unitid == 53)
                {
                    t.CompleteTripTest(Session[SessionParams.USER_ID].ToString(), ddlUnit.SelectedValue, txtTrip.Text.Trim(), ddlShip.SelectedValue, brandissuenumber, ref error);
                    dt = t.GetTripvsChallan(txtTrip.Text.Trim(), ddlUnit.SelectedValue);
                    grdvchallanchecking.DataSource = dt;
                    grdvchallanchecking.DataBind();
