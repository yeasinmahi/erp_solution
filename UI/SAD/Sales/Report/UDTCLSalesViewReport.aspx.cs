...
namespace UI.SAD.Sales.Report
{
    public partial class UDTCLSalesViewReport : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "StartupScript", "loadIframe('frame', 'https://report.akij.net/reports/report/Sales%20And%20Distribution/UDTCLSalesReport?rs:Embed=true');", true);
