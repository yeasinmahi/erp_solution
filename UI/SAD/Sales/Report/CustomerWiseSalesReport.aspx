<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseSalesReport.aspx.cs" Inherits="UI.SAD.Sales.Report.CustomerWiseSalesReport" %>
...
<head runat="server">
    <title>.: Customerwise Sales Report :.</title>
...
<body>
    <form id="frmSalesPrice" runat="server">
                        ...
                        <table style="width: auto;">
                            <tr>
                                <td style="width: 150px; text-align: right;">
                                    <asp:Label runat="server" Text="From Date :"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="txtFromDate" runat="server" Width="150px" autocomplete="off" placeholder="yyyy-MM-dd"></asp:TextBox>
                                    <cc1:CalendarExtender ID="fd" runat="server" Format="yyyy-MM-dd" TargetControlID="txtFromDate"></cc1:CalendarExtender>
                            </tr>
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label runat="server" Text="To Date :"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="txtToDate" runat="server"  Width="150px" autocomplete="off" placeholder="yyyy-MM-dd"></asp:TextBox>
                                    <cc1:CalendarExtender ID="td" runat="server" Format="yyyy-MM-dd" TargetControlID="txtToDate"></cc1:CalendarExtender>
                            </tr>
                            <tr>
                                <td style="text-align: right;" colspan="2">
                                    <asp:Button ID="btnShow" runat="server" Text="View-Sales-Report" Font-Bold="True"
