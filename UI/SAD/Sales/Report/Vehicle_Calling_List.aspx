<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicle_Calling_List.aspx.cs" Inherits="UI.SAD.Sales.Report.Vehicle_Calling_List" %>
...
<html>
<head runat="server">
    <title>.: Vehicle Calling List :.</title>
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    <table>
                        <tr>
                            <td colspan="6">
                                <h4>Vehicle Calling List Report</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>Unit:</td>
