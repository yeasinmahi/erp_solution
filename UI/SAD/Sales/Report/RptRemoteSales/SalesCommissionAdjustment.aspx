<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesCommissionAdjustment.aspx.cs" Inherits="UI.SAD.Sales.Report.RptRemoteSales.SalesCommissionAdjustment" %>
...
<head id="Head1" runat="server"><title></title><meta http-equiv="X-UA-Compatible" content="IE=edge" />
  ...
  <link href="../../../../Content/CSS/GridHEADER.css" rel="stylesheet" />
    ...
    function GridviewScroll() {
        $('#<%=grdvCustomerCommission.ClientID%>').gridviewScroll({
        width: 1024,
        height: 500,
        startHorizontal: 0,
        wheelstep: 10,
   ...
   function CheckAll(Checkbox) {
        var GridVwHeaderCheckbox = document.getElementById("<%=grdvCustomerCommission.ClientID %>");
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> Discount Adjustment Commission :<asp:HiddenField ID="hdnenroll" runat="server"/>
      ...
      <td style="text-align:right"><asp:Label ID="lblUnit" CssClass="lbl" runat="server" Text="Unit Name:  "></asp:Label></td>
           ...
           <tr class="tblrowOdd">
    <%--DataSourceID="odsSalesviewType" DataTextField="strReportType" DataValueField="intID"--%>
             <td style="text-align:right"><asp:Label ID="lblsalesviewtype" CssClass="lbl" runat="server" Text="Sales View:  "></asp:Label></td>
                                <td><asp:DropDownList ID="drdlSalesview" runat="server" DataSourceID="odsSalesComType" DataTextField="strCommissionType" DataValueField="intID" ></asp:DropDownList> 
                                    <asp:ObjectDataSource ID="odsSalesComType" runat="server" SelectMethod="SalesComtType" TypeName="SAD_BLL.Sales.SalesOrder">
                                        <SelectParameters>
         ...
         <div class="leaveApplication_container"> 
             <table>
              ...
              <asp:GridView ID="grdvCustomerCommission" runat="server" AutoGenerateColumns="False" AllowPaging="false"  BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="grdvCustomerCommission_PageIndexChanging" OnRowDataBound="grdvCustomerCommission_RowDataBound" >
                ...
                <ItemTemplate><asp:CheckBox ID="chkbx" runat="server"/></ItemTemplate></asp:TemplateField>
                    ...
                    <asp:HiddenField ID="hdncustcoaid" runat="server" Value='<%# Eval("intCustCoAid") %>' />
                     <asp:HiddenField ID="hdncustnarrationindividual" runat="server" Value='<%# Eval("strnarration") %>' />
                    <asp:HiddenField ID="hdncustomercommissionndividual" runat="server" Value='<%# Eval("monadjustableamount") %>' />
                    <asp:HiddenField ID="hdncustname" runat="server" Value='<%# Eval("strCustName") %>' />
                    </ItemTemplate></asp:TemplateField>
                    <asp:BoundField DataField="strCustName" HeaderText="Name" SortExpression="strCustName" ItemStyle-HorizontalAlign="Center" >
