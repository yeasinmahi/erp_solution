...
{
    public partial class NBR_SalesChallan : BasePage
    {
        ...
        protected string GetEditLink(object voucherID, object completed)
        {
            ...
            {
                case "false":
                    str = "<a href=\"#\" onclick=\"ShowPopUpE('NBR_DOEntry.aspx?id=" + voucherID + "&unit=" + ddlUnit.SelectedValue + "')\"class=\"link\">Edit</a>";
                    //str = "";
                    break;
                case "true":
                    str = "";
