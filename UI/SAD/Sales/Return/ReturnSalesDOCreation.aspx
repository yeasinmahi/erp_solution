<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnSalesDOCreation.aspx.cs" Inherits="UI.SAD.Sales.Return.ReturnSalesDOCreation" %>
                    ...
                    <table style="width: 850px; background-color: #F0F0F0;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="RSDO" runat="server" BackColor="#ffff66" Text="Return Sales Order" Enabled="false" Checked="true" TextAlign="Left"  />
                        ...
                        <asp:GridView SkinID="sknGrid1" ID="GridView1" runat="server" DataSourceID="XmlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DiscountAmount">
                                    <ItemTemplate>
                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("Vat") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="G. Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label14" runat="server" Text='<%# GetFullTotal(""+Eval("Pr"), ""+Eval("ApprQnt"), ""+Eval("ExtPr"),  ""+Eval("Vat")  ) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
