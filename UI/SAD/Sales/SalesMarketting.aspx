<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1" Inherits="UI.SAD.Sales.SalesMarketting" Codebehind="SalesMarketting.aspx.cs" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Amount" SortExpression="strNarration">
                     ...
                     <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>                            
                            <a href="#" onclick="ShowPopUpC('Report/DO2Print.aspx?id=<%# Eval("intId") %>&unit=<%# ddlUnit.SelectedValue %>')" class="link">Challan</a>
                        </ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetSalesInfoForMarketting"
