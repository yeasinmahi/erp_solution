<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1" Inherits="UI.SAD.Sales.DOEntry2" Codebehind="DOEntry2.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var unitID=parseInt(document.getElementById('hdnUnit2').value);
        var tot=0;
        if(unitID==6)
        {
            var e = document.getElementById('ddlUOM');
            var uom = e.options[e.selectedIndex].text;
        ...
        //if (tot > 0) { document.getElementById('btnAdd').disabled = false; }
        //else { document.getElementById('btnAdd').disabled = true; }
        //var visibilit = document.getElementById('hdnvisibility').value;
        //var salestype = document.getElementById('hdnsalestype').value;
        //if (salestype == "Local Sales" || salestype == "Ready Mix" && visibilit == 'false')
        //{document.getElementById('lblPrice').className = 'hide'; }
        //else { document.getElementById('lblPrice').className = ''; }
    }
    </script>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 450px; float: right;">
                    ...
                    <asp:HiddenField ID="hdnUnit2" Value="0" runat="server" />
                                    ...
                                    <table style="width: 300px;">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%--<asp:DropDownList ID="ddlSupplierList" runat="server" AutoPostBack="false" CssClass="dropdownList">
                                                    <asp:ListItem Selected="True" Value="Self Transport">Self Transport</asp:ListItem>
                                                    <asp:ListItem Value="M/S Munna Transport">M/S Munna Transport</asp:ListItem>
                                                    <asp:ListItem Value="Kalpana Transport">Kalpana Transport</asp:ListItem>
                                                    <asp:ListItem Value="Modern Transport">Modern Transport</asp:ListItem>
                                                    <asp:ListItem Value="Shuktara Transport">Shuktara Transport</asp:ListItem>
                                                    <asp:ListItem Value="Kh. Transport">Kh. Transport</asp:ListItem>
                                                    <asp:ListItem Value="Lalon Tranport">Lalon Tranport</asp:ListItem>
                                                    <asp:ListItem Value="Akij Transport Agency">Akij Transport Agency</asp:ListItem>
                                                    <asp:ListItem Value="Jamuna Transport">Jamuna Transport</asp:ListItem>
                                                    <asp:ListItem Value="A.N Transport">A.N Transport</asp:ListItem>
                                                    <asp:ListItem Value="Tania Transport">Tania Transport</asp:ListItem>
                                                    <asp:ListItem Value="Sonar Bangla Transport">Sonar Bangla Transport</asp:ListItem>
                                                    <asp:ListItem Value="Nila Transport">Nila Transport</asp:ListItem>
                                                    <asp:ListItem Value="Others Transport">Others Transport</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:TextBox ID="txtSupplier" runat="server" Width="200px" Visible="true"></asp:TextBox>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtProduct" runat="server" AutoCompleteType="Search" Width="250px"
                                    AutoPostBack="true" OnTextChanged="txtProduct_TextChanged" ReadOnly="True"></asp:TextBox>
