<%@ Page Language="C#" Theme="Theme1" AutoEventWireup="true" Inherits="UI.SAD.Sales.SalesAccounts" Codebehind="SalesAccounts.aspx.cs" %>
...
<head runat="server">
    ...
    function ShowPopUpC(url){       
        var rand_no = Math.floor(11*Math.random());
        url = url + '&rnd='+rand_no; 
        newwindow = window.open(url,'sub','scrollbars=yes,toolbar=0,height=650,width=1000,top=70,left=220');
        if (window.focus) {newwindow.focus()}
        }
        
    function ValidateComplete(sender, args){
        var txt = document.getElementById("txtCompleteDate").value;
        if(!confirm('Do you want to complete this voucher at this date: ' + txt + ' ?')){
            args.IsValid = false;
            isProceed = false;
        }
    }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 150px; float: right;">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                <asp:RadioButtonList ID="rdoEntryBy" runat="server" RepeatDirection="Horizontal"
                                    AutoPostBack="True">
                                    <asp:ListItem Value="all">All</asp:ListItem>
                                    <asp:ListItem Selected="True" Value="acc">By Accounts</asp:ListItem>
                                    <asp:ListItem Value="do">By DO</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td colspan="3" align="right" style="color: Green; height: 40px; vertical-align: bottom;">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnSelect" runat="server" Text="Select All" Style="height: 26px"
                                                OnClick="btnSelect_Click" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnUnSelect" runat="server" Text="Un Select All" Style="height: 26px"
                                                OnClick="btnUnSelect_Click" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnCompleteAll" ValidationGroup="valCom" runat="server" Text="Complete All"
                                                Style="height: 26px" OnClick="btnCompleteAll_Click" />
                                        </td>
                                        <td>
                                            Complete Date:
                                        </td>
                                        <td>
                                            ...
                                            <cc1:CalendarExtender CssClass="cal_Theme1" TargetControlID="txtCompleteDate" Format="dd/MM/yyyy"
                                                PopupButtonID="imgCal_3" ID="CalendarExtender3" runat="server" EnableViewState="true">
                                            </cc1:CalendarExtender>
            ...
            <asp:GridView ID="GridView1" SkinID="sknGrid1" runat="server" AutoGenerateColumns="False"
                CaptionAlign="Top" Caption="Sales Entry" DataKeyNames="intId" DataSourceID="ObjectDataSource3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Date" SortExpression="dteDate">
                        <ItemTemplate>
                            <asp:Label ID="Label4" runat="server" Text='<%# UI.ClassFiles.CommonClass.GetShortDateAtLocalDateFormat(Eval("dteDate")) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Amount" SortExpression="strNarration">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a href="#" onclick="ShowPopUpC('Report/DO2Print.aspx?id=<%# Eval("intId") %>&unit=<%# ddlUnit.SelectedValue %>')"
                                class="link">Print</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Button ID="btnCancel" ValidationGroup="valCan" runat="server" Text="Delete"
                                CommandArgument='<%# Eval("intId") %>' OnClick="btnCancel_Click" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:BoundField DataField="intId" HeaderText="intId" SortExpression="intId" ItemStyle-CssClass="hide"
                        HeaderStyle-CssClass="hide">
                        <HeaderStyle CssClass="hide" />
                        <ItemStyle CssClass="hide" />
                    </asp:BoundField>
                    <asp:CheckBoxField DataField="ysnEnable" HeaderText="Enabled" ItemStyle-CssClass="hide"
            ...
            <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetSalesInfoForAccounts"
                TypeName="SAD_BLL.Sales.SalesView" OldValuesParameterFormatString="original_{0}">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="rdoEntryBy" Name="byAccounts" PropertyName="SelectedValue" Type="String" />
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ValidateCancel"
                ValidationGroup="valCan"></asp:CustomValidator>
        </ContentTemplate>
    </asp:UpdatePanel>
