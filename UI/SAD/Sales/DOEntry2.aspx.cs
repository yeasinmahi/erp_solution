...
{
    public partial class DOEntry2 : BasePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            SalesEntry se = new SalesEntry();
            se.AddUpdateSalesDO2(xml, Session[SessionParams.USER_ID].ToString(), ddlUnit.SelectedValue
                ...
                , ddlCurrency.SelectedValue, decimal.Parse(txtConvRate.Text), RadioButtonList1.SelectedValue, ext, "", txtNarration.Text.Trim(), txtDriver.Text.Trim(), 
                txtDriverContact.Text.Trim(), ddlSo.SelectedValue, ddlShip.SelectedValue, ref code, ref id);
        ...
        private string GetXmlFilePath()
        {
            ...
            return Server.MapPath("") + "/Data/" + Session["sesUserID"] + "_" + unit + "_item.xml";
        }
        ...
        private void SetPrice()
        {
            ...
            if (hdnProduct.Value != "")
            {
                ...
                if (pr <= 0 && (hdnUnit.Value != "3" && hdnUnit2.Value != "3") &&
        ...
        private bool CheckLimitBalance(decimal currentAmount)
        {
            ...
            if (hdnCreditSales.Value == "true")
            {
                ...
                //else if (lm >= 0 && cur < 0 && (hdnUnit.Value =="2" || hdnUnit2.Value == "2") ) //else if (lm > 0 && cur < 0)
                else if (lm >= 0 && cur < 0 && (hdnUnit.Value == "2" || hdnUnit2.Value == "2" || hdnUnit.Value == "6" || hdnUnit2.Value == "6" || hdnUnit.Value == "1" || hdnUnit2.Value == "1")) //else if (lm > 0 && cur < 0)
                {
                    return false;
                }
        ...
        private void SalesConfigSet()
        {
            ...
            hdnUnit2.Value = ddlUnit.SelectedValue;
