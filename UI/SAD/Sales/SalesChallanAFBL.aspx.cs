...
{
    public partial class SalesChallanAFBL : BasePage
    {
        SeriLog log = new SeriLog();
        string location = "SAD";
        string start = "starting SAD\\Sales\\SalesChallanAFBL";
        string stop = "stopping SAD\\Sales\\SalesChallanAFBL";
        ...
        protected void btnCompleted_Click(object sender, EventArgs e)
        {
            ...
            var tracker = new PerfTracker("Performance on SAD\\Sales\\SalesChallanAFBL Challan Complete", "", fd.UserName, fd.Location,
                fd.Product, fd.Layer);
            try
            {
            ...
            sv.ChallanComplete(id, Session[SessionParams.USER_ID].ToString());
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            // starting performance tracker
            var tracker = new PerfTracker("Performance on SAD\\Sales\\SalesChallanAFBL Cancel challan", "", fd.UserName, fd.Location,
                fd.Product, fd.Layer);
            try
            {
                SalesView sv = new SalesView();
        ...
        protected string GetGrandTotal1(int col)
        {
            decimal tot = 0;
