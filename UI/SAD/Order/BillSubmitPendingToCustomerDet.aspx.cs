        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    dgbCustomerprintcopy.FooterRow.Cells[5].Text = prchqnt.ToString();
                    dgbCustomerprintcopy.FooterRow.Cells[6].Text = prchamount.ToString();
                    dgbCustomerprintcopy.FooterRow.Cells[7].Text = rtnqnt.ToString();
