<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TADAEntryByAnother.aspx.cs" Inherits="UI.SAD.Order.TADAEntryByAnother" %>
    ...
    $("#txtFullName").autocomplete({
        source: function (request, response) {
            $.ajax({
                ...
                url: "TADAEntryByAnother.aspx/GetAutoCompleteDataForTADA",
...
<%--=========================================Start My Code From Here===============================================--%>
         ...
         <div class="tabs_container"> TA DA Entry (Employees whom have no official Email address ) :<asp:HiddenField ID="hdnenroll" runat="server"/>
        ...
        <td>
         ...
         <td> <asp:TextBox ID="txtMovDuration" runat="server" Width="200px" TextMode="Number" placeholder="Fill by digit"   CssClass="txtBox"></asp:TextBox><span style="color:red">*</span></td>      
        ...
        <td> <asp:TextBox ID="txtToaddr" runat="server" Width="200px" TextMode="MultiLine" CssClass="txtBox"></asp:TextBox></td>
            ...
            <tr class="tblroweven">
                 ...
                 <td><asp:TextBox ID="txtBusFair" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)"></asp:TextBox></td>
                 <td style="text-align:right"><asp:Label ID="lblRickshaw" runat="server" CssClass="lbl" Text="Rickshaw:  "></asp:Label> </td>
                 <td><asp:TextBox ID="txtRickshaw" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)"></asp:TextBox></td>
                 <td style="text-align:right"><asp:Label ID="lblCNG" runat="server" CssClass="lbl" Text="C.N.G:  "></asp:Label></td>
                 <td><asp:TextBox ID="txtCNG" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox" TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)"></asp:TextBox> </td>
             </tr>
             <tr class="tblrowOdd">
                 <td style="text-align:right"><asp:Label ID="lblTrain" runat="server" CssClass="lbl" Text="Train:  "></asp:Label></td>
                 <td><asp:TextBox ID="txtTrain" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)"></asp:TextBox> </td>
                 <td style="text-align:right"><asp:Label ID="lblBoat" runat="server" CssClass="lbl" Text="Boat:  "></asp:Label> </td>
                 <td><asp:TextBox ID="txtBoat" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox" TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox> </td>
                 <td style="text-align:right"> <asp:Label ID="lblAnOtherVh" runat="server" CssClass="lbl" Text="Another Transport:  "></asp:Label></td>
                 <td><asp:TextBox ID="txtOtherVh" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox></td>
             </tr>
             <tr class="tblroweven">
                 <td style="text-align:right"><asp:Label ID="lblOwnDA" runat="server" CssClass="lbl" Text="Own D.A:  "></asp:Label></td>
                 <td> <asp:TextBox ID="txtOwnDA" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox></td>
                 <td style="text-align:right"> <asp:Label ID="lblOtherDA" runat="server" CssClass="lbl" Text="Entertainment:  "></asp:Label> </td>
                 <td><asp:TextBox ID="txtOtherDA" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox" TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox> </td>
                 <td style="text-align:right"><asp:Label ID="lblHotel" runat="server" CssClass="lbl" Text="Hotel :  "></asp:Label></td>
                 <td> <asp:TextBox ID="txtHotel" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox></td>
             </tr>
             <tr class="tblrowOdd">
                 <td style="text-align:right"> <asp:Label ID="lblOtherCost" runat="server" CssClass="lbl" Text="OtherCost:  "></asp:Label> </td>
                 <td> <asp:TextBox ID="txtOtherCost" runat="server" onkeyup="sum();" AutoPostBack="false" CssClass="txtBox"  TextMode="Number" Width="200px" onkeypress="javascript:return isNumber (event)" ></asp:TextBox> </td>
                 <td style="text-align:right"><asp:Label ID="lblRemarks" runat="server" CssClass="lbl" Text="Remarks:  "></asp:Label> </td>
                 <td> <asp:TextBox ID="TextBox2" runat="server" CssClass="txtBox" TextMode="MultiLine" Width="200px"></asp:TextBox> </td>
             ...
             <tr class="tblroweven">
                 ...
                 <td><asp:TextBox ID="txtContactPerson" placeholder="Name" runat="server" CssClass="txtBox" TextMode="SingleLine" Width="200px"></asp:TextBox></td>
                 <td style="text-align:right">  <asp:Label ID="lblContactPersonPhone" runat="server"  CssClass="lbl" Text="Phone:  "></asp:Label></td>
                 <td><asp:TextBox ID="txtPhone" placeholder="Number" runat="server" CssClass="txtBox" onkeypress="javascript:return isNumber (event)" TextMode="SingleLine" Width="200px"></asp:TextBox></td>
                 <td style="text-align:right"><asp:Label ID="lblVisitedOrganziation" runat="server" CssClass="lbl" Text="Visited Place  :  "></asp:Label></td>
                 <td><asp:TextBox ID="txtVisitedPlace" runat="server" placeholder="Address" CssClass="txtBox" TextMode="MultiLine" Width="200px"></asp:TextBox></td>
             </tr>
             <tr class="tblrowOdd">
             ...
             <tr class="tblroweven">
                <td>
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="aplName" HeaderText="Applicant Name" SortExpression="aplName" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100" />
                            
                             <asp:BoundField DataField="AplEnrol" HeaderText="Enrol" SortExpression="AplEnrol" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100" />
                            ...
                            <asp:TemplateField HeaderText="bus fair" HeaderStyle-HorizontalAlign="Center" SortExpression="busfair">
                            ...
                            <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblbusfair1" runat="server" Font-Bold="true"  Text='<%# busfairTotal %>'  /></FooterTemplate></asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Rick fair" HeaderStyle-HorizontalAlign="Center" SortExpression="Rickfai">
                    <ItemTemplate><asp:Label ID="lblRickfai" runat="server" Text='<%# (""+Eval("Rickfai")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblRickfai1" runat="server" Font-Bold="true"  Text='<%# RickfaiTotal %>'  /></FooterTemplate></asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="cng fair" HeaderStyle-HorizontalAlign="Center" SortExpression="cngfair">
                    <ItemTemplate><asp:Label ID="lblcngfair" runat="server" Text='<%# (""+Eval("cngfair")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblcngfair1" runat="server" Font-Bold="true" Text='<%# cngfairTotal %>' /></FooterTemplate></asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="train fair" HeaderStyle-HorizontalAlign="Center" SortExpression="trainfair">
                    <ItemTemplate><asp:Label ID="lbltrainfair" runat="server" Text='<%# (""+Eval("trainfair")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblboatfair1" runat="server" Font-Bold="true"   Text='<%# trainfairTotal %>'/></FooterTemplate></asp:TemplateField>
                             ...
                             <asp:TemplateField HeaderText="boat fair" HeaderStyle-HorizontalAlign="Center" SortExpression="boatfair">
                    <ItemTemplate><asp:Label ID="lblboatfair" runat="server" Text='<%# (""+Eval("boatfair")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblboatfair1" runat="server" Font-Bold="true"  Text='<%# boatfairTotal %>' /></FooterTemplate></asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="other vhfair" HeaderStyle-HorizontalAlign="Center" SortExpression="othervhfair">
                    <ItemTemplate><asp:Label ID="lblothervhfair" runat="server" Text='<%# (""+Eval("othervhfair")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblothervhfair1" runat="server" Font-Bold="true" Text='<%# othervhfairTotal %>'  /></FooterTemplate></asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="own DA" HeaderStyle-HorizontalAlign="Center" SortExpression="ownda">
                    <ItemTemplate><asp:Label ID="lblownda" runat="server" Text='<%# (""+Eval("ownda")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblownda1" runat="server" Font-Bold="true"  Text='<%# owndaTotal %>' /></FooterTemplate></asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Entertainment" HeaderStyle-HorizontalAlign="Center" SortExpression="otherpersonda">
                    <ItemTemplate><asp:Label ID="lblotherpersonda" runat="server" Text='<%# (""+Eval("otherpersonda")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblotherpersonda1" runat="server" Font-Bold="true"  Text='<%# otherpersondaTotal %>'  /></FooterTemplate></asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="hotel fair" HeaderStyle-HorizontalAlign="Center" SortExpression="hotelfair">
                    <ItemTemplate><asp:Label ID="lblhotelfair" runat="server" Text='<%# (""+Eval("hotelfair")) %>'></asp:Label></ItemTemplate>
                      <ItemStyle HorizontalAlign="Center" Width="120px"/><FooterTemplate><asp:Label ID="lblhotelfair1" runat="server" Font-Bold="true" Text='<%# hotelfairTotal %>'  /></FooterTemplate></asp:TemplateField>
                             ...
                             <asp:TemplateField HeaderText="Other Cost" HeaderStyle-HorizontalAlign="Center" SortExpression="OtherCost">
