                                                    ...
                                                    <td style="width: 200px;">
                                                        <table style="font-size: 10px; color: Green">
                                                            ...
                                                            <tr style="background-color: #F0F0FF">
                                                                <td>Capacity</td>
                                                                <td>
                                                                    <asp:Label ID="lblC" runat="server" Text=""></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Loaded</td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <asp:Label ID="lblChallan" runat="server"></asp:Label></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                        ...
                                        <img alt=""  src="../../Content/images/icons/Delete.png" style="border: 0px;" title="Delete"/>
                                            ...
                                            <img alt="" src="../../Content/images/icons/edit.gif" style="border: 0px;"
                                                    ...
                                                    <asp:TemplateField HeaderText="SL.N">
                                                        <HeaderTemplate>
                                                            <asp:TextBox ID="TxtServiceConfg" runat="server" Width="70" placeholder="Search" onkeyup="Search_GridView1(this, 'GridView1')"></asp:TextBox>
                                                        </HeaderTemplate>
