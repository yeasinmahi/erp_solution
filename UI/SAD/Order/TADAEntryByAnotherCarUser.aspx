<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TADAEntryByAnotherCarUser.aspx.cs" Inherits="UI.SAD.Order.TADAEntryByAnotherCarUser" %>
...
<head runat="server">
  ...
  <script>
      ...
      function personalMilagCal() {
          ...
          var ppermilageRate = document.getElementById('txtPersonalRate').value;
        ...
        function sum() {
            ...
            var result = parseFloat(txtPetrolCost) + parseFloat(txtOctenCost) + parseFloat(txtCNGCost) + parseFloat(txtMobilCost)
                         ...
                         + parseFloat(txtOwnDA) + parseFloat(txtDriverDA) + parseFloat(txtOwnHotel) + parseFloat(txtDriverHotel)
                          + parseFloat(txtPhotocopy) + parseFloat(txtCourier) + parseFloat(txtOtherCost)
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="tabs_container"> TA - DA information input Form (For Bike and Car User)  :<asp:HiddenField ID="hdnApplicantEnrol" runat="server"/>
        <asp:HiddenField ID="hdnstation" runat="server"/><asp:HiddenField ID="hdnsearch" runat="server"/>
        
        <asp:HiddenField ID="HiddenUnit" runat="server"/><asp:HiddenField ID="hdnconfirm" runat="server" />  <input type="hidden" id="DATE" name="DATE" value="WOULD_LIKE_TO_ADD_DATE_HERE">
        ...
        <tr class="tblroweven">
                        ...
                        <td><asp:TextBox ID="txtEffectiveDate" placeholder="Click for date selection" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true" autocomplete="off"></asp:TextBox>
                        ...
                        <td> <asp:TextBox ID="txtStarTime" runat="server" onkeyup="sub();" Width="200px"   CssClass="txtBox"></asp:TextBox></td>            
                        ...
                        <td> <asp:TextBox ID="txtEndTime" runat="server" onkeyup="sub();" Width="200px"  CssClass="txtBox"></asp:TextBox></td>            
            ...
            <td><asp:TextBox ID="txtFullName" runat="server"  placeholder="Type  Name"  Font-Bold="true" CssClass="txtBox" AutoPostBack="True" OnTextChanged="txtFullName_TextChanged"></asp:TextBox>
            ...
            <td><asp:TextBox ID="txtDepartment" runat="server" AutoPostBack="false" Font-Bold="true" BackColor="#ffffcc" CssClass="txtBox" Enabled="false"></asp:TextBox></td> 
               ...
               <td><asp:Label ID="Label5" runat="server" CssClass="lbl"  Text="Fuel station Payment: "></asp:Label><span style="color:red">*</span></td>
         ...
         <tr class="tblrowOdd">
                        ...
                        <td> <asp:TextBox ID="txtFromAddr" runat="server" AutoPostBack="false" Width="200px" TextMode="MultiLine" CssClass="txtBox"></asp:TextBox></td>
                        ...
                        <td> <asp:TextBox ID="txtToaddr" runat="server" AutoPostBack="false" Width="200px" TextMode="MultiLine" CssClass="txtBox"></asp:TextBox></td>
        ...
        <tr class="tblroweven">
              ...
              <tr class="tblrowOdd" style="background-color:lightcyan">
                    ...
                    <td><asp:Label ID="Label1" CssClass="lbl" runat="server" Text="CNG Credit1: "></asp:Label></td>
                    <td>
                        ...
                        <td style="text-align:right"><asp:Label ID="Label2" CssClass="lbl" runat="server" Text="CNG Credit1" ></asp:Label><span style="color:red">*</span></td>
                        ...
                        <td style="text-align:right"><asp:Label ID="Label3" CssClass="lbl" runat="server" Text="CNG Credit2:  " ></asp:Label></td>
                        <td>
                ...
                <td style="text-align:right"><asp:Label ID="Label4" CssClass="lbl" runat="server" Text="CNG Credit2" ></asp:Label><span style="color:red">*</span></td>
             ...
             <tr class="tblrowOdd" style="background-color:lightyellow">
                    <td style="text-align:right"><asp:Label ID="Label6" CssClass="lbl" runat="server" Text="Oil Credit Station :  " ></asp:Label></td>
                        <td>
                ...
                <td style="text-align:right"><asp:Label ID="Label7" CssClass="lbl" runat="server" Text="Oil Credit" ></asp:Label><span style="color:red">*</span></td>
             ...
             <tr class="tblrowOdd">
                ...
                <tr class="tblroweven">
                 <td style="text-align:right"><asp:Label ID="lblPhotCopy" runat="server" CssClass="lbl" Text="Photocopy:  "></asp:Label></td>
                 <td><asp:TextBox ID="txtPhotocopy" onkeyup="sum();" AutoPostBack="false" runat="server"   CssClass="txtBox"  TextMode="Number" Width="200px"></asp:TextBox></td>
             ...
             <tr class="tblrowOdd">
                 <td>
                     <asp:Button ID="btnAddBikeCarUser" runat="server" OnClick="btnAddBikeCarUser_Click" OnClientClick = "Confirm()"  Text="Add" BackColor="#ffffcc" />
                 </td>
                 <td>
            ...
            <table>
             <tr class="tblroweven">
                <td>
                    ...
                    <asp:GridView ID="GridviewBikeCarUserInputInfoEntryByAnother" runat="server" AutoGenerateColumns="false" RowStyle-Wrap="true" HeaderStyle-Wrap="true" OnSelectedIndexChanged="GridviewBikeCarUserInputInfoEntryByAnother_SelectedIndexChanged" OnRowDeleting="GridviewBikeCarUserInputInfoEntryByAnother_RowDeleting"  >
                        <Columns>
