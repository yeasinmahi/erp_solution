...
{
    public partial class VehicleSelectViewForQuation : System.Web.UI.Page
    {
        protected decimal totAmount = 0, totPieces = 0, aprPieces = 0;
        SeriLog log = new SeriLog();
        string location = "SAD";
        string start = "starting SAD\\Order\\VehicleSelectViewForQuation";
        string stop = "stopping SAD\\Order\\VehicleSelectViewForQuation";
        ...
        protected string GetEditLink(object voucherID, object completed)
        {
            ...
            {
                case "false":
                    str = "<a href=\"#\" onclick=\"ShowPopUpE('VehicleSelectNChallan.aspx?id=" + voucherID + "&unit=" + ddlUnit.SelectedValue + "&ship=" + ddlShip.SelectedValue.ToString().ToLower() + "')\"class=\"link\">Assign Vehicle</a>";
                    //str = "";
                    break;
                case "true":
                    str = "";
