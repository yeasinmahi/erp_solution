<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryViewForPendingOrder.aspx.cs" Inherits="UI.SAD.Order.DeliveryViewForPendingOrder" %>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function Registration(url) {
             window.open('DeliveryOrderPendingAmountPrint.aspx?ID=' + url, '', "height=2024, width=750, scrollbars=yes, left=50, top=10, resizable=yes, title=Preview");
                  }
</script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnTo" runat="server" />
                      ...
                      <asp:GridView ID="dgvCustomerVSPendingQnt" runat="server"  AllowPaging="false" PageSize="11125" OnPageIndexChanging="dgvCustomerVSPendingQnt_PageIndexChanging"  AutoGenerateColumns="false" CellPadding="5" ShowFooter="true">
                    ...
                    <Columns>
                       ...
                       <%--intcustmid,strname,stritemname,strDONumber,numrestqnt,monrestamount--%>
                        ...
                        <asp:BoundField DataField="numRestPieces" HeaderText="Remaining Qnt" SortExpression="numRestPieces" ItemStyle-HorizontalAlign="Center" />
             ...
             <%-- CommandArgument='<%# Eval("intApplicantEnrol")+","+Eval("dteFromdate")+","+Eval("intApplicantUnit")%>'--%>
                              <ItemTemplate>                                                                                                          
             <asp:Button ID="Complete" runat="server" Text="Deaills" class="button" CommandName="complete" OnClick="Complete_Click"   CommandArgument='<%# Eval("intCustomerId")+","+Eval("unitid")%>' /></ItemTemplate>
             </asp:TemplateField> 
