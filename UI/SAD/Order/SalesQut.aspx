<%@ Page Language="C#" AutoEventWireup="true" Inherits="UI.SAD.Order.SalesQut" Codebehind="SalesQut.aspx.cs" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 400px; float: right;">
                    ...
                    <%--<asp:HiddenField ID="hdnIncenPrice" Value="0" runat="server" /> --%>                   
                        ...
                        <asp:GridView SkinID="sknGrid1" ID="GridView1" runat="server" DataSourceID="XmlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label3" runat="server" Text='<%# GetTotal(""+Eval("Pr"), ""+Eval("Qnt")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# GetGrandTotal(4) %>'></asp:Label>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <FooterStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                               ...
                               <%-- <asp:TemplateField HeaderText="Logistic">
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label8" runat="server" Text='<%# GetTotal(""+Eval("ExtPr"), ""+Eval("Qnt"), ""+Eval("IncPr")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="Label9" runat="server" Text='<%# GetGrandTotal(7) %>'></asp:Label>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <FooterStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="G. Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label10" runat="server" Text='<%# GetFullTotal(""+Eval("Pr"), ""+Eval("Qnt"), ""+Eval("ExtPr"),  ""+Eval("IncPr")  ) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="Label11" runat="server" Text='<%# GetGrandTotal(10) %>'></asp:Label>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <FooterStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
