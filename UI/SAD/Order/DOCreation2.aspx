<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DOCreation2.aspx.cs" Inherits="UI.SAD.Order.DOCreation2" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 410px; float: right;">
                    ...
                    <asp:HiddenField ID="hdnUndeliverqntpricevalue" Value="" runat="server" />
                    <asp:HiddenField ID="hdncalculateddiscount" Value="" runat="server" />
                    <asp:HiddenField ID="hdndiscount" Value="0" runat="server"  />
                    ...
                    <table style="width: 850px; background-color: #F0F0F0;">
                        <tr>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="color: Blue;">
                                                <b style="color: Blue;">Undelv.: </b> &nbsp;
                                                <asp:Label ID="lblundelvvalue" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                            ...
                            <td align="right">
                                <asp:TextBox ID="textHallmark" runat="server"  Width="250px"></asp:TextBox>
                            </td>
                                            <td>
                               Slot
                            </td>
                                             <td align="right">
                                <asp:TextBox ID="txtslot" runat="server" BackColor="#ffffcc"  Width="250px"></asp:TextBox>
                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                    ...
                    <table style="width: 850px; background-color: #F0F0F0;">
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <asp:RadioButtonList ID="rdoNeedVehicle" runat="server"
                                    RepeatDirection="Horizontal">
                                    <asp:ListItem Selected="True" Value="true">Yes</asp:ListItem>
                                    <asp:ListItem Value="false">No</asp:ListItem>
                                   <%-- <asp:ListItem Value="false">Supplier</asp:ListItem>--%>
                                </asp:RadioButtonList>
                            </td>                                                       
                            ...
                            <td>
                                ...
                                <%--<asp:CheckBox ID="sdv" runat="server" Text="Site Delivery" TextAlign="Left" Enabled="false" />--%>
                                  <asp:CheckBox ID="chkSRSubsidiary" runat="server" Visible="false" Text="SR Subsidiary" TextAlign="Left"  />
                                <asp:CheckBox ID="chkSupplier" runat="server" Text="Supplier" TextAlign="Left"  />
                                <asp:Label ID="lblcompanyvhclprice" runat="server" Text="Own vhcl."></asp:Label>
                                <asp:TextBox ID="txtcompanyvhcle" Width="40px" runat="server" Text="0.00"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <%--<b>EXTRA CHARGES</b>
                        ...
                        <asp:GridView SkinID="sknGrid1" ID="GridView1"  runat="server" DataSourceID="XmlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="G. Total">
                                    <FooterStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label14" runat="server" Text='<%# GetFullTotal(""+Eval("Pr"), ""+Eval("ApprQnt"), ""+Eval("ExtPr"),  ""+Eval("IncPr"),  ""+Eval("DiscountAmount"),  ""+Eval("Damage"),  ""+Eval("Special") ,  ""+Eval("SRSubsidy")  ,  ""+Eval("Supplvheicle") ,  ""+Eval("Customvheicle"),  ""+Eval("companyvhc") ) %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Comm">
                                    <ItemTemplate>
                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("DiscountAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Damage">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelDamage" runat="server" Text='<%# Eval("Damage") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Special">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelSpecial" runat="server" Text='<%# Eval("Special") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                 <asp:TemplateField HeaderText="SRSubsidy">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelSRSubsidy" runat="server" Text='<%# Eval("SRSubsidy") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                 <asp:TemplateField HeaderText="SupplyVhc">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelSupplvheicle" runat="server" Text='<%# Eval("Supplvheicle") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                 <asp:TemplateField HeaderText="CustomerVhc">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelCustomvheicle" runat="server" Text='<%# Eval("Customvheicle") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Company">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelCompanyvhc" runat="server" Text='<%# Eval("Companyvhc") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
