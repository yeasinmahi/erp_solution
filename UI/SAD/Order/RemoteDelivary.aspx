<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoteDelivary.aspx.cs" Inherits="UI.SAD.Order.RemoteDelivary" %>
...
<body>
    ...
    <div id="divControl" class="divPopUp2" style="width: 100%; height: 80px; float: right;"><asp:HiddenField ID="hdnCharBasedOnUom" runat="server" />
    <asp:HiddenField ID="hdnIncenBasedOnUom" runat="server" /><asp:HiddenField ID="hdnCreditSales" runat="server" />
    <asp:HiddenField ID="hdnBl" Value="0" runat="server" /><asp:HiddenField ID="hdnPN" Value="0" runat="server" />
    <asp:HiddenField ID="hdnUnit" Value="0" runat="server" /><asp:HiddenField ID="hdnXFactoryVhl" Value="0" runat="server" />
    <asp:HiddenField ID="hdnXFactoryChr" Value="0" runat="server" /><asp:HiddenField ID="hdnEditPr" runat="server" />
    <asp:HiddenField ID="hdnPrice" Value="0" runat="server" /><asp:HiddenField ID="hdnChrgMerge" Value="0" runat="server" />
    <asp:HiddenField ID="hdnSuppTax" Value="0" runat="server" /><asp:HiddenField ID="hdnVat" Value="0" runat="server" />
    <asp:HiddenField ID="hdnVatPrice" Value="0" runat="server" /><asp:HiddenField ID="hdnCredit" Value="" runat="server" /></div>
...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <table style="width: 90%;background-color: #E0E0E0;">
        <tr>
        <td style="width: 80px;">
        Unit
        </td>
        ...
        <table style="width: 90%;height: 40px; background-color: #FFF0F0;">
        <tr>
        <td style="width: 80px;">
        Date
        </td>
        ...
        <table style="width: 90%;background-color: #F0F0F0;">
        <tr>
        <td>
        Customer
        </td>
        <td>
        <asp:HiddenField ID="hdnCustomer" runat="server" /><asp:HiddenField ID="hdnCustomerText" runat="server" />
        ...
        <table style="width: 90%;background-color: #D0D0D0;">
        <tr>
        ...
        <asp:CheckBox ID="sdv" runat="server" Text="Site Delivery" TextAlign="Left" />
        ...
        <table style="width: 90%; background-color: #C0C0C0;">
        <tr>
        <td>
        <b style="">Product</b>
        </td>
