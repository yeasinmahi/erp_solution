<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadedReceiveChallanDetaills.aspx.cs" Inherits="UI.SAD.Order.UploadedReceiveChallanDetaills" %>
...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <tr class="tblheader"><td colspan="4"> Document List :<asp:HiddenField ID="hdnSeprationID" runat="server" /></td></tr>
            ...
            <tr><td colspan="4">
            <asp:GridView ID="grdvReceiveChallanDownload" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" 
