...
{
    public partial class TADAEntryByAnotherCarUser : System.Web.UI.Page
    {
        ...
        private void LoadGridwithXml()
        {
            try
            {
                ...
                System.Xml.XmlNode dSftTm = doc.SelectSingleNode("RemotetadaBikeCarUserEntryByAnother");
                xmlString = dSftTm.InnerXml;
                xmlString = "<RemotetadaBikeCarUserEntryByAnother>" + xmlString + "</RemotetadaBikeCarUserEntryByAnother>";
                StringReader sr = new StringReader(xmlString);
                DataSet ds = new DataSet();
                ds.ReadXml(sr);
                if (ds.Tables[0].Rows.Count > 0)
                { GridviewBikeCarUserInputInfoEntryByAnother.DataSource = ds; }
                else { GridviewBikeCarUserInputInfoEntryByAnother.DataSource = ""; }
              ...
              )
        {
            ...
            {
                doc.Load(filePathForXML);
                XmlNode rootNode = doc.SelectSingleNode("RemotetadaBikeCarUserEntryByAnother");
            ...
            else
            {
                ...
                XmlNode rootNode = doc.CreateElement("RemotetadaBikeCarUserEntryByAnother");
                XmlNode addItem = CreateItemNode(doc, BillDate, starttime, endtime, MovDuration, fromAddress, movementAddress, toAddress, nightstay, startmilage, endmilage, consumed, remarks, petrolqnt, petrolcost, octenqnt, octencost, cngqnt, cngcost, lubricantqnt, lubricantcost, busfair, Rickfai, cngfair, trainfair, Airplance, othervhfair, mntCost, ferrytoll, ownda, driverda, ownhotelfair, driverhotel, photocoly, courier, OtherCost, totalcost, FuelpaymentTypeid,
                    Cngcredit1FuelSupplierstationid, CNGCredit1AmountcngFuelStationbill, Cngcredit1FuelSupplierstationName
                   , Cngcredit2FuelSupplierstationid, CNGCredit2AmountcngFuelStationbill, Cngcredit2FuelSupplierstationName
                   , OilCredit1Supplierstationid, oilCredit1Stationbill, oilCredit1StationName
        ...
        private void Clear()
        {
            ...
            //txtSupplierCNGCredit1.Text = ""; txtSupplierCNGCredit2.Text = ""; txtOilCredit.Text = "";
            //drdlSupplierName.DataSource = null;
            //drdlSupplierName.DataBind();
            //drdlCNGStationNameCredit2.DataSource = null;
            //drdlCNGStationNameCredit2.DataBind();
            //drdlOilCreditStationName1.DataSource = null;
            //drdlOilCreditStationName1.DataBind();
        }
        ...
        protected void GridviewBikeCarUserInputInfoEntryByAnother_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void GridviewBikeCarUserInputInfoEntryByAnother_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                LoadGridwithXml();
                DataSet dsGrid = (DataSet)GridviewBikeCarUserInputInfoEntryByAnother.DataSource;
                dsGrid.Tables[0].Rows[GridviewBikeCarUserInputInfoEntryByAnother.Rows[e.RowIndex].DataItemIndex].Delete();
                dsGrid.WriteXml(filePathForXML);
                DataSet dsGridAfterDelete = (DataSet)GridviewBikeCarUserInputInfoEntryByAnother.DataSource;
                if (dsGridAfterDelete.Tables[0].Rows.Count <= 0)
                { File.Delete(filePathForXML); GridviewBikeCarUserInputInfoEntryByAnother.DataSource = ""; GridviewBikeCarUserInputInfoEntryByAnother.DataBind(); }
                ...
                else
                {
                    ...
                    if (diffbEOMTODATE > 0)
                    {
                        ...
                        else
                        {
                            ...
                            string strBillDate = DateTime.Parse(txtEffectiveDate.Text).ToString("yyyy-MM-dd");
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 1)
                            {
                                Serial = "2";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 2)
                            {
                                Serial = "3";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 3)
                            {
                                Serial = "4";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 4)
                            {
                                Serial = "5";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 5)
                            {
                                Serial = "6";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 6)
                            {
                                Serial = "7";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 7)
                            {
                                Serial = "8";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 8)
                            {
                                Serial = "9";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 9)
                            {
                                Serial = "10";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 10)
                            {
                                Serial = "11";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 11)
                            {
                                Serial = "12";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 12)
                            {
                                Serial = "13";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 13)
                            {
                                Serial = "14";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 14)
                            {
                                Serial = "15";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
                            ...
                            else if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count == 15)
                            {
                                Serial = "16";
                                CreateVoucherXml(strBillDate, strstarttime, strendtime, strMovDuration, strfromAddress, strmovementAddress, strtoAddress, strnightstay, strstartmilage
                              , strendmilage, strconsumed, strremarks, strpetrolqnt, strpetrolcost, stroctenqnt, stroctencost, strcngqnt, strcngcost, strlubricantqnt, strlubricantcost
        ...
        protected void btnSubmitBikeCar_Click(object sender, EventArgs e)
        {
            if (hdnconfirm.Value == "1")
            {
                    ...
                    if (GridviewBikeCarUserInputInfoEntryByAnother.Rows.Count > 0)
                {
                    ...
                    Int32 intinsertbyenrol = Convert.ToInt32(hdnApplicantEnrol.Value);
                    ...
                    //{
                        doc.Load(filePathForXML);
                        XmlNode dSftTm = doc.SelectSingleNode("RemotetadaBikeCarUserEntryByAnother");
                        string xmlString = dSftTm.InnerXml;
                        xmlString = "<RemotetadaBikeCarUserEntryByAnother>" + xmlString + "</RemotetadaBikeCarUserEntryByAnother>";
                        string message = bll.tadaInsertByAnotherUserForBikeAndCarUser(xmlString, dteFromDate, enroll, BikeCarUserTypeid, unit, jobstation, intinsertbyenrol);
        ...
        private void LoadFieldValue(int enrol)
        {
            try
            {
                ...
                if (objDT.Rows.Count >= 0)
                {
                    ...
                    hdnApplicantEnrol.Value = enrol.ToString();
