<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RmtAttchForNoEmialEmployee.aspx.cs" Inherits="UI.SAD.Order.RmtAttchForNoEmialEmployee" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <table border="0px"; style="width:Auto"; align="center" >
        ...
        <td><asp:TextBox ID="txtFromDate" runat="server" CssClass="txtBox" Enabled="true" Width="100" autocomplete="off"></asp:TextBox>
        ...
        <td><asp:TextBox ID="txtToDate" runat="server" CssClass="txtBox" Enabled="true" Width="100" autocomplete="off"></asp:TextBox>
        ...
        <tr class="tblrowodd">
            ...
            <td colspan="3"> <asp:TextBox ID="txtFullName" Width="300px" CssClass="txtBox" runat="server"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drdlAttachType" CssClass="ddList" runat="server" DataSourceID="odsRmtAttahmentType" DataTextField="strBillAttachmentType" DataValueField="ID"></asp:DropDownList> 
        ...
        <tr>
            ...
            <td><asp:FileUpload ID="DUpload" runat="server" CssClass="txtBox"/><asp:HiddenField ID="HiddenUnit" runat="server"/>
                <asp:HiddenField ID="hdnsearch" runat="server"/><asp:HiddenField ID="hdnAreamanagerEnrol" runat="server" />
              <asp:HiddenField ID="HiddenField1" runat="server" /> <asp:HiddenField ID="hdnJobstation" runat="server" /> <asp:HiddenField ID="ApproverEnrol" runat="server" />    </td>
