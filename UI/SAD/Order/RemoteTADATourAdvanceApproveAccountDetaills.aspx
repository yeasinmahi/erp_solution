<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoteTADATourAdvanceApproveAccountDetaills.aspx.cs" Inherits="UI.SAD.Order.RemoteTADATourAdvanceApproveAccountDetaills" %>
          ...
          <tr class="tblroweven">
              <td colspan="1">
                  <asp:Button ID="btnApprove" runat="server" Text="Approve" class="button" OnClick="btnApprove_Click" />
                    <asp:Button ID="btnReject" runat="server" Text="Reject" ForeColor="#ff0000" Font-Bold="true" class="button" OnClick="btnReject_Click" />
              </td>
         </tr>          
                   <tr class="tblrowodd">
                <td>
                    ...
                    <asp:GridView ID="grdvAccountIDBasisPendingTADAShow" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="3000" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="grdvAccountIDBasisPendingTADAShow_PageIndexChanging" OnRowDataBound="grdvAccountIDBasisPendingTADAShow_RowDataBound">
                     ...
                     <Columns>
                         ...
                         <asp:TemplateField HeaderText="Enrol" SortExpression="intEnrolDet">
                          ...
                          <asp:BoundField DataField="decAdvAmountDet" HeaderText="Applicant Required" SortExpression="decAdvAmountDet" ControlStyle-Width="10%" >
                           <ControlStyle Width="10%" />
                                                </asp:BoundField>

                         <asp:BoundField DataField="decApproveAmountDet" HeaderText="Supervisor Aprv" SortExpression="decApproveAmountDet" ControlStyle-Width="10%" >
                           <ControlStyle Width="10%" />
                                                </asp:BoundField>

                          <asp:TemplateField HeaderText="Approve Tk." SortExpression="decAprvByACCOUNT">
                            <ItemTemplate>
                            <asp:HiddenField  ID="hddecAprvByACCOUNT" runat="server"  Value='<%# Bind("decAprvByACCOUNT", "{0:0.0}") %>'></asp:HiddenField>
                            <asp:TextBox ID="txtdecAprvByACCOUNT" CssClass="txtBox" runat="server" Width="60" TextMode="Number" Text='<%# Bind("decAprvByACCOUNT") %>' AutoPostBack="false"></asp:TextBox></ItemTemplate>
