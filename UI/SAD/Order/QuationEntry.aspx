                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 410px; float: right;">
                   ...
                   <%-- <asp:HiddenField ID="hdnCrFixed" Value="" runat="server" />
                    ...
                    <table style="width: 850px; background-color: #D0D0D0;">
                        <tr>
                            <td style="vertical-align: top;">
                                ...
                                <b style="color: Navy;"><asp:Label ID="privevariable" runat="server" Text=" Price Variable" Visible="false"></asp:Label></b>
                            ...
                            <td style="vertical-align: top;">
                                ...
                                <b style="color: Navy;"><asp:Label ID="lblLocationvariable" runat="server" Text=" Location Variable" Visible="false"></asp:Label></b>
                    ...
                    <table style="width: 850px; background-color: #F0F0F0;">
                        <tr>
                            <td style="width: 80px;">
                                <b style="color: Green;"><asp:Label ID="lbllogvariable" runat="server" Visible="false"></asp:Label></b>
                            </td>
                            ...
                            <td align="right"  style="color: Blue;">
                                <b><asp:Label ID="lblIncentive" runat="server" Visible="false"></asp:Label></b>
                            </td>
                            <td>
                             ...
                             <td align="right" style="color:Maroon;">
                                <b><asp:Label ID="lblExtrachar" runat="server" Visible="false"></asp:Label></b>
                            </td>
                            <td>
