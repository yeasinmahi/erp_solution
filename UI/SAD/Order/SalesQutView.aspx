<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1" Inherits="UI.SAD.Order.SalesQutView" Codebehind="SalesQutView.aspx.cs" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" SkinID="sknGrid1" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Qnt." SortExpression="numPieces">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Apr. Qnt." SortExpression="numApprPieces">
                        <ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetSalesOrder"
                TypeName="SAD_BLL.Sales.SalesOrderView" 
                OldValuesParameterFormatString="original_{0}">
                <SelectParameters>
