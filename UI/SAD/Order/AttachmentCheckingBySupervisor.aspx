<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachmentCheckingBySupervisor.aspx.cs" Inherits="UI.SAD.Order.AttachmentCheckingBySupervisor"%>
...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <tr class="tblheader"><td colspan="4"> Attachement List :<asp:HiddenField ID="hdnSeprationID" runat="server" /></td></tr>
            ...
            <tr><td colspan="4">
            <asp:GridView ID="grdvAttachmentCheckBySupervisor" runat="server" AutoGenerateColumns="False" Font-Size="10px" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="strPathurl" HeaderText="FILE  Name" SortExpression="strName" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate><asp:Button ID="btnDocDownload" UseSubmitBehavior="false" class="button" runat="server" Font-Size="9px" OnClick="btnDocDownload_Click"
