...
{
    public partial class ItemSearch : BasePage
    {
        ...
        private void GetItemInfo(string parentID, int subLevel)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                Label lbl = new Label();
                lbl.Text = item.GetLabel(subLevel.ToString(), level.ToString(), ddlUnit.SelectedValue) + " ";
                tdLbl.Controls.Add(lbl);
                td.Controls.Add(ddl);
                //td.Controls.Add(BuildAnchor(" AD", "ShowDivWithoutLabel(" + level + "," + subLevel + ");"));
                ...
                if (subLevel == 1)
                {
                    ...
                    if (level == 1)
                    {
                        //td.Controls.Add(BuildAnchor(" SB", "ShowDiv(" + (level + 1) + "," + (maxLevel + 1) + ");"));
                    }
                }

                //td.Controls.Add(BuildAnchor(" LB", "ShowDivWithoutText(" + level + "," + subLevel + ");"));
                tr.Cells.Add(td);
