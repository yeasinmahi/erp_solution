<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmItemPromotionSetupOtherUnit.aspx.cs" Inherits="UI.SAD.Item.frmItemPromotionSetupOtherUnit" %>
    ...
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnEnroll" runat="server" /><asp:HiddenField ID="hdnUnit" runat="server" />
       <div class="tabs_container">Sales Item Promotion Setup <hr /></div>
        ...
        <tr class="tblrowodd">           
            ...
            <td colspan="2" style='text-align: left;'>  <asp:DropDownList ID="ddloffice" runat="server" CssClass="ddllist"> </asp:DropDownList></td>              
        </tr>    
        <tr><td>Sales Product Name </td>
            ...
            <asp:ListItem Value="3">By Office</asp:ListItem>
