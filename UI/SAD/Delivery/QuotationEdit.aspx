<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationEdit.aspx.cs" Inherits="UI.SAD.Delivery.QuotationEdit" %>
             ...
             <tr>
                ...
                <div>
                    <div>
                            ...
                            <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="Specifiation" HeaderStyle-HorizontalAlign="Center" SortExpression="intCustid">
                                    <ItemTemplate>
                                       ...
                                       <asp:HiddenField ID="hdncustid" runat="server" Value='<%# Eval("intCustomerId") %>' />
                                        ...
                                        <asp:HiddenField ID="hdnUnitid" runat="server" Value='<%# Eval("intUnitId") %>' />
                               ...
                               <%-- <asp:TemplateField HeaderText="Rate" HeaderStyle-HorizontalAlign="Center" SortExpression="strProductName">
                                 ...
                                 <asp:TemplateField HeaderText="Rate" HeaderStyle-HorizontalAlign="Center" SortExpression="strProductName">
                                    <ItemTemplate>
                                       <asp:HiddenField ID="hdnnumprice" runat="server" Value='<%# Bind("numprice", "{0:0.0}") %>'></asp:HiddenField>  
                                        <asp:Label ID="lblnumprice" runat="server" Visible="false"  Text='<%# Bind("numprice", "{0:0.0}") %>'></asp:Label>
                                   <asp:TextBox ID="txtrate"  runat="server" onblur="" CssClass="txtBox" Width="75px" Text='<%# Bind("numprice", "{0:0.0}") %>' AutoPostBack="false"></asp:TextBox>
                                        </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Quantity" HeaderStyle-HorizontalAlign="Center"  SortExpression="Quantity">
                                   ...
                                   <asp:Label ID="lbltotalqnt" runat="server" Visible="false" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("numqnt", "{0:0.00}"))) %>'></asp:Label>
                                        ...
                                        <asp:TextBox ID="txtquantity"  runat="server" onblur="" CssClass="txtBox" Width="75px" TextMode="Number" Text='<%# Bind("numqnt", "{0:00}") %>' AutoPostBack="false"></asp:TextBox>
                                     </ItemTemplate>
                        ...
                        <asp:Button ID="btnEdit" runat="server" CssClass="btn btn-primary pull-right"  Text="Edit" OnClick="btnEdit_Click" />
                    </div>
