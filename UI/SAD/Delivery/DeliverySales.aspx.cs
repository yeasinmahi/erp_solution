...
{
    public partial class DeliverySales : System.Web.UI.Page
    {
        ...
        {
            if (rdoVhlCompany.SelectedValue.ToLower() == "1")
            {
                pnlVehicle3rd.Visible = false;
                Session["sesCurVhlCom"] = true;
                
            }
            else if( rdoVhlCompany.SelectedValue.ToLower() == "2")
            {
            ...
            else if (rdoVhlCompany.SelectedValue.ToLower() == "3")
            {
                pnlVehicle3rd.Visible = false;
                Session["sesCurVhlCom"] = false;
