<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverySales.aspx.cs" Inherits="UI.SAD.Delivery.DeliverySales" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlUpperControl" runat="server" Width="100%">
                ...
                <div id="divControl" class="divPopUp2" style="width: 100%; height: 450px; float: right;">
                    ...
                    <table style="width: 850px; height: 60px; background-color: #E0E0E0;">
                        <tr>
                            <td >
                                Unit
                            </td>
...
>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <asp:TextBox ID="txtChallan" runat="server" Width="120px" TextMode="MultiLine" Visible="true"></asp:TextBox>
                            </td>
                        </tr>
                        </table>
                <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" AutoCompleteType="Search" Width="355px" OnTextChanged="txtCus_TextChanged"
                                             AutoPostBack="true"></asp:TextBox>
                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender6" runat="server" TargetControlID="txtCus"
                                                          ServiceMethod="GetCustomerList" MinimumPrefixLength="1" CompletionSetCount="1"
                                                          CompletionInterval="1" FirstRowSelected="true" EnableCaching="false" CompletionListCssClass="autocomplete_completionListElementBig"
                                                          CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                </cc1:AutoCompleteExtender>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ReadOnly="true" ID="txtShipToAddress" runat="server" TextMode="MultiLine"
                                           Width="350px"></asp:TextBox>
                          </td>
                      </tr>
                      </table>
                ...
                <table style="width: 530px; vertical-align: top;">
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rdoNeedVehicle" runat="server" Width="120px" AutoPostBack="True" OnSelectedIndexChanged="rdoNeedVehicle_SelectedIndexChanged"
                    ...
                    <table style="width: 850px; background-color: #D0D0D0;">
                        <tr>
                            <td style="padding-top: 10px; vertical-align: top; width: 10px; height: 180px;">
                                ...
                                <asp:Panel ID="pnlVehicleMain" runat="server">
                                    <table style="width: 300px;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left">
                                                <asp:TextBox ID="txtDriver" runat="server" Width="200px" Visible="true"></asp:TextBox>
                                            </td>
