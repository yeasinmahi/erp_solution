<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDOTest.aspx.cs" Inherits="UI.SAD.Delivery.ViewDOTest" %>
        ...
        <table width="100%" style="background-color:#C0C0C0">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:ListItem Value="true"> Partial </asp:ListItem>
                    <asp:ListItem Selected="True" Value="false"> Full</asp:ListItem>
                    <asp:ListItem Selected="True" Value="false"> None</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>                
        </table>
