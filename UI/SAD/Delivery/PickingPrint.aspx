<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickingPrint.aspx.cs" Inherits="UI.SAD.Delivery.PickingPrint" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        function DO_Edit(intDOID, intCusID, strReportType, ShipPointID, PopupType) {
            window.open('DeliveryEntry.aspx?intDOID=' + intDOID + '&intCusID=' + intCusID + '&strReportType=' + strReportType + '&ShipPointID=' + ShipPointID + '&PopupType=' + PopupType, 'sub', "height=570, width=720, scrollbars=yes, left=50, top=45, resizable=no, title=Preview");
        }
</script>
