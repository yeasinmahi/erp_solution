...
<body>
    ...
    <asp:BoundField DataField="strCode" HeaderText="Order Number" SortExpression="strCode" ItemStyle-HorizontalAlign="Center" >
    <ItemStyle HorizontalAlign="Center" /></asp:BoundField>
                        
    <asp:BoundField DataField="dteDate" HeaderText="Order Date" SortExpression="dteDate" ItemStyle-HorizontalAlign="left" DataFormatString="{0:dd/MM/yyyy}" >
    <ItemStyle HorizontalAlign="left" /></asp:BoundField>
        
    <asp:BoundField DataField="intCusID" HeaderText="CustID" SortExpression="intCusID" HeaderStyle-CssClass="header-ta" ItemStyle-HorizontalAlign="Center" Visible="false" >
    <ItemStyle HorizontalAlign="Center" /></asp:BoundField>
    ...
    <asp:Button ID="btnDOEdit" runat="server" Text="Edit" class="nextclick" BackColor="Gray" ForeColor="Black" Font-Bold="true" CommandName="DO_Edit" OnClick="DO_Edit_Click"  CommandArgument='<%# Eval("intCusID")+","+Eval("intid")%>' /></ItemTemplate>
    </asp:TemplateField> 

    <asp:TemplateField HeaderText=""><ItemTemplate>                                                                                                          
    <asp:Button ID="btnApprove" runat="server" Text="Approve" class="nextclick" BackColor="Gray" ForeColor="Black" Font-Bold="true" CommandName="DO_Approve" OnClientClick="ConfirmAll()" OnClick="Complete_Click"  CommandArgument='<%# Eval("intCusID")+","+Eval("intid")%>' /></ItemTemplate>
    </asp:TemplateField> 

    <asp:TemplateField HeaderText=""><ItemTemplate>                                                                                                          
    <asp:Button ID="btnCancel" runat="server" Text="Cancel" class="nextclick" BackColor="Gray" ForeColor="Black" Font-Bold="true" CommandName="DO_Cancel" OnClientClick="ConfirmAll()" OnClick="DO_Cancel_Click"  CommandArgument='<%# Eval("intCusID")+","+Eval("intid")%>' /></ItemTemplate>
    </asp:TemplateField> 

    <asp:TemplateField HeaderText=""><ItemTemplate>                                                                                                          
    <asp:Button ID="btnClose" runat="server" Text="Close" class="nextclick" BackColor="Gray" ForeColor="Black" Font-Bold="true" CommandName="DO_Close" OnClientClick="ConfirmAll()" OnClick="DO_Close_Click"  CommandArgument='<%# Eval("intCusID")+","+Eval("intid")%>' /></ItemTemplate>
    </asp:TemplateField> 
