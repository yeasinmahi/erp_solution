<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpBillByDamage.aspx.cs" Inherits="UI.SAD.Corporate_sales.CorpBillByDamage" %>
...
<tr class="tblrowodd"><td style="text-align:right;"><asp:Label ID="lblitm" CssClass="lbl" runat="server" Text="Customer Name : "></asp:Label></td>
    ...
    <tr class='tblroweven'><td style="text-align:right;">Challan No:</td>
    <td>
        <asp:TextBox ID="txtChallanno" CssClass=""  runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr class='tblroweven'><td style="text-align:right;">Po_No:</td>
    <td> <asp:TextBox ID="txtPONo" CssClass=""  runat="server"></asp:TextBox></td>
    </tr>
     <tr class='tblroweven'><td style="text-align:right;">GRN No:</td>
    <td> <asp:TextBox ID="txtGRNno" CssClass=""  runat="server"></asp:TextBox></td>
    </tr>
