...
namespace UI.SAD.Corporate_sales
{
    public partial class CorpPendingView : System.Web.UI.Page
    {
        ...
        //private void driverResult()
        //{
        //    DataTable dtMobilenos = new DataTable();
        ...
        //        int   enroll = int.Parse(technichin.ToString());
        //        dtMobilenos = Report.getEmpMobile(enroll);
        //        string Mobilenos = Convert.ToString(dtMobilenos.Rows[0]["strContactNo1"].ToString());

        //        Session["Mobileno"] = Mobilenos;
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                dtProductPending = CorpReport.getPendingProductWiseReportCorp(Custid,shippointid);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (hdnsession.Value == "")
            {
                ...
                Int32 technichins = Int32.Parse(hdnvehicle.Value.ToString());
                Vehicleidss = Convert.ToInt32(technichins.ToString());
