<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpPendingView.aspx.cs" Inherits="UI.SAD.Corporate_sales.CorpPendingView" %>
...
<%--=========================================Start My Code From Here===============================================--%>
        ...
        <ItemTemplate>
         <asp:HiddenField  ID="hdnFreeQty" runat="server" Value='<%# Bind("FreeQty","{0:n0}") %>'></asp:HiddenField>
        ...
        <ItemStyle HorizontalAlign="Left" Width="75px" />
             ...
             <asp:HiddenField ID="FreeQtys" runat="server" Value='<%# Eval("FreeQty") %>' /><asp:HiddenField ID="HiddenField21" runat="server" Value='<%# Eval("FreeQty") %>' />
             <asp:Label ID="lblFreeQty" runat="server" Text='<%# Bind("FreeQty","{0:n0}") %>'></asp:Label></ItemTemplate>
             <ItemStyle HorizontalAlign="Left" Width="80px"/></asp:TemplateField> 
             ...
             <asp:Label ID="lblTotalQty" runat="server" Text='<%# Bind("TotalQty","{0:n0}") %>'></asp:Label></ItemTemplate>
             <ItemStyle HorizontalAlign="Left" Width="80px"/></asp:TemplateField> 
