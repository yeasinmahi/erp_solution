<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedDetailsFinal.aspx.cs" Inherits="UI.SAD.Corporate_sales.ApprovedDetailsFinal" %>
...
<body>
    ...
    <asp:GridView ID="dgvOrder" runat="server" AutoGenerateColumns="False" Font-Size="12px" BackColor="White" 
        ...
        <asp:HiddenField ID="intOrderNo" runat="server" Value='<%# Eval("intOrderNo") %>' /><asp:HiddenField ID="iname" runat="server" Value='<%# Eval("intOrderNo") %>' />
        ...
        <asp:HiddenField ID="itemname" runat="server" Value='<%# Eval("strName") %>' /><asp:HiddenField ID="iname" runat="server" Value='<%# Eval("strName") %>' />
        ...
        <asp:HiddenField ID="intCusID" runat="server" Value='<%# Eval("intCusID") %>' /><asp:HiddenField ID="iname" runat="server" Value='<%# Eval("intCusID") %>' />
        <asp:Label ID="lblintCusID" runat="server" Text='<%# Bind("intCusID") %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="100px"/></asp:TemplateField>                                           
        ...
        <asp:HiddenField ID="intShipPointId" runat="server" Value='<%# Eval("intShipPointId") %>' /><asp:HiddenField ID="intShipPointId1" runat="server" Value='<%# Eval("intShipPointId") %>' />
        <asp:Label ID="lblintShipPointId" runat="server" Text='<%# Bind("intShipPointId") %>'></asp:Label></ItemTemplate>
        <ItemStyle HorizontalAlign="Left" Width="100px"/></asp:TemplateField> 
