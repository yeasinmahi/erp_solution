<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfblPointSetup.aspx.cs" Inherits="UI.SAD.Setup.AfblPointSetup" %>
...
<head runat="server">
    <title>AFBL Distributor Point Setup</title>
...
<body>
    <form id="frmPointSetup" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="divbody" style="padding-right: 10px;">
                    <div class="tabs_container" style="background-color: #dcdbdb; padding-top: 10px; padding-left: 5px; padding-right: -50px; border-radius: 5px;">
                        AFBL Distributor Point Setup<hr />
                    </div>
                    <table style="width: auto; float: left;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Territory Name"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Exist Dis. Point Name"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlExPointName" CssClass="ddList" Font-Bold="False" runat="server" Width="220px" Height="23px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlExPointName_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td style="text-align: right; width: 15px;">
                                <asp:Label ID="Label6" runat="server" Text=""></asp:Label></td>
                            <td style="text-align: right;">
                                <asp:Label ID="Label7" runat="server" CssClass="lbl" Text="Exist Customer"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtExistCust" runat="server" ReadOnly="true" CssClass="txtBox1"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <hr />
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="lblLineName" runat="server" CssClass="lbl" Text="New Dis. Point Name"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtDisPointName" runat="server" CssClass="txtBox1"></asp:TextBox></td>
                            <td style="text-align: right; width: 15px;">
                                <asp:Label ID="Label3" runat="server" Text=""></asp:Label></td>
                            <td style="text-align: right;">
                                <asp:Label ID="lblCust" runat="server" CssClass="lbl" Text="Customer"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlCust" CssClass="ddList" Font-Bold="False" runat="server" Width="220px" Height="23px"
                                    AutoPostBack="True">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="lblComputer" runat="server" CssClass="lbl" Text="Computer"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlComputer" CssClass="ddList" runat="server" AutoPostBack="True" Width="220px" Height="23px">
