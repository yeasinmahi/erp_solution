<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfblLineSetup.aspx.cs" Inherits="UI.SAD.Setup.AfblLineSetup" %>
...
<body>
    <form id="frmLineSetup" runat="server">
                ...
                <div class="divbody" style="padding-right: 10px;">
                    ...
                    <table style="width: auto; float: left;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="lblLineName" runat="server" CssClass="lbl" Text="New Line Name"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtLineName" runat="server" CssClass="txtBox1"></asp:TextBox></td>
                            <td style="text-align: right; width: 15px;">
