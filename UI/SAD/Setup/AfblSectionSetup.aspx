<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfblSectionSetup.aspx.cs" Inherits="UI.SAD.Setup.AfblSectionSetup" %>
            ...
            <ContentTemplate>
                ...
                <div class="divbody" style="padding-right: 10px;">
                    <div class="tabs_container" style="background-color: #dcdbdb; padding-top: 10px; padding-left: 5px; padding-right: -50px; border-radius: 5px;">
                        AFBL Distributor Section Setup<hr />
                    </div>
                    <table style="width: auto; float: left;">
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Dis. Point Name"></asp:Label></td>
                            <td>
                            ...
                            <td style="text-align: right; width: 15px;">
                                <asp:Label ID="Label9" runat="server" CssClass="lbl" Text="Exist Section Name"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlExSectionName" CssClass="ddList" Font-Bold="False" runat="server" Width="220px" Height="23px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlExSectionName_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="Label7" runat="server" CssClass="lbl" Text="Exist Code"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtExistCode" runat="server" ReadOnly="true" CssClass="txtBox1"></asp:TextBox></td>
                            <td style="text-align: right; width: 15px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="lblLineName" runat="server" CssClass="lbl" Text="New Section Name"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtSectionName" runat="server" CssClass="txtBox1"></asp:TextBox></td>
                            <td style="text-align: right; width: 15px;">
                                <asp:Label ID="Label3" runat="server" Text=""></asp:Label></td>
                            <td style="text-align: right;">
                                <asp:Label ID="lblCode" runat="server" CssClass="lbl" Text="New Code"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtCode" runat="server" CssClass="txtBox1"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">
