<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadingSlip.aspx.cs" Inherits="UI.SAD.AutoChallan.LoadingSlip" %>
         ...
         <table>
            ...
            <tr>
                ...
                <tr><td style="text-align:left" class="auto-style7">
                    ...
                    <td class="auto-style7">
                    <label id="Label8" runat="server" >Batch No :</label>
                    </td>
                    ...
                    <Columns>
                       ...
                       <asp:HiddenField  ID="freeintCOAID" runat="server" Value='<%# Bind("freeintCOAID", "{0:0}") %>'></asp:HiddenField>
                        ...
                        <ItemTemplate>
                         <asp:HiddenField  ID="hdnFreeQty" runat="server" Value='<%# Bind("qty","{0:n2}") %>'></asp:HiddenField>
                        <asp:TextBox ID="lblnumqty" CssClass="txtBox" runat="server" Width="75px"  Text='<%# Bind("qty","{0:n2}") %>' AutoPostBack="true"    ></asp:TextBox></ItemTemplate>
