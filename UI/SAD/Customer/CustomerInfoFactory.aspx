<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerInfoFactory.aspx.cs" Inherits="UI.SAD.Customer.CustomerInfoFactory" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" SkinID="sknGrid1" Caption="Customer List" runat="server"
                            AutoGenerateColumns="False" DataKeyNames="intCusID" DataSourceID="ObjectDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Font-Size="Small" ForeColor="Black" GridLines="Vertical">
