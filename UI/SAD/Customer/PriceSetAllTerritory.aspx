<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceSetAllTerritory.aspx.cs" Inherits="UI.SAD.Customer.PriceSetAllTerritory" %>
...
<head id="Head1" runat="server">
    ...
    <script>
      ...
      function Confirm() {
          ...
          var txtDteFrom = document.forms["form1"]["txtFrom"].value;
          var txtDteTo = document.forms["form1"]["txtTo"].value;
        ...
        <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="padding-top: 15px;">
                                ...
                                <asp:HiddenField ID="hdnId" runat="server" /><asp:HiddenField ID="hdnconfirm" runat="server" />
            ...
            <table width="650px;">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:Button ID="btnPrice" runat="server" OnClick="btnPrice_Click" OnClientClick="Confirm()" Text="Request Price Change" />
                    </td>
                </tr>
                <tr>
