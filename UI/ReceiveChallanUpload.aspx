<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveChallanUpload.aspx.cs" Inherits="UI.SAD.Order.ReceiveChallanUpload" %>
...
<head runat="server">
   ...
   <link href="../../../../Content/CSS/GridHEADER.css" rel="stylesheet" />
    ...
    <script>
        ...
        window.open('ReceiveChallanUploadDetaills.aspx?ID=' + url, '', "height=600, width=800, scrollbars=yes, left=50, top=100, resizable=yes, title=Preview");
    }
