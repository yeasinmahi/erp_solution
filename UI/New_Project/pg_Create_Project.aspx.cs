...
{
    public partial class pg_Create_Project : System.Web.UI.Page
    {
        DataTable dtglobal;
        string[] arrayKeyItem; char[] delimiterChars = { '[', ']' };
        int part,intunitid,intCCID,intEmpId,intPCode;
        string xmlpath, xmlpath1, xmlpathfund, xmlpathemp, strUname,strCCName,strlocation,strAddress, xmlString, xmlString1, xmlStringfund, xmlStringemp, emplName,msg,remarks,
