...
{
    public partial class AnnualPlan : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            filePathForXML = Server.MapPath("~/Projects/Data/AnnualActivity_" + hdnEnroll.Value + ".xml");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (hdnconfirm.Value == "1")
            {
                ...
                dtePlan = DateTime.Parse(txtDate.Text);
                intActionBy = int.Parse(hdnEnroll.Value);
                dtePlanF = DateTime.Parse(txtDate.Text);
                dtePlanT = DateTime.Parse(txtDate.Text);
                numAdvAmount = 0;
