<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecutionApproveBySupervisor.aspx.cs" Inherits="UI.Projects.Local.ExecutionApproveBySupervisor" %>
...
<head runat="server">
    ...
    width:500%; height: 50%; margin-left:50px; margin-top: 00px; margin-right:00px; padding: 15px; overflow-y:scroll;}    
    </style>

    <script type="text/javascript">
        $("[id*=txtRAmount]").live("keyup", function () {
            var row = $(this).closest("tr"); var gt = 0; var qty = 0;
            $("[id*=txtRAmount]").each(function () { if ($(this).val() != '') { qty = $(this).val(); } else { qty = 0; }; gt = parseFloat(gt) + parseFloat(qty); });
            $("[id*=lblRAmount]").html(parseFloat(gt).toFixed(2));
        });
...
<body>
    <form id="frmExecutionPlanApproveBySupervisor" runat="server">        
    ...
    <tr class="tblheader"><td colspan="4" style="color:black; text-align:left; font-size:14px"> EXECUTION PLAN APPROVE FORM (By Supervisor) </td></tr>
    ...
    <asp:TemplateField HeaderText="From Date" SortExpression="dteStart"><ItemTemplate>
    <asp:Label ID="lblDateF" runat="server" Text='<%# Eval("dteStart", "{0:dd-MM-yyyy}") %>'></asp:Label></ItemTemplate>
    <ItemStyle HorizontalAlign="center" Width="80px"/></asp:TemplateField>

    <asp:TemplateField HeaderText="To Date" SortExpression="dteEnd"><ItemTemplate>
    <asp:Label ID="lblDateT" runat="server" Text='<%# Eval("dteEnd", "{0:dd-MM-yyyy}") %>'></asp:Label></ItemTemplate>
    <ItemStyle HorizontalAlign="center" Width="80px"/></asp:TemplateField>     
    ...
    <tr class="tblheader"><td colspan="3"> EXECUTION PLAN APPROVE (By Supervisor) </td></tr>
    <tr>
        <td colspan="3">
            <asp:Label ID="Label4" runat="server" CssClass="lbl" Width="50px" Height="1px" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="3" style="text-align:left;"><asp:Label ID="lblDateF" runat="server" CssClass="lbl" Text="From Date:"></asp:Label>
        <asp:TextBox ID="txtDateF" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true" Width="80px"></asp:TextBox>
        <cc1:CalendarExtender ID="dt" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateF"></cc1:CalendarExtender>                                

        <asp:Label ID="Label3" runat="server" CssClass="lbl" Width="50px" Text=""></asp:Label>

        <asp:Label ID="lblDateT" runat="server" CssClass="lbl" Text="To Date:"></asp:Label>
        <asp:TextBox ID="txtDateT" runat="server" AutoPostBack="false" CssClass="txtBox" Enabled="true" Width="80px"></asp:TextBox>
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateT"></cc1:CalendarExtender></td>                                
    </tr>
    <tr><td colspan="3">
    ...
    <asp:TemplateField HeaderText="Request Amount" SortExpression="RequestAmount"><ItemTemplate>
    <asp:TextBox ID="txtRAmount" CssClass="txtBoxdgv" Width="100px" runat="server" onkeypress="return onlyNumbers();" TextMode="Number" Text='<%# Bind("RequestAmount") %>'></asp:TextBox></ItemTemplate>
    <ItemStyle HorizontalAlign="right"/><FooterTemplate><asp:Label ID="lblRAmount" runat="server" Width="100px" Text='<%# totalamo %>' /></FooterTemplate></asp:TemplateField>
    ...
    <tr>
        ...
        <asp:TextBox ID="txtAdvance" runat="server" CssClass="txtBox" Width="100px"></asp:TextBox>
        </td>
    </tr>
    <tr><td colspan="3"><hr /></td></tr>
    <tr>
