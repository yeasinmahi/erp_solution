...
<head runat="server">
    ...
    <%--hidden visible--%>
    <style> .HyperLinkButtonStyle { float:left; text-align:left; border: none; background: none; 
    ...
    width:5%; height: 5%; margin-left:auto; margin-right:auto; padding: 15px; overflow-y:scroll; }
    </style>
    ...
    <script>
       function OpenhdnDivision() {
        ...
        { window.open('DocView.aspx?EN=' + enroll + '&TP=' + vwtype, 'sub', "height=550, width=850, scrollbars=yes, left=300, top=250, resizable=yes, title=Preview");}
        function ViewPolicy(id, filepath)
        { window.open('DocPView.aspx?ID=' + id + '&FP=' + filepath, 'sub', "height=550, width=850, scrollbars=yes, left=300, top=250, resizable=yes, title=Preview"); }
...
<body >
    ...
    <div class="divs_content_container" style="background:none; border:0px solid red;"><table border="0" style="width:Auto;";>
    <tr><td><asp:Panel ID="pnlpersonalinformation" runat="server"><%# strinformation %></asp:Panel></td></tr>

    <tr><td><br /><asp:Label ID="lblmsg" runat="server" Text="Policy Document:"></asp:Label><br />
    ...
    <asp:TemplateField HeaderText="Document"><ItemTemplate>
    ...
    <tr><td><br /><asp:Label ID="lblper" runat="server" Text="Personal Document :"></asp:Label><br />
    ...
    <tr><td><a class="nextclick" onclick="OpenhdnDivision()">Upload</a></td></tr>
    </table></div>
    ...
    <tr class="tblrowodd">
    <td style="text-align:right;"><asp:Label ID="lblitem" runat="server" Text="Type List : "></asp:Label></td>
    <td style="text-align:left;"><asp:DropDownList ID="ddlist" runat="server" CssClass="dropdownList" DataSourceID="odsdoctplst" DataTextField="DocumentType" DataValueField="Enroll"></asp:DropDownList>
    <asp:ObjectDataSource ID="odsdoctplst" runat="server" SelectMethod="GetDocumentList" TypeName="HR_BLL.Global.ApplicationType"></asp:ObjectDataSource></td>
    <td style="text-align:right;"><asp:Label ID="lbldoc" CssClass="lbl" runat="server" Text="Document : "></asp:Label></td>
    <td><asp:FileUpload ID="docUpload" runat="server" CssClass="txtBox"/><asp:HiddenField ID="hdnField" runat="server" /></td></tr>
    <tr><td colspan="4"><a class="nextclick" onclick="ClosehdnDivision(1)">Cancel</a><a class="nextclick" onclick="Save()">Save</a></td></tr>
    </table>
    </div>
