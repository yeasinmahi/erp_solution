...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnConfirm" runat="server" />
       <div class="tabs_container" align="left" >WH Location Transfer </div>
                ...
                <td style="text-align:left;"><asp:DropDownList ID="ddlWH" CssClass="ddList" Font-Bold="False" runat="server" OnSelectedIndexChanged="ddlWH_SelectedIndexChanged" AutoPostBack="True"     ></asp:DropDownList></td>                                                                                      
             
                <td><asp:RadioButton ID="radItem" runat="server" GroupName="Location"  AutoPostBack="true" Text="Item"     OnCheckedChanged="radItem_CheckedChanged"/></td>
                <td><asp:RadioButton ID="radLocation" runat="server" GroupName="Location" AutoPostBack="true" Text="Location"     OnCheckedChanged="radLocation_CheckedChanged" /></td>
                </td>   
                </tr>
                <tr>
                ...
                <table>
                <tr> 
                <td><asp:GridView ID="dgvWHLocation" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true"     
                ...
                <ItemTemplate><asp:Label ID="lblItemName" Width="200px" runat="server" Text='<%# Bind("strItem") %>'></asp:Label> </ItemTemplate>
                </asp:TemplateField> 
