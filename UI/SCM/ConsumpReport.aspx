        ...
        <asp:UpdatePanel ID="UpdatePanel0" runat="server">
            <ContentTemplate>
                ...
                <div class="leaveApplication_container">
                    ...
                    <div class="tabs_container" style="text-align: left; background-color: white">
                        <hr />
                    </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                ...
                                <asp:Button ID="btnFilterDept" runat="server" Text="Show" OnClick="btnFilterDept_Click" />
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                ...
                                <asp:Button ID="btnShowCostCenter" runat="server" Text="Show" OnClick="btnShowCostCenter_OnClick" />
                            </td>
                        </tr>
                        <tr>
