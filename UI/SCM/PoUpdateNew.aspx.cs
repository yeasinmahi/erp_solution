...
namespace UI.SCM
{
    public partial class PoGenerateNew : BasePage
    {
        ...
        string ysnApprove, intSingleApproveBy;


        decimal totalqnty = 0,totalValue=0,totalAit=0,totalVat=0;
        char[] delimeters = { '[', ']' };
        string[] arraykey;

        string payDate, paymentTrems, destDelivery, paymentSchedule;
        DateTime dtePo, dtelastShipment;
        decimal others = 0, tansport = 0, grosDiscount = 0, commision, ait;
