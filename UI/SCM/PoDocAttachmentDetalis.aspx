    ...
    <form id="frmaccountsrealize" runat="server">
        ...
        <div class="leaveApplication_container">
            ...
            <table style="width: 700px">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <asp:Label ID="lblUnit" CssClass="lbl" Font-Bold="true" runat="server"></asp:Label></td>

                    <td style="text-align: right;">
                        <asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Bill Amount:"></asp:Label></td>
                    <td style="text-align: left;">
                        <asp:Label ID="lblBillAmount" CssClass="lbl" Font-Bold="true" runat="server"></asp:Label></td>
                    <td style="text-align: right;">
                        <asp:Label ID="Label5" runat="server" CssClass="lbl" Text="PO ID"></asp:Label></td>
                    <td style="text-align: left;">
                        <asp:Label ID="lblPoId" CssClass="lbl" Font-Bold="true" runat="server"></asp:Label></td>

                    <td style="text-align: right;">
                        <asp:Label ID="Label7" runat="server" CssClass="lbl" Text="Bill ID:"></asp:Label></td>
                    <td style="text-align: left;">
                        <asp:Label ID="lblBillId" CssClass="lbl" Font-Bold="true" runat="server"></asp:Label></td>
                    <td style="text-align: right;">
            ...
            <table style="width: 600px">
                <tr>
                    <td style="text-align: right;">
                        <asp:Label ID="lblFrom" runat="server" CssClass="lbl" Text="File Group:"></asp:Label></td>
                    <td style="text-align: left">
                        <asp:DropDownList ID="ddlFileGroup" runat="server" CssClass="ddList">
                        </asp:DropDownList></td>
                    <td style="text-align: right;">
                        <asp:Label ID="lblTo" runat="server" CssClass="lbl" Text="Note :"></asp:Label></td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtNote" runat="server" CssClass="txtBox" Width="300px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="text-align: right;">
                        <asp:Label ID="Label11" runat="server" CssClass="lbl" Text="Attachment :"></asp:Label></td>
            ...
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="dgvDocument" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true" Width="600px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DocID" SortExpression="intFileID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDocId" runat="server" Width="60px" Text='<%# Bind("intFileID") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Detalis">
                                    <ItemTemplate>
                                        <asp:Button ID="btnDocView" runat="server" Text="View" OnClick="btnDocView_Click" CommandArgument='<%# Eval("strFtpPath") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Detalis">
                                    <ItemTemplate>
                                        <asp:Button ID="btnDownload" runat="server" Text="Download" OnClick="btnDownload_Click" CommandArgument='<%# Eval("strFtpPath") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="left" />
                                </asp:TemplateField>
                            </Columns>
