...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnConfirm" runat="server" /><asp:HiddenField ID="hdnUnit" runat="server" /> 
       ...
       <div class="tabs_container">Receive without PO  From<hr/></div> 
       ...
       <table>
            ...
            <td style="text-align:left;"  ><asp:TextBox ID="txtItem" runat="server" AutoCompleteType="Search" CssClass="txtBox" AutoPostBack="true" Width="300px" OnTextChanged="txtItem_TextChanged"   ></asp:TextBox>
           ...
           <tr>
                <td style="text-align:left;"><asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Location"></asp:Label></td>
            <td style="text-align:left;"><asp:DropDownList ID="ddlLocation" CssClass="ddList" Font-Bold="False" AutoPostBack="true" runat="server"   ></asp:DropDownList></td>                                                                                      
          <td style="text-align:right;" ><asp:Label ID="lblPurpose" runat="server" CssClass="lbl" Text="Remarks"></asp:Label></td>            
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtQty" CssClass="txtBox" Font-Bold="False" Text="0" runat="server"></asp:TextBox></td> 
                 <td style="text-align:right;"><asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Rate"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtRate" CssClass="txtBox" Font-Bold="False" TextMode="Number" Text="0" runat="server"></asp:TextBox> 
           ...
           <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="funConfirmAll();" OnClick="btnSubmit_Click"    /></td>  
            ...
            <ItemTemplate><asp:Label ID="lblValue" runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("rate") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Right" /> </asp:TemplateField>
              
            <asp:TemplateField HeaderText="Location" ItemStyle-HorizontalAlign="right" SortExpression="Location" >
            <ItemTemplate><asp:Label ID="lblLOcation" runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("Location") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Right" /> </asp:TemplateField>
            
            <asp:TemplateField HeaderText="Location ID" Visible="false" ItemStyle-HorizontalAlign="right" SortExpression="locationid" > 
            <ItemTemplate><asp:Label ID="lblLOcationId" Width="200px"   runat="server"   Text='<%# Bind("locationid") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Right" /> </asp:TemplateField>

            <asp:TemplateField HeaderText="Remarks" ItemStyle-HorizontalAlign="right" SortExpression="remarks" > 
            <ItemTemplate><asp:Label ID="lblRemarks" runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("remarks") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Right" /> </asp:TemplateField>
