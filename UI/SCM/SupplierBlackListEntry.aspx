<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierBlackListEntry.aspx.cs" Inherits="UI.SCM.SupplierBlackListEntry" %>
...
<body>
    <form id="frmcafrdd" runat="server">        
    ...
    <tr><td>
        <div class="divbody" style="padding-right:10px;">
            <div id="divLevel1" class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;"> <asp:Label ID="lblHeading" runat="server" CssClass="lbl" Text="SUPPLIER BLACK LIST ENTRY" Font-Bold="true" Font-Size="16px"></asp:Label><hr /></div>
    ...
    <tr><td>
        <table class="tbldecoration" style="width:auto; float:left;"> 
            ...
            <tr><td>   
                ...
                ForeColor="Black" GridLines="Vertical" OnRowCommand="dgvSuppliser_RowCommand" OnRowDataBound="dgvSuppliser_RowDataBound">
                ...
                <asp:TemplateField HeaderText="Remarks" SortExpression="ApproveInstallment">
                <ItemTemplate><asp:TextBox ID="txtBlockRemarks" runat="server" CssClass="txtBoxCenterTextAlignLeft" Text='' Width="200px" TextMode="MultiLine" Height="30px"></asp:TextBox>
                </ItemTemplate><ItemStyle HorizontalAlign="left" Width="69px"/></asp:TemplateField>

                <asp:TemplateField HeaderText="Reject" ItemStyle-HorizontalAlign="Center" SortExpression="">
                <ItemTemplate><asp:Button ID="btnReject" class="myButtonGrid" OnClientClick = "ConfirmAll()" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="BL"  
                Text="Black List"/></ItemTemplate><ItemStyle HorizontalAlign="center"/></asp:TemplateField>
