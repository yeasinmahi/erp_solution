<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHLocationCreate.aspx.cs" Inherits="UI.SCM.WHLocationCreate" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdn10" runat="server" /><asp:HiddenField ID="hdnOpID" runat="server" /><asp:HiddenField ID="hdnOpName" runat="server" />
        ...
        <div class="tabs_container">WH Location Summary :<hr /></div>
        ...
        <asp:BoundField DataField="Id" HeaderText="Location Id" ItemStyle-HorizontalAlign="Center" SortExpression="Id" >
        <ItemStyle HorizontalAlign="Left" Width="80px" /></asp:BoundField> 
        <asp:BoundField DataField="strName" HeaderText="Location Name" ItemStyle-HorizontalAlign="Center" SortExpression="strName">
