     ...
     <div class="tabs_container" style="text-align:left">Indent View<hr /></div>
       ...
       <table>
           <tr>
            ...
            <td style="text-align:right;"><asp:Label ID="Label3" CssClass="lbl" runat="server" Text="Type: "></asp:Label></td>     
           ...
           <tr>
                <td style="text-align:right;"><asp:Label ID="Label2" CssClass="lbl" runat="server" Text="Sort By: "></asp:Label></td>     
            <td style="text-align:left;"><asp:DropDownList ID="ddlSortBy" CssClass="ddList" Font-Bold="False" AutoPostBack="true" runat="server">
         ...
         <table>
           <tr><td> 
            ...
            <asp:TemplateField HeaderText="IdentId" SortExpression="indent"><ItemTemplate>
            <asp:Label ID="lblIndent" runat="server" Text='<%# Bind("indent") %>'></asp:Label></ItemTemplate>
