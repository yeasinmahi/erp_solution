<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionReport.aspx.cs" Inherits="UI.SCM.BOM.ProductionReport" %>
                            ...
                            <td>
                                ...
                                <asp:GridView ID="dgvBom" runat="server" AutoGenerateColumns="False" Font-Size="10px" Width="850px" BackColor="White" BorderColor="#999999" BorderStyle="Solid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Invoice No" visible="false" ItemStyle-HorizontalAlign="right" SortExpression="strCinvoiceode">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="SR NO"  visible="false" ItemStyle-HorizontalAlign="right" SortExpression="strCode">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Detail" ItemStyle-HorizontalAlign="right" SortExpression="lineprocess">
                                            <ItemTemplate>
                                                <asp:Button ID="btnSaveProduction" forecolor="Blue" runat="server" Width="100px" OnClick="btnSaveProduction_Click" Text="Save Production"></asp:Button>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
