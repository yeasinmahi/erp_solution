...
{
    public partial class frmTransferOrder : System.Web.UI.Page
    {
       
        int intShipid,intOffId,intUomid, vid, enroll, itemid;
        decimal Qty;string xmlpath = "", xmlString,ItemName;
        DataTable dt;
