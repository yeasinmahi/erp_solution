<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryLoanReceive.aspx.cs" Inherits="UI.SCM.Transfer.InventoryLoanReceive" %>
...
<%--=========================================Start My Code From Here===============================================--%>
    <div class="leaveApplication_container"> <asp:HiddenField ID="hdnUom" runat="server" /><asp:HiddenField ID="hdnValue" runat="server" />
        <asp:HiddenField ID="hdnPreConfirm" runat="server" /><asp:HiddenField ID="hdnTransfromValue" runat="server" /><asp:HiddenField ID="hdnStockQty" runat="server" />
       <div class="tabs_container">INVENTORY TRANSFER <hr /></div>
        ...
        <table style="border-radius:10px; width:700px; border-style:groove">
            <caption style="text-align:left">Loan Receive</caption>
        <tr>
       ...
       <tr>
           ...
           <td style='text-align: left;'>Item</td> 
            <td ><asp:TextBox ID="txtItem" runat="server" AutoCompleteType="Search" CssClass="txtBox" AutoPostBack="true"  Width="300px" OnTextChanged="txtItem_TextChanged"    ></asp:TextBox>
           ...
           <td style="text-align:right" ><asp:Label ID="Label1" Text="Quantity"  runat="server"></asp:Label></td>
           <td style="text-align:left"  ><asp:TextBox ID="txtReceQty" CssClass="txtBox" Text="0" Width="70px"  TextMode="Number" runat="server"></asp:TextBox>Value
            ...
            <td style='text-align: left;' colspan="3"><asp:TextBox ID="txtRemarks" Width="400px" runat="server" CssClass="txtBox"  AutoPostBack="false" ></asp:TextBox>
