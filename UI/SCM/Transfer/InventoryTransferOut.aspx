...
<head runat="server"><title></title>
    ...
    <script type="text/javascript">  
          ...
          function AddConfirm() {
                 ...
                 var stockQty = parseFloat(document.getElementById("hdnStockQty").value);
                 var remarks = parseFloat(document.getElementById("txtRemarks").value);
             ...
             else if (parseFloat(inQty) < parseFloat(quantity)) { document.getElementById("hdnPreConfirm").value = "0"; alert('input Quantity greater then Stock Quantity'); }
             else {
          ...
          function Confirm() {
             ...
             if ($.trim(transferType) == 0 || $.trim(transferType) == "" || $.trim(transferType) == null || $.trim(transferType) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please select Transfer Type'); }
             else if ($.trim(locationId) == 0 || $.trim(locationId) == "" || $.trim(locationId) == null || $.trim(locationId) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please select Sotre Location'); }
            else if ($.trim(towh) == 0 || $.trim(towh) == "" || $.trim(towh) == null || $.trim(towh) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please select Transfer Location'); }
            else if ($.trim(remarks) == 0 || $.trim(remarks) == "" || $.trim(remarks) == null || $.trim(remarks) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please input Remarks'); }

             else if ($.trim(inItem) == 0 || $.trim(inItem) == "" || $.trim(inItem) == null || $.trim(inItem) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please select In Item'); }
             else if ($.trim(inItem) == 0 || $.trim(inItem) == "" || $.trim(remarks) == null || $.trim(remarks) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please Input Remarks'); }
             else if ($.trim(quantity) == 0 || $.trim(quantity) == "" || $.trim(quantity) == null || $.trim(quantity) == undefined) { document.getElementById("hdnConfirm").value = "0"; alert('Please input Quantity'); }
             else if (parseFloat(inQty) < parseFloat(quantity)) { document.getElementById("hdnConfirm").value = "0"; alert('input Quantity greater then Stock Quantity'); }
             else {
       ...
       <div class="tabs_container">INVENTORY TRANSFER <hr /></div>
        ...
        <tr>
           ...
           <td style='text-align: left;'>Location</td>
            ...
            <td style='text-align: left;'><asp:DropDownList ID="ddlToWh" runat="server" CssClass="ddList"  AutoPostBack="True" ></asp:DropDownList></td>  
             ...
             <tr>
                ...
                <td style='text-align: left;' class="auto-style1"><asp:TextBox ID="txtVehicle" runat="server" CssClass="txtBox"  AutoPostBack="True" ></asp:TextBox></td> 
                <td style='text-align: left;' class="auto-style1">TransferType</td>
            ...
            <td>Rate</td>
            <td  style="text-align:left"><asp:TextBox ID="txtRate" CssClass="txtBox" Width="80px" runat="server" TextMode="Number"></asp:TextBox>  
         ...
         <table style="border-color:black;  width:900px;border-radius:10px;">
            ...
            <ItemTemplate><asp:Label ID="lblLocation" Width="120px" runat="server"  Text='<%# Bind("locationName") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="left" />  </asp:TemplateField>  
                 
            <asp:TemplateField HeaderText="TransType" ItemStyle-HorizontalAlign="right" SortExpression="transType" >
            <ItemTemplate><asp:Label ID="lblTrans" runat="server"  Width=""  Text='<%# Bind("transType") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="left" /> </asp:TemplateField>  
