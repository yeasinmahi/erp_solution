    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    ...
                    <table style="width: 750px; text-align: center">
                        <tr>
                            <td colspan="5" style="text-align: right;">WH Name:</td>
                    ...
                    <table style="border-radius: 10px; width: 700px; border-style: groove">
                        <tr>
                            <td style='text-align: left;'>Production ID:</td>
                            <td style='text-align: left;'>
                                <asp:DropDownList ID="ddlProductId" CssClass="ddList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProductId_SelectedIndexChanged"></asp:DropDownList></td>
                            <td style='text-align: left; width: 100px'>Product Name:</td>
                            <td style='text-align: left;'>
                                <asp:DropDownList ID="ddlProduct" CssClass="ddList" runat="server" AutoPostBack="True" Width="250px" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label1" Text="Receive Qty:" runat="server"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: right" colspan="4">
                                <asp:Label ID="lblDate" runat="server" ForeColor="GREEN"></asp:Label>
                                <asp:Button ID="btnReceive" runat="server" ForeColor="Blue" Text="Receive" OnClientClick="Confirms();" OnClick="btnReceive_Click" /></td>
                        </tr>
                        <tr>
                            <td colspan="4">
