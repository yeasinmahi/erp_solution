    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    <table class="tbldecoration" style="width: auto; float: left;">
                        ...
                        <tr class="tblheader">
                            <td class="tdheader" colspan="4">ITEM APPROVE BY PURCHASE DEPT :</td>
                        </tr>
                        <tr class="tblheader">
            ...
            <td><asp:TextBox ID="txtPlant" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke" Enabled="false" ></asp:TextBox></td> --%>
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="Label30" runat="server" Text="Safty Stock:" CssClass="lbl"></asp:Label></td>
                            <td>
            ...
            <td><asp:TextBox ID="TextUnitId" runat="server" CssClass="txtBox1" BackColor="White"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label16" runat="server" Text="P. Origin " CssClass="lbl"></asp:Label><span> :</span></td>
                            <td>
                                <asp:TextBox ID="txtPOrigin" runat="server" CssClass="txtBox1" BackColor="White"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPurchaseDescription" runat="server" CssClass="txtBox1" BackColor="White"></asp:TextBox></td>
