                            ...
                            <asp:GridView ID="FG_Grid" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Store Qty" SortExpression="numSendStoreQty">
                                         <ItemTemplate>
                                            <asp:TextBox ID="txtSendStoreQty" runat="server" Text='<%# Bind("numSendStoreQty","{0:N2}") %>' Width="120px" CssClass="form-control input-xs" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center"/>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LastActionTime" SortExpression="Column1">
                                        <ItemTemplate>
