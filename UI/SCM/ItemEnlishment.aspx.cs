...
namespace UI.SCM
{
    public partial class ItemEnlishment : BasePage
    {
        ...
        {
            Resultstring = txtItemName + ddlUoMN.SelectedValue + txtpartNo + txtModelNo + txtBrandn + txtLength + ddlLengthUom.SelectedValue + txtWidth + ddlWidthUom + txtHight + ddlHightUom.SelectedValue + TextInnerDia + ddlIdUom.SelectedValue + TextOuterDia + ddlOdUom.SelectedValue + TextGrossWt + TextNetWt;
        }
        //protected void ConfirmAll(object sender, EventArgs e)
        //{
        //    Resultstring = txtItemName+ ddlUoMN.SelectedValue+ txtpartNo+ txtModelNo+ txtBrandn+ txtLength+ ddlLengthUom.SelectedValue+ txtWidth+ ddlWidthUom+ txtHight+ ddlHightUom.SelectedValue+ TextInnerDia+ ddlIdUom.SelectedValue+ TextOuterDia+ ddlOdUom.SelectedValue+ TextGrossWt+ TextNetWt;
        //}
        private void Reset()
