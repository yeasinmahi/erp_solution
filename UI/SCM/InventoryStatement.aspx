...
<body>
    ...
    <div class="divbody" style="padding-right:10px;">
        <table><tr><td>
        <div class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;">INVENTORY STATEMENT<hr /></div>
        <table class="tbldecoration" style="width:auto; float:left;">
            ...
            <tr>                      
                ...
                <td style="text-align:left;"  ><asp:TextBox ID="txtdteFrom" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox>
                ...
                <td style="text-align:left;"  ><asp:TextBox ID="txtdteTo" runat="server"   CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox>
            ...
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label1" runat="server" Text="From Time :" CssClass="lbl"></asp:Label></td>
                <td><asp:TextBox ID="txtFTime" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox></td>
                <td style="text-align:right;"><asp:Label ID="Label3" runat="server" Text="To Time :" CssClass="lbl"></asp:Label></td>
                <td><asp:TextBox ID="txtTTime" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align:right;"><asp:Label ID="Label5" runat="server" Text="Search By " CssClass="lbl"></asp:Label><span style="color:red; font-size:14px;">*</span><span> :</span></td>
                            <td><asp:DropDownList ID="ddlSearchBy" CssClass="ddList" Font-Bold="False" runat="server" width="220px" height="24px" BackColor="WhiteSmoke" AutoPostBack="true" OnSelectedIndexChanged="ddlSearchBy_SelectedIndexChanged"><asp:ListItem Value="1" Text="Item"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Group"></asp:ListItem><asp:ListItem Value="3" Text="Category"></asp:ListItem><asp:ListItem Value="4" Text="Sub Category"></asp:ListItem><asp:ListItem Value="5" Text="Minor Category"></asp:ListItem>
                            <asp:ListItem Value="6" Text="Store Location"></asp:ListItem><asp:ListItem Value="7" Text="Plant"></asp:ListItem><asp:ListItem Value="8" Text="Purchase Type"></asp:ListItem>
                            <asp:ListItem Value="9" Text="ABC Classification"></asp:ListItem><asp:ListItem Value="10" Text="FSN Classification"></asp:ListItem><asp:ListItem Value="11" Text="VDE Classification"></asp:ListItem></asp:DropDownList></td>
                <td style="text-align:right;"><asp:Label ID="lblGroup" runat="server" CssClass="lbl"></asp:Label></td>
                <td><asp:DropDownList ID="ddlGroup" CssClass="ddList" Font-Bold="False" runat="server" width="220px" height="24px" BackColor="WhiteSmoke" AutoPostBack="true" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged"></asp:DropDownList><asp:TextBox ID="txtItem" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align:right;"><asp:Label ID="lblCategory" runat="server" CssClass="lbl"></asp:Label></td>
                <td><asp:TextBox ID="txtItemID" runat="server" CssClass="txtBox1" BackColor="WhiteSmoke"></asp:TextBox><asp:DropDownList ID="ddlCategory" CssClass="ddList" Font-Bold="False" runat="server" width="220px" height="24px" BackColor="WhiteSmoke" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList></td>
                <td style="text-align:right;"><asp:Label ID="lblSubCategory" runat="server" CssClass="lbl"></asp:Label></td>
        ...
        <table>
           <tr><td> 
            ...
            <ItemTemplate><asp:Label ID="lblItemName" runat="server"  Text='<%# Bind("strMaterialName") %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="lblOpenQty"  runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("monOpenQty","{0:n2}") %>'></asp:Label></ItemTemplate>
            ...
            <ItemTemplate><asp:Label ID="lblOpenValue" runat="server"  DataFormatString="{0:0.00}" Text='<%# Bind("monOpenValue","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/> </asp:TemplateField>

            <asp:TemplateField HeaderText="RecQty" ItemStyle-HorizontalAlign="right"   SortExpression="monRcvQty" >
            <ItemTemplate><asp:Label ID="lblRecQty" runat="server"   DataFormatString="{0:0.00}" Text='<%# Bind("monRcvQty","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/> </asp:TemplateField>
            ...
            <ItemTemplate><asp:Label ID="lblIssueQty" runat="server"  DataFormatString="{0:0.00}" Text='<%# Bind("monIssueQty","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/>  </asp:TemplateField>  

            <asp:TemplateField HeaderText="Issue Value" ItemStyle-HorizontalAlign="right" SortExpression="issueValue" > 
            <ItemTemplate><asp:Label ID="lblIssueValue" runat="server"  DataFormatString="{0:0.00}" Text='<%# Bind("issueValue","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/> </asp:TemplateField> 
                
             <asp:TemplateField HeaderText="Closing Qty"   ItemStyle-HorizontalAlign="right" SortExpression="ClosingvQty" >
            <ItemTemplate><asp:Label ID="lblClosingQty" runat="server"  DataFormatString="{0:0.00}" Text='<%# Bind("ClosingvQty","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/>  </asp:TemplateField>  

            <asp:TemplateField HeaderText="Closing Value" ItemStyle-HorizontalAlign="right" SortExpression="monCloseValue" > 
            <ItemTemplate><asp:Label ID="lblClosingValue"  Width="60px"   runat="server"  DataFormatString="{0:0.00}" Text='<%# Bind("monCloseValue","{0:n2}") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="right" Width="60px"/> </asp:TemplateField>
            
            <asp:TemplateField HeaderText="Store Location" ItemStyle-HorizontalAlign="right" SortExpression="strLocation" > 
            <ItemTemplate><asp:Label ID="lblLocation"  runat="server"  Text='<%# Bind("strLocation") %>'></asp:Label></ItemTemplate>
