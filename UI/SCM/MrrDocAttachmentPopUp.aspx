    ...
    <form id="frmLoanSummaryPrint" runat="server">
        ...
        <div id="dvTable" style="width: auto; background-color: white; padding-left: 50px; padding-right: 50px; padding-top: 10px; padding-bottom: 20px;">
            ...
            <table style="width: 700px">
                ...
                <tr>
                    <td colspan="3" style="text-align: center; font: bold 13px verdana;"><a id="btnprint" href="#" class="nextclick" style="cursor: pointer" onclick="Print()"></a></td>
                </tr>
            ...
            <table>
                <tr>
                    <td style="text-align: right">
                        <asp:Label ID="Label3" Text="Name" runat="server"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtName" CssClass="txtBox" Width="250px" runat="server" /></td>
                </tr>
                <tr>
                    <td style="text-align: right">
                        <asp:Label ID="lblMupload" Text="Upload" runat="server"></asp:Label></td>
                    <td colspan="3">
                        <asp:FileUpload ID="docUpload" Width="250px" runat="server" /></td>
                    <td style="text-align: right">
                        <asp:Button ID="btnMrr" Text="Attach MRR" Font-Bold="true" runat="server" OnClick="btnMrr_Click" /></td>
                </tr>
            </table>
                    ...
                    <td>
                        <asp:GridView ID="dgvDocument" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true" Width="600px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DocID" SortExpression="intDocID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDocId" runat="server" Width="60px" Text='<%# Bind("intDocID") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Document Note" ItemStyle-HorizontalAlign="right" SortExpression="strDocName">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNote" runat="server" Width="150px" Text='<%# Bind("strDocName") %>'></asp:Label></ItemTemplate>
                                    <ItemStyle HorizontalAlign="left" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Detalis">
                                    <ItemTemplate>
                                        <asp:Button ID="btnView" runat="server" Text="View" OnClick="btnView_Click" CommandArgument='<%# Eval("strFtpPath") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="left" />
                                </asp:TemplateField>
