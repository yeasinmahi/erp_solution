...
<body>
    ...
    <table class="tbldecoration" style="width:auto; float:left;">
        ...
        <tr>        
            ...
            <td class="tdheight"><asp:TextBox ID="txtPOType" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>        

            <td class="tdheight" style="text-align:right;"><asp:Label ID="Label1" CssClass="lbl" runat="server" Text="MRR No. : "></asp:Label></td>
            <td class="tdheight"><asp:TextBox ID="txtMrrNo" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox></td>
        </tr>
        <tr><td colspan="4" style="height:5px;"></td></tr>
        <tr> 
            <td class="tdheight" style="text-align:right;"><asp:Label ID="Label8" CssClass="lbl" runat="server" Text="Supplier Name : "></asp:Label></td>
            <td class="tdheight"><asp:DropDownList ID="ddlSupplier" CssClass="ddList" Height="24px" Font-Bold="False" ForeColor="Black" Font-Size="11px" runat="server"></asp:DropDownList> </td>
            ...
            <td class="tdheight"><asp:TextBox ID="txtNoofShipment" runat="server" CssClass="txtBox1" ></asp:TextBox></td>
        </tr>
        <tr><td colspan="4" style="height:5px;"></td></tr>
        <tr>
            <td class="tdheight" style="text-align:right;"><asp:Label ID="Label4" CssClass="lbl" runat="server" Text="Currency : "></asp:Label></td>
            <td class="tdheight"><asp:DropDownList ID="ddlCurrency" CssClass="ddList" Height="24px" Font-Bold="False" ForeColor="Black" Font-Size="11px" runat="server"></asp:DropDownList> </td>
            ...
            <td class="tdheight"><asp:TextBox ID="txtLastShipmentDate" runat="server" CssClass="txtBox1"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="tdheight"><asp:TextBox ID="txtPODate" runat="server" CssClass="txtBox1" Enabled="false" BackColor="WhiteSmoke"></asp:TextBox>
            ...
            <td class="tdheight"><asp:DropDownList ID="ddlPaymentTerms" runat="server" CssClass="ddList" Height="24px" Font-Bold="False">
        ...
        <tr>
            ...
            <td class="tdheight"><asp:TextBox ID="txtTransport" runat="server" CssClass="txtBox1" ></asp:TextBox></td>
            ...
            <td class="tdheight"><asp:TextBox ID="txtPaymentdaysAfterMRR" runat="server" CssClass="txtBox1" ></asp:TextBox></td>
        </tr>
        <tr><td colspan="4" style="height:5px;"></td></tr>
        <tr>
        ...
        <tr>  
            ...
            <td class="tdheight"><asp:DropDownList ID="ddlPartialShipment" runat="server" CssClass="ddList" Height="24px" Font-Bold="False">
            ...
            <td class="tdheight"><asp:TextBox ID="txtDestinationForDelivery" runat="server" CssClass="txtBox1" ></asp:TextBox></td>                              
        </tr>
        <tr><td colspan="4" style="height:5px;"></td></tr>
        <tr> 
        ...
        <table  class="tbldecoration" style="width:auto; float:left;">
            ...
            <tr>
                <td>
                    ...
                    <FooterTemplate><asp:Label ID="Label20" runat="server" Text="" /></FooterTemplate></asp:TemplateField>
