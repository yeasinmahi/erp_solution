                            ...
                            <td>
                                <asp:GridView ID="dgvPoApp" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true" Width="600px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="WareHouse" SortExpression="strShortName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWhName" runat="server" Width="100px" Text='<%# Bind("strShortName") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Po Date" ItemStyle-HorizontalAlign="right" SortExpression="dtePODate">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPoDate" runat="server" Width="90px" Text='<%# Bind("dtePODate","{0:dd-MM-yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Suppliyer Name" ItemStyle-HorizontalAlign="right" SortExpression="strSupplierName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSuppliyer" runat="server" Width="150px" Text='<%# Bind("strSupplierName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="PO Issuer" ItemStyle-HorizontalAlign="right" SortExpression="strEmployeeName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEmpName" runat="server" Width="150px" Text='<%# Bind("strEmployeeName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Detalis">
                                            <ItemTemplate>
                                                <asp:Button ID="btnDetalis" runat="server" Text="Detalis View" OnClick="btnDetalis_Click" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="PO Approval">
                                            <ItemTemplate>
                                                <asp:Button ID="btnApproval" runat="server" Text="Approval" OnClientClick="funConfirmAll();" OnClick="btnApproval_Click" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                    </Columns>
