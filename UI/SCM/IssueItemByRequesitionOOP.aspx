<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueItemByRequesitionOOP.aspx.cs" Inherits="UI.SCM.IssueItemByRequesitionOOP" %>
    ...
    <script type="text/javascript"> 
     ...
     <script>
         function Viewdetails(ReqId, ReqCode, dteReqDate, strDepartmentName, strReqBy, strApproveBy, intwh, DeptID, SectionID, SectionName) {
             window.open('IssueItemByRequesitionDetalisOOP.aspx?ReqId=' + ReqId + '&ReqCode=' + ReqCode + '&dteReqDate=' + dteReqDate + '&strDepartmentName=' + strDepartmentName + '&strReqBy=' + strReqBy + '&strApproveBy=' + strApproveBy + '&intwh=' + intwh + '&DeptID=' + DeptID + '&SectionID=' + SectionID + '&SectionName=' + SectionName, 'sub', "scrollbars=yes,toolbar=0,height=500,width=950,top=100,left=200, resizable=yes, directories=no,location=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no, addressbar=no");
     ...
     <div class="tabs_container" style="text-align:left">Store Issue From<hr /></div>
       ...
       <table>
           ...
           <td style="text-align:right;"><asp:Label ID="lblFrom" runat="server" CssClass="lbl" Text="From Date :"></asp:Label></td>
            <td style="text-align:center"><asp:TextBox ID="txtdteFrom" runat="server" Width="85px" autocomplete="off" CssClass="txtBox"></asp:TextBox>
            ...
            <td style="text-align:center"><asp:TextBox ID="txtdteTo" Width="85px" autocomplete="off" runat="server" CssClass="txtBox"></asp:TextBox>
        ...
        <table>
           <tr><td> 
            ...
            <ItemTemplate><asp:Label ID="lblIndentBy" width="100px"   runat="server"  Text='<%# Bind("strReqBy") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Right" /> </asp:TemplateField>  
