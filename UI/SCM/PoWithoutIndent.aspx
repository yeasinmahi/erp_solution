...
<body>
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    ...
                    <div class="tabs_container" style="text-align: left">PO without Indent<hr />
                    </div>
                    <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid">
                        <table>
                            ...
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label27" runat="server" CssClass="lbl" Text="PO No.:"></asp:Label>
                                </td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtPONo" runat="server" AutoPostBack="false" CssClass="txtBox" Font-Bold="False"> </asp:TextBox>
                                </td>

                                <td>
                                    <asp:Button ID="btnViewPO" Style="border-radius: 1px;" ForeColor="Black" BackColor="#99ccff" runat="server" Text="View PO" OnClick="btnViewPO_Click" Height="28px" /></td>
                            </tr>
                            <tr>
                                <td colspan="6">
                                    <hr />
                            ...
                            <tr>
                                <td colspan="3" style="text-align: right;">
                                    <asp:Label ID="Label16" runat="server" CssClass="lbl" Text="PO Type:"></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="ddlDepts" runat="server" AutoPostBack="true" CssClass="ddList" Font-Bold="False" OnSelectedIndexChanged="ddlDepts_SelectedIndexChanged"></asp:DropDownList></td>
                                <td>
                                    <asp:Label ID="lblPO" runat="server" ForeColor="Blue"></asp:Label></td>
                          ...
                          <td style="text-align:left;">
                              <asp:DropDownList ID="ddlSupplier" runat="server" AutoPostBack="true" CssClass="ddList" Font-Bold="False" OnSelectedIndexChanged="ddlSuppliyer_SelectedIndexChanged">
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtSupplier" runat="server" AutoCompleteType="Search" placeholder="Search" CssClass="txtBox" AutoPostBack="true" Width="250px" OnTextChanged="txtSupplier_TextChanged"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtdtePo" runat="server" CssClass="txtBox" Font-Bold="False"> 
                                    </asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd" TargetControlID="txtdtePo"></cc1:CalendarExtender>
                                </td>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtCommosion" runat="server" onkeyup="GetCommision(this);" CssClass="txtBox" AutoPostBack="false" Text="0" Font-Bold="False">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <asp:Label ID="Label12" runat="server" CssClass="lbl" Visible="false" Text="Pay Date: "></asp:Label>
                                </td>
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="ddlDtePay" Enabled="false" runat="server" AutoPostBack="false" Visible="false" CssClass="ddList" Font-Bold="False">
                                    </asp:DropDownList></td>

                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtAit" runat="server" onkeyup="GetAIT(this);" Text="0" AutoPostBack="false" Visible="false" CssClass="txtBox" Font-Bold="False"> 
                                    </asp:TextBox></td>
                                <td></td>
                                <td style="text-align: left;">
                                    <asp:Label ID="Label15" runat="server" Visible="false" CssClass="lbl" Text="AIT: "></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="TextBox1" runat="server" onkeyup="GetAIT(this);" Text="0" Width="80px" AutoPostBack="false" Visible="false" CssClass="txtBox" Font-Bold="False"> 
                                    </asp:TextBox>
                                    <asp:Button ID="Button2" Style="border-radius: 1px; height: 29px; float: right;" ForeColor="black" BackColor="#99ccff" runat="server" Text="Generate PO" OnClientClick="PoGenerateCheck();" OnClick="btnGeneratePO_Click" />
                                </td>
                        ...
                        <table style="border-color: cornflowerblue; border-radius: 10px; border: 1px solid blue;">
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Service: "></asp:Label></td>

                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtItem" runat="server" AutoPostBack="false" Width="300px" TextMode="MultiLine" CssClass="txtBox" Font-Bold="False"></asp:TextBox>
                                ...
                                <td style="text-align: right;">
                                    <asp:Label ID="Label2" runat="server" CssClass="lbl" Text="Description: "></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Width="300px" AutoPostBack="false" CssClass="txtBox" Font-Bold="False"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Quantity: "></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtQantity" runat="server" Text="0" AutoPostBack="false" CssClass="txtBox" Font-Bold="False"></asp:TextBox></td>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Rate: "></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtRate" runat="server" Text="0" AutoPostBack="false" CssClass="txtBox" Font-Bold="False"></asp:TextBox>
                                    <asp:Button ID="btnAdd" Style="border-radius: 1px; height: 29px" runat="server" ForeColor="black" BackColor="#99ccff" Text="Add to PO" OnClick="btnAdd_Click" />
                                </td>
                            </tr>
                        </table>
                        <table>
                                    ...
                                    <asp:GridView ID="dgvIndentPrepare" runat="server" ShowFooter="true" OnRowDeleting="dgvIndentPrepare_RowDeleting" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" Font-Size="10px" FooterStyle-BackColor="#999999" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right" ForeColor="Black" GridLines="Vertical">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Description" ItemStyle-HorizontalAlign="right" SortExpression="strUom">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDescription" runat="server" Text='<%# Bind("strDesc") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Quantity" SortExpression="poQty">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblQty" runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("poQty") %>' Width="60px"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="right" Width="60px" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblGrandTotalQty" runat="server" DataFormatString="{0:0.00}" Text="0" /></FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Rate" ItemStyle-HorizontalAlign="right" SortExpression="numPoRate">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtRate" runat="server" CssClass="txtBox" DataFormatString="{0:0.00}" Text='<%# Bind("numPoRate") %>' Width="80px"></asp:TextBox>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="VAT" SortExpression="vat">
                                                ...
                                                <ItemStyle HorizontalAlign="right" Width="80px" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblGrandTotalVAT" runat="server" DataFormatString="{0:0.00}" Text="0" /></FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="AIT" ItemStyle-HorizontalAlign="right" SortExpression="ait">
                                                ...
                                                <ItemStyle HorizontalAlign="right" Width="80px" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblGrandTotalAIT" runat="server" DataFormatString="{0:0.00}" Text="0" /></FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Total Value" ItemStyle-HorizontalAlign="right" SortExpression="total">
                                                ...
                                                <ItemStyle HorizontalAlign="right" Width="80px" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblGrandTotal" runat="server" DataFormatString="{0:0.00}" Text="0" /></FooterTemplate>
                                            </asp:TemplateField>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOthersTerms" runat="server" Width="220px" TextMode="MultiLine" CssClass="txtBox" /></td>
