...
<%--=========================================Start My Code From Here===============================================--%>
    ...
    <asp:HiddenField ID="hdnConfirm" runat="server" />
            ...
            <tr>
            <td style="text-align:left;"><asp:Label ID="Label1" CssClass="lbl" runat="server" Font-Bold="true" Text="WH Name : "></asp:Label>  
            <asp:DropDownList ID="ddlWH" runat="server" AutoPostBack="True" CssClass="ddList" Font-Bold="true" OnSelectedIndexChanged="ddlWH_SelectedIndexChanged"> </asp:DropDownList>   
             ...
             <td><asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="funConfirmAll()" OnClick="btnSubmit_Click" /> </td>
            </tr>
            <tr>
            ...
            <tr class="tblrowodd">
            <td > WH/Location-:</td> 
            <td ><asp:ListBox ID="ListBox1" runat="server" Width="500px" Height="150px" AutoPostBack="True" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged"></asp:ListBox></td>                    
            </tr>
            </table> 
          <table>
        ...
        <asp:TextBox ID="TxtServiceConfg" runat="server"  width="70"  placeholder="Search" onkeyup="Search_dgvservice(this, 'dgvWHLocation')"></asp:TextBox></HeaderTemplate>
        <ItemTemplate><%# Container.DataItemIndex + 1 %></ItemTemplate></asp:TemplateField>
         ...
         <ItemTemplate><asp:Label ID="lblLocId" runat="server" Text='<%# Bind("Id") %>'></asp:Label> </ItemTemplate>
         </asp:TemplateField>                         
         <asp:TemplateField HeaderText="Location Name" Visible="true">
         <ItemTemplate><asp:Label ID="lblLocName" runat="server" Text='<%# Bind("strName") %>'></asp:Label> </ItemTemplate>
         </asp:TemplateField>                       

        
              
          <asp:TemplateField> <ItemTemplate><asp:CheckBox ID="chkRow" runat="server" /></ItemTemplate>
          </asp:TemplateField>
