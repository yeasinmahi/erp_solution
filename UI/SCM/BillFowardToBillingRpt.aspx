    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="leaveApplication_container">
                    ...
                    <table style="width: 700px">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <asp:Label ID="lblWHs" Font-Size="Small" Font-Bold="true" runat="server" Font-Underline="true"></asp:Label></td>
                        </tr>

                        <tr>
                            <td></td>
                            <td style="text-align: center">
                                <asp:Label ID="lblbill" Font-Size="Small" Font-Bold="true" Text="Bill Forward List for Billing Department' Performance Report" runat="server"></asp:Label></td>
                        </tr>
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:GridView ID="dgvBill" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true" Width="800px" CssClass="GridViewStyle">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="PONO" SortExpression="intPo">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPo" runat="server" Width="60px" Text='<%# Bind("intPo") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Supplier" ItemStyle-HorizontalAlign="right" SortExpression="strSupplier">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSupplier" runat="server" Width="150px" Text='<%# Bind("strSupplier") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="PO Amount" ItemStyle-HorizontalAlign="right" SortExpression="monPOamount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOamount" runat="server" Width="50px" Text='<%# Bind("monPOamount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="MRR Amount" ItemStyle-HorizontalAlign="right" SortExpression="monmrrAmount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMrrAmount" runat="server" DataFormatString="{0:0.00}" Text='<%# Bind("monmrrAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="PO Issuer" ItemStyle-HorizontalAlign="right" SortExpression="strPOIssuer">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOIsser" runat="server" Text='<%# Bind("strPOIssuer") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                    </Columns>
