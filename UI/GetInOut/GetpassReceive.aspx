<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetpassReceive.aspx.cs" Inherits="UI.GetInOut.GetpassReceive" %>
...
<%--=========================================Start My Code From Here===============================================--%>
   ...
   <asp:HiddenField ID="HdfTechnicinCode" runat="server" /><asp:HiddenField ID="HdfTechnicinSearchbox" runat="server" /></td>
    ...
    <tr><td class="tblheader">Materials and Document Getpass Receive :<asp:HiddenField ID="HiddenField1" runat="server"/><asp:HiddenField ID="hdnpoint" runat="server" /><asp:HiddenField ID="hdnunit" runat="server" /></td></tr>
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="dgvGetpassRecieve" runat="server" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Receive">
                                    <ItemTemplate>
                                        <asp:Button ID="Button1" runat="server" CommandArgument='<%# Eval("intRTGetInGetPass")%>' CommandName="WorkOrder" OnClick="Button1_Click" Text="Receive" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                 ...
                 <div class="tabs_container">
                     <caption>
                         Getpass Receive Summary :<hr /></caption>
                       </div>
                 <td>
                         ...
                         <Columns>
                             ...
                             <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status" />
                              <asp:TemplateField HeaderText="Detalis">
                                  <ItemTemplate>
                                      <asp:Button ID="BtnDetalis" runat="server" Text="Detalis" CommandName="Detalis"  CommandArgument='<%# Eval("intRTGetInGetPass")%>' OnClick="BtnDetalis_Click" />
                                  </ItemTemplate>
                              </asp:TemplateField>
                         </Columns>
                     </asp:GridView>
