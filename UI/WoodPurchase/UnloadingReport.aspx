<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnloadingReport.aspx.cs" Inherits="UI.WoodPurchase.UnloadingReport" %>
...
<body>
    ...
    <div class="divbody" style="padding-right:10px;">
        <div class="tabs_container" style="background-color:#dcdbdb; padding-top:10px; padding-left:5px; padding-right:-50px; border-radius:5px;"> Unloading Bill Report<hr /></div>
        <table class="tbldecoration" style="width:auto; float:left;">
            ...
            <ItemStyle HorizontalAlign="left" /><FooterTemplate><asp:Label ID="lblTTText" runat="server" Text="Total :"></asp:Label></FooterTemplate></asp:TemplateField>    
