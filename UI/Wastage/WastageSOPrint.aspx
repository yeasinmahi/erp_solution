<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WastageSOPrint.aspx.cs" Inherits="UI.Wastage.WastageSOPrint" %>
...
<head runat="server">
    <title>.:Wastage Sales Order Print :.</title>
...
<body>
    <form id="frmWSOPrint" runat="server">
