<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptTransferSummary.aspx.cs" Inherits="UI.Wastage.rptTransferSummary" %>
...
<body>
    <form id="frmTransferSummary" runat="server">        
    ...
    <table class="tbldecoration" style="width:auto; float:left;">
        <tr>
            ...
            <td style="text-align:left;"><asp:TextBox ID="txtToDate" runat="server" AutoPostBack="false" CssClass="txtBox1" Enabled="true" autocomplete="off"></asp:TextBox>
        ...
        <tr>               
            <td>
                <asp:RadioButton ID="rdnReport" GroupName="lblRpt" Text="Summary Report" runat="server" OnCheckedChanged="rdnReport_CheckedChanged" /><asp:RadioButton ID="rdnRptDetails" GroupName="lblRpt" Text="Details Report" runat="server" OnCheckedChanged="rdnRptDetails_CheckedChanged" />
            </td>                
            <td colspan="4"></td>
          </tr>
    ...
    <table>
        ...
        <tr><td><asp:Panel ID="Panel1" runat="server"> <asp:GridView ID="dgvReport" runat="server" AutoGenerateColumns="False" PageSize="8"
            ...
            <ItemTemplate><asp:Label ID="lblQty" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("TransferQty") %>' Width="80px"></asp:Label>
            ...
            <ItemTemplate><asp:Label ID="lblRate" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column1") %>' Width="80px"></asp:Label>
            </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" /></asp:TemplateField>

            <asp:TemplateField HeaderText="Value" SortExpression="value">
            <ItemTemplate><asp:Label ID="lblValue" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Column2") %>' Width="80px"></asp:Label>
            ...
            <asp:TemplateField HeaderText="Value" SortExpression="value">
            <ItemTemplate><asp:Label ID="lblValue" runat="server" DataFormatString="{0:0.00}"  Text='<%# Bind("Amount") %>' Width="80px"></asp:Label>
            </ItemTemplate><ItemStyle HorizontalAlign="right" Width="80px" />
            <FooterTemplate><asp:Label ID="lblValueTotal" runat="server" DataFormatString="{0:0.00}" Text="<%# totalvalue %>" /></FooterTemplate></asp:TemplateField>
