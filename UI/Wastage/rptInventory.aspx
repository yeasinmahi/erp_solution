    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
                ...
                <div class="divbody" style="padding-right: 10px;">
                    ...
                    <table class="tbldecoration" style="width: auto; float: left;">
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <asp:Label ID="lblWH" runat="server" CssClass="lbl" Text="WH Name"></asp:Label>]<span style="color: red; font-size: 14px;">*</span><span> :</span></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align: right; padding: 0px 0px 0px 0px">
                                <asp:Button ID="btnExport" runat="server" Text="Export To Excel" class="myButtonGrey" OnClick="btnExport_Click" OnClientClick="ExportDivDataToExcel()" />
                                &nbsp&nbsp
                                <asp:Button ID="btnSubmit" runat="server" class="myButtonGrey" Text="Show" OnClick="btnSubmit_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <div id="divExport" runat="server">
                                <asp:GridView ID="dgvReportDetails" runat="server" AutoGenerateColumns="False" PageSize="8"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Material Name" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMaterial" runat="server" Text='<%# Bind("strItemName") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="UOM" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblUOM" runat="server" Text='<%# Bind("strUOM") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Opening Qty" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOPSQty" runat="server" Text='<%# Bind("OpeQty") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Opening Rate" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOPSRate" runat="server" Text='<%# Bind("OpeRate") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Opening Value" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOPSValue" runat="server" Text='<%# Bind("OpeValue") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                            <FooterTemplate>
                                                <asp:Label ID="lblValueTotalqty" runat="server" DataFormatString="{0:0.00}" Text="<%# OtotalOpening %>" />
                                            </FooterTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Receive Qty" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRecqty" runat="server" Text='<%# Bind("RecQty") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Receive Rate" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRecRate" runat="server" Text='<%# Bind("RecRate") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Receive Value" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRecValue" runat="server" Text='<%# Bind("RecValue") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                            <FooterTemplate>
                                                <asp:Label ID="lblValueTotalqty" runat="server" DataFormatString="{0:0.00}" Text="<%# recvalue %>" />
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Available Qty" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAvailableqty" runat="server" Text='<%# Bind("TotalQty") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Available Rate" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAvailableRate" runat="server" Text='<%# Bind("TotalRate") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Available Value" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAvailableValue" runat="server" Text='<%# Bind("TotalValue") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                            <FooterTemplate>
                                                <asp:Label ID="lblValueTotalqty" runat="server" DataFormatString="{0:0.00}" Text="<%# avavalue %>" />
                                            </FooterTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Issue Qty" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIssueqty" runat="server" Text='<%# Bind("IssQty") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Issue Rate" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIssueRate" runat="server" Text='<%# Bind("IssRate") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Issue Value" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIssueValue" runat="server" Text='<%# Bind("IssValue") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                            <FooterTemplate>
                                                <asp:Label ID="lblValueTotalqty" runat="server" DataFormatString="{0:0.00}" Text="<%# issvalue %>" />
                                            </FooterTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Closing Qty" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClosingqty" runat="server" Text='<%# Bind("CloQty") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Closing Rate" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIssueRate" runat="server" Text='<%# Bind("CloRate") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Closing Value" SortExpression="itemid">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClosingValue" runat="server" Text='<%# Bind("CloValue") %>' Width="80px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="80px" />
                                            <FooterTemplate>
                                                <asp:Label ID="lblValueTotalqty" runat="server" DataFormatString="{0:0.00}" Text="<%# clovalue %>" />
                                            </FooterTemplate>
                                        </asp:TemplateField>
