    ...
    <div class="divbody" style="padding-right:10px;">
        ...
        <table class="tbldecoration" style="width:auto; float:left;">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtQty" runat="server" CssClass="txtBox1" onkeypress="return onlyNumbers();"></asp:TextBox></td>                 
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align:right; padding: 0px 0px 0px 0px"><asp:Button ID="btnSubmit" runat="server" class="myButtonGrey" Text="Submit" Width="100px"/></td>        
            </tr>
