<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveEntryAfs.aspx.cs" Inherits="UI.AEFPS.ReceiveEntryAfs" %>
       ...
       <tr>
        ...
        <table>
             <tr>
                 ...
                 <td  style="text-align:right"><asp:Button ID="btnReceive" OnClientClick="funConfirmAll()" runat="server" Text="Receive Mrr" OnClick="btnReceive_Click"  /></td>
             </tr>
         <tr><td colspan="6"> 
            ...
            <ItemTemplate><asp:TextBox ID="txtReceQty" Width="60px" CssClass="txtBox" runat="server" DataFormatString="{0:0.00}" Text='<%# (decimal.Parse(""+Eval("monSalesQty"))) %>'></asp:TextBox></ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Receive"><ItemTemplate>
            <asp:Button ID="btnPrint" runat="server" Text="Receive" OnClientClick="funConfirmAll()" OnClick="btnPrint_Click" />
