<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FpsSalesReturn.aspx.cs" Inherits="UI.AEFPS.FpsSalesReturn" %>
...
<body>
    ...
    <div class="tabs_container"> SALES RETURN :<hr /></div>        
        ...
        <tr>                
            ...
            <td style="text-align:right;"><asp:Label ID="lblSearchBuyerReff" runat="server" CssClass="lbl" Text="Sales Voucher :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="txtSV" runat="server" CssClass="txtBox"></asp:TextBox></td>              
        </tr>         
        <tr>
        ...
        <%--<tr> 
            ...
            <td style="text-align:right;"><asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Item Name :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="TextBox1" runat="server" CssClass="txtBox"></asp:TextBox></td>                          
        </tr> 
        <tr> 
            <td style="text-align:right;"><asp:Label ID="Label3" runat="server" CssClass="lbl" Text="Stock :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="TextBox2" runat="server" CssClass="txtBox"></asp:TextBox></td>   
            
            <td style="text-align:right;"><asp:Label ID="Label4" runat="server" CssClass="lbl" Text="Quantity :"></asp:Label></td>
            <td style="text-align:left;"><asp:TextBox ID="TextBox3" runat="server" CssClass="txtBox"></asp:TextBox></td>                          
        </tr> --%>
        <tr><td colspan="4"><hr /></td></tr> 
        <tr><td colspan="4">Product List By Sales Voucher:<hr /></td></tr>
        <tr><td colspan="4"> 
            ...
            <%--<asp:TemplateField HeaderText="intRefSalesID" Visible="false" SortExpression="intRefSalesID"><ItemTemplate>            
            <asp:Label ID="lblReffID" runat="server" Text='<%# Bind("intRefSalesID") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="45px"/></asp:TemplateField>--%>

            <asp:TemplateField HeaderText="ProductID" Visible="false" SortExpression="intItemID"><ItemTemplate>            
        ...
        <tr><td colspan="4">Return Product List :<hr /></td></tr>  
        ...
        <tr><td colspan="4"> 
            ...
            <asp:TemplateField HeaderText="Sales Voucher" SortExpression="sv"><ItemTemplate>            
            <asp:Label ID="lblSVR" runat="server" Text='<%# Bind("sv") %>'></asp:Label></ItemTemplate>
            <ItemStyle HorizontalAlign="Left" Width="80px"/><FooterTemplate><asp:Label ID="lblT" runat="server" Text ="Total" /></FooterTemplate></asp:TemplateField>
