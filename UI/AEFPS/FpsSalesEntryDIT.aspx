<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FpsSalesEntryDIT.aspx.cs" Inherits="UI.AEFPS.FpsSalesEntryDIT" %>
    ...
    <span class="message-text" id="msg"><%# UI.ClassFiles.CommonClass.GetGlobalMessage() %></span></marquee>
            ...
            CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label10" runat="server" CssClass="lbl" Text="Price :"></asp:Label>
                               </td>
                            <td style="text-align: left;"><asp:TextBox ID="txtPrice" runat="server" CssClass="txtBox" Enabled="false" MaxLength="10" AutoPostBack="true"></asp:TextBox>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;" class="auto-style1">
