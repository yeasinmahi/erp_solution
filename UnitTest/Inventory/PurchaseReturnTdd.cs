...
namespace UnitTest.Inventory
{
    ...
    public class PurchaseReturnTdd
    {
        ...
        {
            string purchaseReturnId = _bll.PurchaseReturn(intWhId, intMrrId, itemId, itemName, poQty, numRcvQty, returnQty,
                returnValue, locationId, remarks, supplierId, supplierName, intEnroll);
            Assert.That(purchaseReturnId.ToLower().Contains("success"));
        }
    }
}
